import{E as t,p as e,a as s,x as n,i,T as o,w as r,f as a,S as l}from"./pb-mixin-B7EAqf7q.js";import{t as c}from"./pb-dialog-BWd4eoTA.js";import{e as d,i as h,t as u,o as p}from"./unsafe-html-C7vzzZJI.js";import{t as g}from"./pb-i18n-Dne_FgGK.js";import{l as f}from"./logger-BDsEU7Z8.js";const m=e=>e??t;class v extends(c(e(s))){static get properties(){return Object.assign(Object.assign({},super.properties),{},{noAnimation:{type:Boolean,attribute:"no-animation"},opened:{type:Boolean},toggles:{type:Boolean},expandIcon:{type:String,attribute:"expand-icon"},collapseIcon:{type:String,attribute:"collapse-icon"},iconSprite:{type:String,attribute:"icon-sprite"},noIcons:{type:Boolean,attribute:"no-icons"}})}constructor(){super(),this.horizontal=!1,this.noAnimation=!1,this.opened=!1,this.expandIcon="icons:expand-more",this.collapseIcon="icons:expand-less",this.noIcons=!1,this.toggles=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("pb-collapse-open",()=>{this.open()}),this.toggles&&this.subscribeTo("pb-collapse-open",t=>{if(t.detail&&t.detail._source!==this){for(const e of this.querySelectorAll("pb-collapse"))if(e===t.detail._source)return;this.close()}})}updated(t){if(super.updated(t),t.has("opened")){const t=this.shadowRoot.querySelector("details");t&&(t.open=this.opened)}}open(){this.opened||(this.opened=!0,this.emitTo("pb-collapse-open",this))}close(){this.opened&&(this.opened=!1)}toggle(){this.opened=!this.opened,this.opened&&this.emitTo("pb-collapse-open",this.data)}_handleToggle(t){t.preventDefault(),this.toggle()}render(){return n`
    ...
    `}_renderIcon({position:t}){if(this.noIcons)return null;const e=this.classList&&this.classList.contains("icon-right");if("left"===t&&e||"right"===t&&!e)return null;const s=this._customIconImage(),i=s&&"none"!==s,o=this.opened?this.collapseIcon:this.expandIcon,r=this.iconSprite||null;return n`
      <span class="collapse-icon" data-custom="${i?"true":"false"}">
        <pb-icon icon="${o}" sprite=${m(r||void 0)} decorative></pb-icon>
      </span>
    ...
    `}_renderSuggestion(t,e){const s=e===this._highlightedIndex;return n`
      <li
        ...
        class=${y({suggestion:!0,"suggestion--active":s})}
        role="option"
    ...
    `}}customElements.get("pb-autocomplete")||customElements.define("pb-autocomplete",S);const E="undefined"!=typeof navigator&&navigator.userAgent.toLowerCase().indexOf("firefox")>0;function T(t,e,s,n){t.addEventListener?t.addEventListener(e,s,n):t.attachEvent&&t.attachEvent(`on${e}`,s)}function A(t,e,s,n){t&&(t.removeEventListener?t.removeEventListener(e,s,n):t.detachEvent&&t.detachEvent(`on${e}`,s))}function O(t,e){const s=e.slice(0,e.length-1),n=[];for(let e=0;e<s.length;e++)n.push(t[s[e].toLowerCase()]);return n}function I(t){"string"!=typeof t&&(t="");const e=(t=t.replace(/\s/g,"")).split(",");let s=e.lastIndexOf("");for(;s>=0;)e[s-1]+=",",e.splice(s,1),s=e.lastIndexOf("");return e}function j(t,e){const s=t.length>=e.length?t:e,n=t.length>=e.length?e:t;let i=!0;for(let t=0;t<s.length;t++)-1===n.indexOf(s[t])&&(i=!1);return i}function M(t){let e=t.keyCode||t.which||t.charCode;return t.code&&/^Key[A-Z]$/.test(t.code)&&(e=t.code.charCodeAt(3)),e}const $={backspace:8,"⌫":8,tab:9,clear:12,enter:13,"↩":13,return:13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,arrowup:38,arrowdown:40,arrowleft:37,arrowright:39,del:46,delete:46,ins:45,insert:45,home:36,end:35,pageup:33,pagedown:34,capslock:20,num_0:96,num_1:97,num_2:98,num_3:99,num_4:100,num_5:101,num_6:102,num_7:103,num_8:104,num_9:105,num_multiply:106,num_add:107,num_enter:108,num_subtract:109,num_decimal:110,num_divide:111,"⇪":20,",":188,".":190,"/":191,"`":192,"-":E?173:189,"=":E?61:187,";":E?59:186,"'":222,"{":219,"}":221,"[":219,"]":221,"\\":220},P={"⇧":16,shift:16,"⌥":18,alt:18,option:18,"⌃":17,ctrl:17,control:17,"⌘":91,cmd:91,meta:91,command:91},L={16:"shiftKey",18:"altKey",17:"ctrlKey",91:"metaKey",shiftKey:16,ctrlKey:17,altKey:18,metaKey:91},N={16:!1,18:!1,17:!1,91:!1},B={};for(let t=1;t<20;t++)$[`f${t}`]=111+t;let R=[],D=null,U="all";const V=new Map,F=t=>$[t.toLowerCase()]||P[t.toLowerCase()]||t.toUpperCase().charCodeAt(0),q=t=>Object.keys($).find(e=>$[e]===t),z=t=>Object.keys(P).find(e=>P[e]===t),K=t=>{U=t||"all"},X=()=>U||"all",H=()=>R.map(t=>q(t)||z(t)||String.fromCharCode(t)),W=()=>{const t=[];return Object.keys(B).forEach(e=>{B[e].forEach(({key:e,scope:s,mods:n,shortcut:i})=>{t.push({scope:s,shortcut:i,mods:n,keys:e.split("+").map(t=>F(t))})})}),t},Y=t=>{const e=t.target||t.srcElement,{tagName:s}=e;let n=!0;const i="INPUT"===s&&!["checkbox","radio","range","button","file","reset","submit","color"].includes(e.type);return(e.isContentEditable||(i||"TEXTAREA"===s||"SELECT"===s)&&!e.readOnly)&&(n=!1),n},Z=t=>("string"==typeof t&&(t=F(t)),-1!==R.indexOf(t)),G=(t,e)=>{let s,n;t||(t=X());for(const e in B)if(Object.prototype.hasOwnProperty.call(B,e))for(s=B[e],n=0;n<s.length;)s[n].scope===t?s.splice(n,1).forEach(({element:t})=>ot(t)):n++;X()===t&&K(e||"all")};function J(t){let e=M(t);t.key&&"capslock"===t.key.toLowerCase()&&(e=F(t.key));const s=R.indexOf(e);if(s>=0&&R.splice(s,1),t.key&&"meta"===t.key.toLowerCase()&&R.splice(0,R.length),(93===e||224===e)&&(e=91),e in N){N[e]=!1;for(const t in P)P[t]===e&&(nt[t]=!1)}}const Q=(t,...e)=>{if(void 0===t)Object.keys(B).forEach(t=>{Array.isArray(B[t])&&B[t].forEach(t=>tt(t)),delete B[t]}),ot(null);else if(Array.isArray(t))t.forEach(t=>{t.key&&tt(t)});else if("object"==typeof t)t.key&&tt(t);else if("string"==typeof t){let[s,n]=e;"function"==typeof s&&(n=s,s=""),tt({key:t,scope:s,method:n,splitKey:"+"})}},tt=({key:t,scope:e,method:s,splitKey:n="+"})=>{I(t).forEach(t=>{const i=t.split(n),o=i.length,r=i[o-1],a="*"===r?"*":F(r);if(!B[a])return;e||(e=X());const l=o>1?O(P,i):[],c=[];B[a]=B[a].filter(t=>{const n=(!s||t.method===s)&&t.scope===e&&j(t.mods,l);return n&&c.push(t.element),!n}),c.forEach(t=>ot(t))})};function et(t,e,s,n){if(e.element!==n)return;let i;if(e.scope===s||"all"===e.scope){i=e.mods.length>0;for(const t in N)Object.prototype.hasOwnProperty.call(N,t)&&(!N[t]&&e.mods.indexOf(+t)>-1||N[t]&&-1===e.mods.indexOf(+t))&&(i=!1);(0===e.mods.length&&!N[16]&&!N[18]&&!N[17]&&!N[91]||i||"*"===e.shortcut)&&(e.keys=[],e.keys=e.keys.concat(R),!1===e.method(t,e)&&(t.preventDefault?t.preventDefault():t.returnValue=!1,t.stopPropagation&&t.stopPropagation(),t.cancelBubble&&(t.cancelBubble=!0)))}}function st(t,e){const s=B["*"];let n=M(t);if(t.key&&"capslock"===t.key.toLowerCase()||!(nt.filter||Y).call(this,t))return;if((93===n||224===n)&&(n=91),-1===R.indexOf(n)&&229!==n&&R.push(n),["metaKey","ctrlKey","altKey","shiftKey"].forEach(e=>{const s=L[e];t[e]&&-1===R.indexOf(s)?R.push(s):!t[e]&&R.indexOf(s)>-1?R.splice(R.indexOf(s),1):"metaKey"===e&&t[e]&&(R=R.filter(t=>t in L||t===n))}),n in N){N[n]=!0;for(const e in P)if(Object.prototype.hasOwnProperty.call(P,e)){const s=L[P[e]];nt[e]=t[s]}if(!s)return}for(const e in N)Object.prototype.hasOwnProperty.call(N,e)&&(N[e]=t[L[e]]);t.getModifierState&&(!t.altKey||t.ctrlKey)&&t.getModifierState("AltGraph")&&(-1===R.indexOf(17)&&R.push(17),-1===R.indexOf(18)&&R.push(18),N[17]=!0,N[18]=!0);const i=X();if(s)for(let n=0;n<s.length;n++)s[n].scope===i&&("keydown"===t.type&&s[n].keydown||"keyup"===t.type&&s[n].keyup)&&et(t,s[n],i,e);if(!(n in B))return;const o=B[n],r=o.length;for(let s=0;s<r;s++)if(("keydown"===t.type&&o[s].keydown||"keyup"===t.type&&o[s].keyup)&&o[s].key){const n=o[s],{splitKey:r}=n,a=n.key.split(r),l=[];for(let t=0;t<a.length;t++)l.push(F(a[t]));l.sort().join("")===R.sort().join("")&&et(t,n,i,e)}}const nt=function(t,e,s){R=[];const n=I(t);let i=[],o="all",r=document,a=0,l=!1,c=!0,d="+",h=!1,u=!1;if(void 0===s&&"function"==typeof e&&(s=e),"[object Object]"===Object.prototype.toString.call(e)){const t=e;t.scope&&(o=t.scope),t.element&&(r=t.element),t.keyup&&(l=t.keyup),void 0!==t.keydown&&(c=t.keydown),void 0!==t.capture&&(h=t.capture),"string"==typeof t.splitKey&&(d=t.splitKey),!0===t.single&&(u=!0)}for("string"==typeof e&&(o=e),u&&Q(t,o);a<n.length;a++){const t=n[a].split(d);i=[],t.length>1&&(i=O(P,t));let e=t[t.length-1];e="*"===e?"*":F(e),e in B||(B[e]=[]),B[e].push({keyup:l,keydown:c,scope:o,mods:i,shortcut:n[a],method:s,key:n[a],splitKey:d,element:r})}if(void 0!==r&&"undefined"!=typeof window){if(!V.has(r)){const t=(t=window.event)=>st(t,r),e=(t=window.event)=>{st(t,r),J(t)};V.set(r,{keydownListener:t,keyupListenr:e,capture:h}),T(r,"keydown",t,h),T(r,"keyup",e,h)}if(!D){const t=()=>{R=[]};D={listener:t,capture:h},T(window,"focus",t,h)}}};function it(t,e="all"){Object.keys(B).forEach(s=>{B[s].filter(s=>s.scope===e&&s.shortcut===t).forEach(t=>{t&&t.method&&t.method({},t)})})}function ot(t){const e=Object.values(B).flat();if(e.findIndex(({element:e})=>e===t)<0&&t){const{keydownListener:e,keyupListenr:s,capture:n}=V.get(t)||{};e&&s&&(A(t,"keyup",s,n),A(t,"keydown",e,n),V.delete(t))}if((e.length<=0||V.size<=0)&&(Array.from(V.keys()).forEach(t=>{const{keydownListener:e,keyupListenr:s,capture:n}=V.get(t)||{};e&&s&&(A(t,"keyup",s,n),A(t,"keydown",e,n),V.delete(t))}),V.clear(),Object.keys(B).forEach(t=>delete B[t]),D)){const{listener:t,capture:e}=D;A(window,"focus",t,e),D=null}}const rt={getPressedKeyString:H,setScope:K,getScope:X,deleteScope:G,getPressedKeyCodes:()=>R.slice(0),getAllKeyCodes:W,isPressed:Z,filter:Y,trigger:it,unbind:Q,keyMap:$,modifier:P,modifierMap:L};for(const t in rt){const e=t;Object.prototype.hasOwnProperty.call(rt,e)&&(nt[e]=rt[e])}if("undefined"!=typeof window){const t=window.hotkeys;nt.noConflict=e=>(e&&window.hotkeys===nt&&(window.hotkeys=t),nt),window.hotkeys=nt}const at=new Set(["INPUT","SELECT","TEXTAREA","PAPER-INPUT","PAPER-TEXTAREA","PB-SEARCH"]);let lt=!0;lt&&(nt.filter=t=>{const{target:e}=t;if(e.isContentEditable)return!1;const{tagName:s}=e;return!at.has(s)},lt=!1);const ct=t=>class extends t{static get properties(){return Object.assign(Object.assign({},super.properties),{},{hotkeys:{type:Object}})}constructor(){super(),this.hotkeys={}}registerHotkey(t,e,s){t&&this.hotkeys[t]&&(s?nt(this.hotkeys[t],{element:s},e):nt(this.hotkeys[t],e))}display(t){if(t&&this.hotkeys[t]){const e=[];return this.hotkeys[t].split(/\s*,\s*/).forEach(t=>{e.push(t.replace("+","-"))}),e.join(", ")}return""}};function dt(t,e,s){s?nt(t,{element:s},e):nt(t,e)}window.pbKeyboard=dt;const ht=(t="")=>t.replace(/[-_]/g," ").trim();class ut extends s{static properties={icon:{type:String},disabled:{type:Boolean,reflect:!0},label:{type:String},toggles:{type:Boolean},active:{type:Boolean,reflect:!0}};constructor(){super(),this.icon="",this.disabled=!1,this.label="",this.toggles=!1,this.active=!1}render(){const t=this.title||"",e=this.icon?ht(this.icon.includes(":")?this.icon.split(":").pop():this.icon):"",s=this.label||t||e;return n`
      <button
  ...
  `}customElements.get("pb-icon-button")||customElements.define("pb-icon-button",ut);class pt extends(c(s)){static get styles(){return i`
      :host {
        display: block;
      }
  ...
  `);const ze=t=>t,Ke="string"==typeof document.head.style.touchAction,Xe="__polymerGestures",He="__polymerGesturesHandled",We="__polymerGesturesTouchAction",Ye=25,Ze=5,Ge=2,Je=["mousedown","mousemove","mouseup","click"],Qe=[0,1,4,2],ts=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(t){return!1}}();function es(t){return Je.indexOf(t)>-1}let ss=!1;function ns(t){es(t)}!function(){try{const t=Object.defineProperty({},"passive",{get(){ss=!0}});window.addEventListener("test",null,t),window.removeEventListener("test",null,t)}catch(t){}}();const is=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u),os={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function rs(t){const e=t.type;if(!es(e))return!1;if("mousemove"===e){let e=void 0===t.buttons?1:t.buttons;return t instanceof window.MouseEvent&&!ts&&(e=Qe[t.which]||0),Boolean(1&e)}return 0===(void 0===t.button?0:t.button)}function as(t){if("click"===t.type){if(0===t.detail)return!0;const e=ms(t);if(!e.nodeType||e.nodeType!==Node.ELEMENT_NODE)return!0;const s=e.getBoundingClientRect(),n=t.pageX,i=t.pageY;return!(n>=s.left&&n<=s.right&&i>=s.top&&i<=s.bottom)}return!1}const ls={touch:{x:0,y:0,id:-1,scrollDecided:!1}};function cs(t){let e="auto";const s=us(t);for(let t,n=0;n<s.length;n++)if(t=s[n],t[We]){e=t[We];break}return e}function ds(t,e,s){t.movefn=e,t.upfn=s,document.addEventListener("mousemove",e),document.addEventListener("mouseup",s)}function hs(t){document.removeEventListener("mousemove",t.movefn),document.removeEventListener("mouseup",t.upfn),t.movefn=null,t.upfn=null}const us=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:t=>t.composedPath&&t.composedPath()||[],ps={},gs=[];function fs(t,e){let s=document.elementFromPoint(t,e),n=s;for(;n&&n.shadowRoot&&!window.ShadyDOM;){const i=n;if(n=n.shadowRoot.elementFromPoint(t,e),i===n)break;n&&(s=n)}return s}function ms(t){const e=us(t);return e.length>0?e[0]:t.target}function vs(t){const e=t.type,s=t.currentTarget[Xe];if(!s)return;const n=s[e];if(!n)return;if(!t[He]&&(t[He]={},e.startsWith("touch"))){const s=t.changedTouches[0];if("touchstart"===e&&1===t.touches.length&&(ls.touch.id=s.identifier),ls.touch.id!==s.identifier)return;Ke||"touchstart"!==e&&"touchmove"!==e||bs(t)}const i=t[He];if(!i.skip){for(let e,s=0;s<gs.length;s++)e=gs[s],n[e.name]&&!i[e.name]&&e.flow&&e.flow.start.indexOf(t.type)>-1&&e.reset&&e.reset();for(let s,o=0;o<gs.length;o++)s=gs[o],n[s.name]&&!i[s.name]&&(i[s.name]=!0,s[e](t))}}function bs(t){const e=t.changedTouches[0],s=t.type;if("touchstart"===s)ls.touch.x=e.clientX,ls.touch.y=e.clientY,ls.touch.scrollDecided=!1;else if("touchmove"===s){if(ls.touch.scrollDecided)return;ls.touch.scrollDecided=!0;const s=cs(t);let n=!1;const i=Math.abs(ls.touch.x-e.clientX),o=Math.abs(ls.touch.y-e.clientY);t.cancelable&&("none"===s?n=!0:"pan-x"===s?n=o>i:"pan-y"===s&&(n=i>o)),n?t.preventDefault():Ss("track")}}function ys(t,e,s){return!!ps[e]&&(_s(t,e,s),!0)}function _s(t,e,s){const n=ps[e],i=n.deps,o=n.name;let r=t[Xe];r||(t[Xe]=r={});for(let e,s,n=0;n<i.length;n++)e=i[n],is&&es(e)&&"click"!==e||(s=r[e],s||(r[e]=s={_count:0}),0===s._count&&t.addEventListener(e,vs,ns(e)),s[o]=(s[o]||0)+1,s._count=(s._count||0)+1);t.addEventListener(e,s),n.touchAction&&ks(t,n.touchAction)}function ws(t){gs.push(t),t.emits.forEach(e=>{ps[e]=t})}function xs(t){for(let e,s=0;s<gs.length;s++){e=gs[s];for(let s,n=0;n<e.emits.length;n++)if(s=e.emits[n],s===t)return e}return null}function ks(t,e){Ke&&t instanceof HTMLElement&&Bt.run(()=>{t.style.touchAction=e}),t[We]=e}function Cs(t,e,s){const n=new Event(e,{bubbles:!0,cancelable:!0,composed:!0});if(n.detail=s,ze(t).dispatchEvent(n),n.defaultPrevented){const t=s.preventer||s.sourceEvent;t&&t.preventDefault&&t.preventDefault()}}function Ss(t){const e=xs(t);e.info&&(e.info.prevent=!0)}function Es(t,e,s,n){e&&Cs(e,t,{x:s.clientX,y:s.clientY,sourceEvent:s,preventer:n,prevent:t=>Ss(t)})}function Ts(t,e,s){if(t.prevent)return!1;if(t.started)return!0;const n=Math.abs(t.x-e),i=Math.abs(t.y-s);return n>=Ze||i>=Ze}function As(t,e,s){if(!e)return;const n=t.moves[t.moves.length-2],i=t.moves[t.moves.length-1],o=i.x-t.x,r=i.y-t.y;let a,l=0;n&&(a=i.x-n.x,l=i.y-n.y),Cs(e,"track",{state:t.state,x:s.clientX,y:s.clientY,dx:o,dy:r,ddx:a,ddy:l,sourceEvent:s,hover:()=>fs(s.clientX,s.clientY)})}function Os(t,e,s){const n=Math.abs(e.clientX-t.x),i=Math.abs(e.clientY-t.y),o=ms(s||e);!o||os[o.localName]&&o.hasAttribute("disabled")||(isNaN(n)||isNaN(i)||n<=Ye&&i<=Ye||as(e))&&(t.prevent||Cs(o,"tap",{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:s}))}ws({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){hs(this.info)},mousedown(t){if(!rs(t))return;const e=ms(t),s=this,n=t=>{rs(t)||(Es("up",e,t),hs(s.info))},i=t=>{rs(t)&&Es("up",e,t),hs(s.info)};ds(this.info,n,i),Es("down",e,t)},touchstart(t){Es("down",ms(t),t.changedTouches[0],t)},touchend(t){Es("up",ms(t),t.changedTouches[0],t)}}),ws({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(t){this.moves.length>Ge&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,hs(this.info)},mousedown(t){if(!rs(t))return;const e=ms(t),s=this,n=t=>{const n=t.clientX,i=t.clientY;Ts(s.info,n,i)&&(s.info.state=s.info.started?"mouseup"===t.type?"end":"track":"start","start"===s.info.state&&Ss("tap"),s.info.addMove({x:n,y:i}),rs(t)||(s.info.state="end",hs(s.info)),e&&As(s.info,e,t),s.info.started=!0)},i=t=>{s.info.started&&n(t),hs(s.info)};ds(this.info,n,i),this.info.x=t.clientX,this.info.y=t.clientY},touchstart(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove(t){const e=ms(t),s=t.changedTouches[0],n=s.clientX,i=s.clientY;Ts(this.info,n,i)&&("start"===this.info.state&&Ss("tap"),this.info.addMove({x:n,y:i}),As(this.info,e,s),this.info.state="track",this.info.started=!0)},touchend(t){const e=ms(t),s=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:s.clientX,y:s.clientY}),As(this.info,e,s))}}),ws({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(t){rs(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click(t){rs(t)&&Os(this.info,t)},touchstart(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend(t){Os(this.info,t.changedTouches[0],t)}});const Is=Gt(t=>class extends t{static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0,sync:!0}}}_disabledChanged(t){this._setAriaDisabled(t)}_setAriaDisabled(t){t?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled")}click(){this.disabled||super.click()}}),js=Gt(t=>class extends t{ready(){super.ready(),this.addEventListener("keydown",t=>{this._onKeyDown(t)}),this.addEventListener("keyup",t=>{this._onKeyUp(t)})}_onKeyDown(t){switch(t.key){case"Enter":this._onEnter(t);break;case"Escape":this._onEscape(t)}}_onKeyUp(t){}_onEnter(t){}_onEscape(t){}}),Ms=t=>class extends(Is(js(t))){get _activeKeys(){return[" "]}ready(){super.ready(),ys(this,"down",t=>{this._shouldSetActive(t)&&this._setActive(!0)}),ys(this,"up",()=>{this._setActive(!1)})}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(t){return!this.disabled}_onKeyDown(t){super._onKeyDown(t),this._shouldSetActive(t)&&this._activeKeys.includes(t.key)&&(this._setActive(!0),document.addEventListener("keyup",t=>{this._activeKeys.includes(t.key)&&this._setActive(!1)},{once:!0}))}_setActive(t){this.toggleAttribute("active",t)}};let $s=!1;function Ps(){return $s}function Ls(t){const e=t.style;if("hidden"===e.visibility||"none"===e.display)return!0;const s=window.getComputedStyle(t);return"hidden"===s.visibility||"none"===s.display}function Ns(t){return t.checkVisibility?!t.checkVisibility({visibilityProperty:!0}):null===t.offsetParent&&0===t.clientWidth&&0===t.clientHeight||Ls(t)}function Bs(t){return t.getRootNode().activeElement===t}window.addEventListener("keydown",()=>{$s=!0},{capture:!0}),window.addEventListener("mousedown",()=>{$s=!1},{capture:!0});const Rs=Gt(t=>class extends t{get _keyboardActive(){return Ps()}ready(){this.addEventListener("focusin",t=>{this._shouldSetFocus(t)&&this._setFocused(!0)}),this.addEventListener("focusout",t=>{this._shouldRemoveFocus(t)&&this._setFocused(!1)}),super.ready()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}focus(t){super.focus(t),t&&!1===t.focusVisible||this.setAttribute("focus-ring","")}_setFocused(t){this.toggleAttribute("focused",t),this.toggleAttribute("focus-ring",t&&this._keyboardActive)}_shouldSetFocus(t){return!0}_shouldRemoveFocus(t){return!0}});export{Ms as A,Is as D,Wt as E,Rs as F,js as K,Oe as L,re as P,he as S,Fe as T,ue as a,Dt as b,Lt as c,vt as d,Bs as e,Ns as f,le as g,Gt as h,Ps as i,m as o,ct as p,Pt as t};
