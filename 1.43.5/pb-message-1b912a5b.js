...
*/;class kt{static detectScrollType(){const t=document.createElement("div");t.textContent="ABCD",t.dir="rtl",t.style.fontSize="14px",t.style.width="4px",t.style.height="1px",t.style.position="absolute",t.style.top="-1000px",t.style.overflow="scroll",document.body.appendChild(t);let e="reverse";return t.scrollLeft>0?e="default":(t.scrollLeft=2,t.scrollLeft<2&&(e="negative")),document.body.removeChild(t),e}static getNormalizedScrollLeft(t,e,i){const{scrollLeft:a}=i;if("rtl"!==e||!t)return a;switch(t){case"negative":return i.scrollWidth-i.clientWidth+a;case"reverse":return i.scrollWidth-i.clientWidth-a}return a}static setNormalizedScrollLeft(t,e,i,a){if("rtl"===e&&t)switch(t){case"negative":i.scrollLeft=i.clientWidth-i.scrollWidth+a;break;case"reverse":i.scrollLeft=i.scrollWidth-i.clientWidth-a;break;default:i.scrollLeft=a}else i.scrollLeft=a}}const It=[];let Ot;new MutationObserver((function(){const t=Tt();It.forEach(e=>{Bt(e,t)})})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Bt=function(t,e){e?t.setAttribute("dir",e):t.removeAttribute("dir")},Tt=function(){return document.documentElement.getAttribute("dir")},Et=t=>class extends t{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize(),Ot||(Ot=kt.detectScrollType())}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")||(this.__subscribe(),Bt(this,Tt()))}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"dir"!==t)return;const a=i===Tt()&&-1===It.indexOf(this),n=!i&&e&&-1===It.indexOf(this),o=i!==Tt()&&e===Tt();a||n?(this.__subscribe(),Bt(this,Tt())):o&&this.__subscribe(!1)}disconnectedCallback(){super.disconnectedCallback(),this.__subscribe(!1),this.removeAttribute("dir")}__subscribe(t=!0){t?-1===It.indexOf(this)&&It.push(this):It.indexOf(this)>-1&&It.splice(It.indexOf(this),1)}__getNormalizedScrollLeft(t){return kt.getNormalizedScrollLeft(Ot,this.getAttribute("dir")||"ltr",t)}__setNormalizedScrollLeft(t,e){return kt.setNormalizedScrollLeft(Ot,this.getAttribute("dir")||"ltr",t,e)}},Wt=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Ft=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function Nt(){function t(){return!0}return Gt(t)}function Rt(){try{return!!Pt()||!!jt()&&(Ft?!Dt():!Nt())}catch(t){return!1}}function Pt(){return localStorage.getItem("vaadin.developmentmode.force")}function jt(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function Dt(){if(Ft){if(Object.keys(Ft).map(t=>Ft[t]).filter(t=>t.productionMode).length>0)return!0}return!1}function Gt(t,e){if("function"!=typeof t)return;const i=Wt.exec(t.toString());if(i)try{t=new Function(i[1])}catch(t){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",t)}return t(e)}window.Vaadin=window.Vaadin||{};const Ut=function(t,e){if(window.Vaadin.developmentMode)return Gt(t,e)};function Kt(){}void 0===window.Vaadin.developmentMode&&(window.Vaadin.developmentMode=Rt());const Xt=function(){if("function"==typeof Ut)return Ut(Kt)};let qt;window.Vaadin||(window.Vaadin={}),window.Vaadin.registrations=window.Vaadin.registrations||[],window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{},window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){Xt&&Xt()};const Yt=new Set,Zt=t=>class extends(Et(t)){static finalize(){super.finalize();const{is:t}=this;t&&!Yt.has(t)&&(window.Vaadin.registrations.push(this),Yt.add(t),window.Vaadin.developmentModeCallback&&(qt=d.debounce(qt,m,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),v(qt)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}};class Qt extends H{static get styles(){return b`
        ...
        <paper-dialog id="modal">
            ...
            <paper-dialog-scrollable id="message" class="message" tabindex="0">${I(this.message)}</paper-dialog-scrollable>
