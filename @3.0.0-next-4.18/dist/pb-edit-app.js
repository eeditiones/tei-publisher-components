import{p as e,a as t,w as a,E as i,x as l,i as n}from"./pb-mixin-CJCn1VrV.js";import{t as s}from"./pb-i18n-D7JQ-z6N.js";import{l as o}from"./logger-BDsEU7Z8.js";import"./pb-dialog-xM4miV8Y.js";import"./unsafe-html-DIlZTsbV.js";class p extends(e(t)){static get properties(){return Object.assign(Object.assign({},super.properties),{},{error:{type:String},url:{type:String},templates:{type:Array},odds:{type:Array},_templateValue:{type:String},_defaultViewValue:{type:String},_indexValue:{type:String}})}constructor(){super(),this.templates=[],this.odds=[],this._templateValue="view.html",this._defaultViewValue="div",this._indexValue="tei:div"}connectedCallback(){super.connectedCallback()}firstUpdated(){const e=this.shadowRoot.getElementById("form");a("pb-page-ready",t=>{const a=t.endpoint,i=this.minApiVersion("1.0.0")?`${a}/api/templates`:`${a}/modules/lib/components-list-templates.xql`,l=this.minApiVersion("1.0.0")?`${a}/api/odd`:`${a}/modules/lib/components-list-odds.xql`,n=this.minApiVersion("1.0.0")?`${a}/api/apps/generate`:`${a}/modules/components-generate.xql`;e&&(e.action=n),(async()=>{try{const e=await fetch(i,{method:"GET",mode:"cors",credentials:"same-origin"}),t=await e.json(),a=Array.isArray(t)?t:[];this.templates=a,a.find(e=>e.name===this._templateValue)||(this._templateValue=a.length?a[0].name:""),this.requestUpdate()}catch(e){o.error("<pb-edit-app> Failed to load templates",e)}})(),(async()=>{try{const e=await fetch(l,{method:"GET",mode:"cors",credentials:"same-origin"}),t=await e.json();this.odds=Array.isArray(t)?t:[],this.requestUpdate()}catch(e){o.error("<pb-edit-app> Failed to load odds list",e)}})()}),e&&e.addEventListener("submit",this._handleSubmit.bind(this))}_doSubmit(){const e=this.shadowRoot.getElementById("form");e&&(e.requestSubmit?e.requestSubmit():e.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0})))}_renderTextField({id:e,name:t,type:a="text",required:n=!1,pattern:s,placeholder:o="",label:p}){return l`
    ...
    `}}customElements.define("pb-edit-app",p);export{p as PbEditApp};
