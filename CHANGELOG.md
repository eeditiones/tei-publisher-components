...
* **pb-authority:** do not requery if the query is the same ([27b49ea](https://github.com/eeditiones/tei-publisher-components/commit/27b49ea9b36f5d2e1fe99f57df596dcf2f05ec01))
* **pb-authority:** never translate the contents of pb-view-annotate ([c9a43c4](https://github.com/eeditiones/tei-publisher-components/commit/c9a43c42cab110c26ab6250a8b0ea0244a6579e7))
* **pb-view-annotate:** scroll marker into view instead of parent element ([f105004](https://github.com/eeditiones/tei-publisher-components/commit/f105004928d2acd1eb0ccec0d3605cdc0526920d))
...
* **airtable:** wait for airtable to be initialized before we query ([#290](https://github.com/eeditiones/tei-publisher-components/issues/290)) ([1758452](https://github.com/eeditiones/tei-publisher-components/commit/1758452001fc59425ca62dd56036294161bc2066))
...
* **build:** transform commonJS in jinn-codemirror dependency ([b8089cb](https://github.com/eeditiones/tei-publisher-components/commit/b8089cbd53d1bee58f1b22293048febd64467f43))
* **odd-editor:** update jinn-codemirror to fix an issue in Firefox ([faf3fcb](https://github.com/eeditiones/tei-publisher-components/commit/faf3fcbaa68d9b54d1716c0fb5a44b30ee6a1e69))

## [3.0.2](https://github.com/eeditiones/tei-publisher-components/compare/v3.0.1...v3.0.2) (2026-01-06)


### Bug Fixes

* **build:** transform commonJS in jinn-codemirror dependency ([ae2d12b](https://github.com/eeditiones/tei-publisher-components/commit/ae2d12b1f05961508e2f1b6bfc5353d9dd6aaf34))
* **odd-editor:** update jinn-codemirror to fix an issue in Firefox ([31ce15a](https://github.com/eeditiones/tei-publisher-components/commit/31ce15a5935a10278f64f9a5f646fde7aed13caa))
