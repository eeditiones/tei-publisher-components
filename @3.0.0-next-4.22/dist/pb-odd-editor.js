import{T as e,i as t,a as i,x as s,c as o,E as a,p as n,w as r}from"./pb-mixin-BUnZhCew.js";import{e as d,a as l,b as c,p,v as h,s as u,M as m,m as b,t as g,g as v}from"./pb-i18n-DpafwkRO.js";import{A as f,F as y,T as _,E as w,P as x,L as $,a as E,d as S,K as C,e as k,f as A,g as R,b as I,t as P,h as M,p as T}from"./focus-mixin-177q2Y1S.js";import{l as O}from"./logger-BDsEU7Z8.js";import"./jinn-codemirror-DETLdm08.js";import"./pb-dialog-69GQVfpQ.js";import"./unsafe-html-C8JBHfUC.js";import"./purify.es-DOKMcktY.js";const j=(()=>{if("undefined"==typeof self)return!1;if("top"in self&&self!==top)try{top.window.document._=0}catch(e){return!1}return"showOpenFilePicker"in self})();j?Promise.resolve().then(function(){return L}):Promise.resolve().then(function(){return G}),j?Promise.resolve().then(function(){return V}):Promise.resolve().then(function(){return X});const B=j?Promise.resolve().then(function(){return W}):Promise.resolve().then(function(){return Y});async function z(...e){return(await B).default(...e)}const q=async e=>{const t=await e.getFile();return t.handle=e,t};var N=async(e=[{}])=>{Array.isArray(e)||(e=[e]);const t=[];e.forEach((e,i)=>{t[i]={description:e.description||"Files",accept:{}},e.mimeTypes?e.mimeTypes.map(s=>{t[i].accept[s]=e.extensions||[]}):t[i].accept["*/*"]=e.extensions||[]});const i=await window.showOpenFilePicker({id:e[0].id,startIn:e[0].startIn,types:t,multiple:e[0].multiple||!1,excludeAcceptAllOption:e[0].excludeAcceptAllOption||!1}),s=await Promise.all(i.map(q));return e[0].multiple?s:s[0]},L={__proto__:null,default:N};function D(e){function t(e){if(Object(e)!==e)return Promise.reject(new TypeError(e+" is not an object."));var t=e.done;return Promise.resolve(e.value).then(function(e){return{value:e,done:t}})}return D=function(e){this.s=e,this.n=e.next},D.prototype={s:null,n:null,next:function(){return t(this.n.apply(this.s,arguments))},return:function(e){var i=this.s.return;return void 0===i?Promise.resolve({value:e,done:!0}):t(i.apply(this.s,arguments))},throw:function(e){var i=this.s.return;return void 0===i?Promise.reject(e):t(i.apply(this.s,arguments))}},new D(e)}const U=async(e,t,i=e.name,s)=>{const o=[],a=[];var n,r=!1,d=!1;try{for(var l,c=function(e){var t,i,s,o=2;for("undefined"!=typeof Symbol&&(i=Symbol.asyncIterator,s=Symbol.iterator);o--;){if(i&&null!=(t=e[i]))return t.call(e);if(s&&null!=(t=e[s]))return new D(t.call(e));i="@@asyncIterator",s="@@iterator"}throw new TypeError("Object is not async iterable")}(e.values());r=!(l=await c.next()).done;r=!1){const n=l.value,r=`${i}/${n.name}`;"file"===n.kind?a.push(n.getFile().then(t=>(t.directoryHandle=e,t.handle=n,Object.defineProperty(t,"webkitRelativePath",{configurable:!0,enumerable:!0,get:()=>r})))):"directory"!==n.kind||!t||s&&s(n)||o.push(U(n,t,r,s))}}catch(e){d=!0,n=e}finally{try{r&&null!=c.return&&await c.return()}finally{if(d)throw n}}return[...(await Promise.all(o)).flat(),...await Promise.all(a)]};var F=async(e={})=>{e.recursive=e.recursive||!1,e.mode=e.mode||"read";const t=await window.showDirectoryPicker({id:e.id,startIn:e.startIn,mode:e.mode});return(await(await t.values()).next()).done?[t]:U(t,e.recursive,void 0,e.skipDirectory)},V={__proto__:null,default:F},K=async(e,t=[{}],i=null,s=!1,o=null)=>{Array.isArray(t)||(t=[t]),t[0].fileName=t[0].fileName||"Untitled";const a=[];let n=null;if(e instanceof Blob&&e.type?n=e.type:e.headers&&e.headers.get("content-type")&&(n=e.headers.get("content-type")),t.forEach((e,t)=>{a[t]={description:e.description||"Files",accept:{}},e.mimeTypes?(0===t&&n&&e.mimeTypes.push(n),e.mimeTypes.map(i=>{a[t].accept[i]=e.extensions||[]})):n?a[t].accept[n]=e.extensions||[]:a[t].accept["*/*"]=e.extensions||[]}),i)try{await i.getFile()}catch(e){if(i=null,s)throw e}const r=i||await window.showSaveFilePicker({suggestedName:t[0].fileName,id:t[0].id,startIn:t[0].startIn,types:a,excludeAcceptAllOption:t[0].excludeAcceptAllOption||!1});!i&&o&&o(r);const d=await r.createWritable();if("stream"in e){const t=e.stream();return await t.pipeTo(d),r}return"body"in e?(await e.body.pipeTo(d),r):(await d.write(await e),await d.close(),r)},W={__proto__:null,default:K},H=async(e=[{}])=>(Array.isArray(e)||(e=[e]),new Promise((t,i)=>{const s=document.createElement("input");s.type="file";const o=[...e.map(e=>e.mimeTypes||[]),...e.map(e=>e.extensions||[])].join();s.multiple=e[0].multiple||!1,s.accept=o||"",s.style.display="none",document.body.append(s),s.addEventListener("cancel",()=>{s.remove(),i(new DOMException("The user aborted a request.","AbortError"))}),s.addEventListener("change",()=>{s.remove(),t(s.multiple?Array.from(s.files):s.files[0])}),"showPicker"in HTMLInputElement.prototype?s.showPicker():s.click()})),G={__proto__:null,default:H},J=async(e=[{}])=>(Array.isArray(e)||(e=[e]),e[0].recursive=e[0].recursive||!1,new Promise((t,i)=>{const s=document.createElement("input");s.type="file",s.webkitdirectory=!0,s.style.display="none",document.body.append(s),s.addEventListener("cancel",()=>{s.remove(),i(new DOMException("The user aborted a request.","AbortError"))}),s.addEventListener("change",()=>{s.remove();let i=Array.from(s.files);e[0].recursive?e[0].recursive&&e[0].skipDirectory&&(i=i.filter(t=>t.webkitRelativePath.split("/").every(t=>!e[0].skipDirectory({name:t,kind:"directory"})))):i=i.filter(e=>2===e.webkitRelativePath.split("/").length),t(i)}),"showPicker"in HTMLInputElement.prototype?s.showPicker():s.click()})),X={__proto__:null,default:J},Q=async(e,t={})=>{Array.isArray(t)&&(t=t[0]);const i=document.createElement("a");let s=e;"body"in e&&(s=await async function(e,t){const i=e.getReader(),s=new ReadableStream({start:e=>async function t(){return i.read().then(({done:i,value:s})=>{if(!i)return e.enqueue(s),t();e.close()})}()}),o=new Response(s),a=await o.blob();return i.releaseLock(),new Blob([a],{type:t})}(e.body,e.headers.get("content-type"))),i.download=t.fileName||"Untitled",i.href=URL.createObjectURL(await s);const o=()=>{"function"==typeof a&&a()},a=t.legacySetup&&t.legacySetup(o,()=>a(),i);return i.addEventListener("click",()=>{setTimeout(()=>URL.revokeObjectURL(i.href),3e4),o()}),i.click(),null},Y={__proto__:null,default:Q};const Z=(e,t,i)=>{const s=new Map;for(let o=t;o<=i;o++)s.set(e[o],o);return s},ee=d(class extends l{constructor(e){if(super(e),e.type!==c.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const o=[],a=[];let n=0;for(const t of e)o[n]=s?s(t,n):n,a[n]=i(t,n),n++;return{values:a,keys:o}}render(e,t,i){return this.dt(e,t,i).values}update(t,[i,s,o]){const a=p(t),{values:n,keys:r}=this.dt(i,s,o);if(!Array.isArray(a))return this.ut=r,n;const d=this.ut??=[],l=[];let c,g,v=0,f=a.length-1,y=0,_=n.length-1;for(;v<=f&&y<=_;)if(null===a[v])v++;else if(null===a[f])f--;else if(d[v]===r[y])l[y]=h(a[v],n[y]),v++,y++;else if(d[f]===r[_])l[_]=h(a[f],n[_]),f--,_--;else if(d[v]===r[_])l[_]=h(a[v],n[_]),u(t,l[_+1],a[v]),v++,_--;else if(d[f]===r[y])l[y]=h(a[f],n[y]),u(t,a[v],a[f]),f--,y++;else if(void 0===c&&(c=Z(r,y,_),g=Z(d,v,f)),c.has(d[v]))if(c.has(d[f])){const e=g.get(r[y]),i=void 0!==e?a[e]:null;if(null===i){const e=u(t,a[v]);h(e,n[y]),l[y]=e}else l[y]=h(i,n[y]),u(t,a[v],i),a[e]=null;y++}else m(a[f]),f--;else m(a[v]),v++;for(;y<=_;){const e=u(t,l[_+1]);h(e,n[y]),l[y++]=e}for(;v<=f;){const e=a[v++];null!==e&&m(e)}return this.ut=r,b(t,l),e}}),te=e=>class extends(f(y(e))){static get properties(){return{_hasVaadinItemMixin:{value:!0},selected:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_selectedChanged",sync:!0},_value:String}}get _activeKeys(){return["Enter"," "]}get value(){return void 0!==this._value?this._value:this.textContent.trim()}set value(e){this._value=e}ready(){super.ready();const e=this.getAttribute("value");null!==e&&(this.value=e)}focus(e){this.disabled||super.focus(e)}_shouldSetActive(e){return!(this.disabled||"keydown"===e.type&&e.defaultPrevented)}_selectedChanged(e){this.setAttribute("aria-selected",e)}_disabledChanged(e){super._disabledChanged(e),e&&(this.selected=!1,this.blur())}_onKeyDown(e){super._onKeyDown(e),this._activeKeys.includes(e.key)&&!e.defaultPrevented&&(e.preventDefault(),this.click())}},ie=t`
  :host {
    flex-shrink: 0;
    display: flex;
    align-items: center;
...
`;class se extends(te(_(w(x($(i)))))){static get is(){return"vaadin-tab"}static get styles(){return ie}render(){return s`
      <slot></slot>
      <slot name="tooltip"></slot>
    `}ready(){super.ready(),this.setAttribute("role","tab"),this._tooltipController=new E(this),this.addController(this._tooltipController)}_onKeyUp(e){const t=this.hasAttribute("active");if(super._onKeyUp(e),t){const e=this.querySelector("a");e&&e.click()}}}S(se);const oe=t`
  :host {
    display: flex;
    max-width: 100%;
    max-height: 100%;
...
`;function ae(e,t){const{scrollLeft:i}=e;return"rtl"!==t?i:e.scrollWidth-e.clientWidth+i}function ne(e,t,i){e.scrollLeft="rtl"!==t?i:e.clientWidth-e.scrollWidth+i}const re=e=>class extends(C(e)){get focused(){return(this._getItems()||[]).find(k)}get _vertical(){return!0}get _tabNavigation(){return!1}focus(e){const t=this._getFocusableIndex();t>=0&&this._focus(t,e)}_getFocusableIndex(){const e=this._getItems();return Array.isArray(e)?this._getAvailableIndex(e,0,null,e=>!A(e)):-1}_getItems(){return Array.from(this.children)}_onKeyDown(e){if(super._onKeyDown(e),e.metaKey||e.ctrlKey)return;const{key:t,shiftKey:i}=e,s=this._getItems()||[],o=s.indexOf(this.focused);let a,n;const r=!this._vertical&&"rtl"===this.getAttribute("dir")?-1:1;this.__isPrevKeyPressed(t,i)?(n=-r,a=o-r):this.__isNextKeyPressed(t,i)?(n=r,a=o+r):"Home"===t?(n=1,a=0):"End"===t&&(n=-1,a=s.length-1),a=this._getAvailableIndex(s,a,n,e=>!A(e)),this._tabNavigation&&"Tab"===t&&(a>o&&e.shiftKey||a<o&&!e.shiftKey||a===o)||a>=0&&(e.preventDefault(),this._focus(a,{focusVisible:!0},!0))}__isPrevKeyPressed(e,t){return this._vertical?"ArrowUp"===e:"ArrowLeft"===e||this._tabNavigation&&"Tab"===e&&t}__isNextKeyPressed(e,t){return this._vertical?"ArrowDown"===e:"ArrowRight"===e||this._tabNavigation&&"Tab"===e&&!t}_focus(e,t,i=!1){const s=this._getItems();this._focusItem(s[e],t,i)}_focusItem(e,t){e&&e.focus(t)}_getAvailableIndex(e,t,i,s){const o=e.length;let a=t;for(let t=0;"number"==typeof a&&t<o;t+=1,a+=i||1){a<0?a=o-1:a>=o&&(a=0);const t=e[a];if(this._isItemFocusable(t)&&this.__isMatchingItem(t,s))return a}return-1}__isMatchingItem(e,t){return"function"!=typeof t||t(e)}_isItemFocusable(e){return!e.hasAttribute("disabled")}},de=e=>class extends(re(e)){static get properties(){return{disabled:{type:Boolean,value:!1,reflectToAttribute:!0},selected:{type:Number,reflectToAttribute:!0,notify:!0,sync:!0},orientation:{type:String,reflectToAttribute:!0,value:""},items:{type:Array,readOnly:!0,notify:!0},_searchBuf:{type:String,value:""}}}static get observers(){return["_enhanceItems(items, orientation, selected, disabled)"]}get _isRTL(){return!this._vertical&&"rtl"===this.getAttribute("dir")}get _scrollerElement(){return console.warn(`Please implement the '_scrollerElement' property in <${this.localName}>`),this}get _vertical(){return"horizontal"!==this.orientation}focus(e){this._observer&&this._observer.flush();const t=Array.isArray(this.items)?this.items:[],i=this._getAvailableIndex(t,0,null,e=>0===e.tabIndex&&!A(e));i>=0?this._focus(i,e):super.focus(e)}ready(){super.ready(),this.addEventListener("click",e=>this._onClick(e));const e=this.shadowRoot.querySelector("slot:not([name])");this._observer=new R(e,()=>{this._setItems(this._filterItems([...this.children]))})}_getItems(){return this.items}_enhanceItems(e,t,i,s){if(!s&&e){this.setAttribute("aria-orientation",t||"vertical"),e.forEach(e=>{t?e.setAttribute("orientation",t):e.removeAttribute("orientation")}),this._setFocusable(i<0||!i?0:i);const s=e[i];e.forEach(e=>{e.selected=e===s}),s&&!s.disabled&&this._scrollToItem(i)}}_filterItems(e){return e.filter(e=>e._hasVaadinItemMixin)}_onClick(e){if(e.metaKey||e.shiftKey||e.ctrlKey||e.defaultPrevented)return;const t=this._filterItems(e.composedPath())[0];let i;t&&!t.disabled&&(i=this.items.indexOf(t))>=0&&(this.selected=i)}_searchKey(e,t){this._searchReset=I.debounce(this._searchReset,P.after(500),()=>{this._searchBuf=""}),this._searchBuf+=t.toLowerCase(),this.items.some(e=>this.__isMatchingKey(e))||(this._searchBuf=t.toLowerCase());const i=1===this._searchBuf.length?e+1:e;return this._getAvailableIndex(this.items,i,1,e=>this.__isMatchingKey(e)&&"none"!==getComputedStyle(e).display)}__isMatchingKey(e){return e.textContent.replace(/[^\p{L}\p{Nd}]/gu,"").toLowerCase().startsWith(this._searchBuf)}_onKeyDown(e){if(e.metaKey||e.ctrlKey)return;const t=e.key,i=this.items.indexOf(this.focused);if(/[\p{L}\p{Nd}]/u.test(t)&&1===t.length){const e=this._searchKey(i,t);return void(e>=0&&this._focus(e))}super._onKeyDown(e)}_setFocusable(e){e=this._getAvailableIndex(this.items,e,1);const t=this.items[e];this.items.forEach(e=>{e.tabIndex=e===t?0:-1})}_focus(e,t){this.items.forEach((t,i)=>{t.focused=i===e}),this._setFocusable(e),this._scrollToItem(e),super._focus(e,t)}_scrollToItem(e){const t=this.items[e];if(!t)return;const i=this._vertical?["top","bottom"]:this._isRTL?["right","left"]:["left","right"],s=this._scrollerElement.getBoundingClientRect(),o=(this.items[e+1]||t).getBoundingClientRect(),a=(this.items[e-1]||t).getBoundingClientRect();let n=0;!this._isRTL&&o[i[1]]>=s[i[1]]||this._isRTL&&o[i[1]]<=s[i[1]]?n=o[i[1]]-s[i[1]]:(!this._isRTL&&a[i[0]]<=s[i[0]]||this._isRTL&&a[i[0]]>=s[i[0]])&&(n=a[i[0]]-s[i[0]]),this._scroll(n)}_scroll(e){if(this._vertical)this._scrollerElement.scrollTop+=e;else{const t=this.getAttribute("dir")||"ltr",i=ae(this._scrollerElement,t)+e;ne(this._scrollerElement,t,i)}}},le=new ResizeObserver(e=>{setTimeout(()=>{e.forEach(e=>{e.target.isConnected&&(e.target.resizables?e.target.resizables.forEach(t=>{t._onResize(e.contentRect)}):e.target._onResize(e.contentRect))})})}),ce=M(e=>class extends e{get _observeParent(){return!1}connectedCallback(){if(super.connectedCallback(),le.observe(this),this._observeParent){const e=this.parentNode instanceof ShadowRoot?this.parentNode.host:this.parentNode;e.resizables||(e.resizables=new Set,le.observe(e)),e.resizables.add(this),this.__parent=e}}disconnectedCallback(){super.disconnectedCallback(),le.unobserve(this);const e=this.__parent;if(this._observeParent&&e){const t=e.resizables;t&&(t.delete(this),0===t.size&&le.unobserve(e)),this.__parent=null}}_onResize(e){}}),pe=e=>class extends(ce(de(e))){static get properties(){return{orientation:{value:"horizontal",type:String,reflectToAttribute:!0,sync:!0},selected:{value:0,type:Number,reflectToAttribute:!0}}}static get observers(){return["__tabsItemsChanged(items)"]}constructor(){super(),this.__itemsResizeObserver=new ResizeObserver(()=>{setTimeout(()=>this._updateOverflow())})}get _scrollOffset(){return this._vertical?this._scrollerElement.offsetHeight:this._scrollerElement.offsetWidth}get _scrollerElement(){return this.$.scroll}get __direction(){return!this._vertical&&this.__isRTL?1:-1}ready(){super.ready(),this._scrollerElement.addEventListener("scroll",()=>this._updateOverflow()),this.setAttribute("role","tablist")}_onResize(){this._updateOverflow()}__tabsItemsChanged(e){this.__itemsResizeObserver.disconnect(),(e||[]).forEach(e=>{this.__itemsResizeObserver.observe(e)}),this._updateOverflow()}_scrollForward(){const e=this._getNavigationButtonVisibleWidth("forward-button"),t=this._getNavigationButtonVisibleWidth("back-button"),i=this._scrollerElement.getBoundingClientRect(),s=[...this.items].reverse().find(s=>this._isItemVisible(s,e,t,i)).getBoundingClientRect(),o=20+this.shadowRoot.querySelector('[part="back-button"]').clientWidth;let a;if(this.__isRTL){const e=i.right-o;a=s.right-e}else{const e=i.left+o;a=s.left-e}-this.__direction*a<1&&(a=-this.__direction*(this._scrollOffset-o)),this._scroll(a)}_scrollBack(){const e=this._getNavigationButtonVisibleWidth("forward-button"),t=this._getNavigationButtonVisibleWidth("back-button"),i=this._scrollerElement.getBoundingClientRect(),s=this.items.find(s=>this._isItemVisible(s,e,t,i)).getBoundingClientRect(),o=20+this.shadowRoot.querySelector('[part="forward-button"]').clientWidth;let a;if(this.__isRTL){const e=i.left+o;a=s.left-e}else{const e=i.right-o;a=s.right-e}this.__direction*a<1&&(a=this.__direction*(this._scrollOffset-o)),this._scroll(a)}_isItemVisible(e,t,i,s){if(this._vertical)throw new Error("Visibility check is only supported for horizontal tabs.");const o=this.__isRTL?i:t,a=this.__isRTL?t:i,n=s.right-o,r=s.left+a,d=e.getBoundingClientRect();return n>Math.floor(d.left)&&r<Math.ceil(d.right)}_getNavigationButtonVisibleWidth(e){const t=this.shadowRoot.querySelector(`[part="${e}"]`);return"0"===window.getComputedStyle(t).opacity?0:t.clientWidth}_updateOverflow(){const e=this._vertical?this._scrollerElement.scrollTop:ae(this._scrollerElement,this.getAttribute("dir")),t=this._vertical?this._scrollerElement.scrollHeight:this._scrollerElement.scrollWidth;let i=Math.floor(e)>1?"start":"";Math.ceil(e)<Math.ceil(t-this._scrollOffset)&&(i+=" end"),1===this.__direction&&(i=i.replace(/start|end/giu,e=>"start"===e?"end":"start")),i?this.setAttribute("overflow",i.trim()):this.removeAttribute("overflow")}};class he extends(pe(w(_(x($(i)))))){static get is(){return"vaadin-tabs"}static get styles(){return oe}render(){return s`
    ...
    `}}S(he);class ue extends i{static get styles(){return t`
      :host {
        display: block;
      }
      .wrapper {
    ...
    `}render(){return s`
      ...
      <slot></slot>
    `}static get properties(){return{scopes:{type:Array},css:{type:String,reflect:!0},scope:{type:String,reflect:!0},selected:{type:String}}}constructor(){super(),this.scopes=["","before","after"],this.css="";const e=this.getAttribute("scope");this.scope=null!=e?e:"",this.selected="",this._initialized=!1}connectedCallback(){super.connectedCallback(),this.css=this.css.trim(),this.dispatchEvent(new CustomEvent("rendition-connected",{composed:!0,bubbles:!0,detail:{target:this}}))}firstUpdated(e){this.refreshEditor(),this._initialized=!0}refreshEditor(){O.log("refreshEditor"),this.shadowRoot.getElementById("editor")}_remove(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("remove-rendition",{}))}_handleCodeChange(){this.css=this.shadowRoot.getElementById("editor").value,this._emitChange()}_handleScopeChange(e){this.scope=e.target.value,this._emitChange()}_emitChange(){this.dispatchEvent(new CustomEvent("rendition-changed",{composed:!0,bubbles:!0,detail:{name:this.name,css:this.css,scope:this.scope}}))}_displayScope(e){return e||"(default)"}}customElements.define("pb-odd-rendition-editor",ue);class me extends i{static get styles(){return t`
      :host {
        display: block;
      }
      .wrapper {
      ...
      <div class="wrapper">
        <div class="pb-field">
          <span class="pb-field__label"
            >${g("odd.editor.model.param-name-placeholder")}</span
          >
          <pb-autocomplete
            id="combo"
            .suggestions=${this._currentParameters}
            .value=${this.name||""}
            placeholder="${g("odd.editor.model.param-name-placeholder")}"
        ...
        <div class="editor">
          ...
          <jinn-codemirror
            ...
            mode="xquery"
            code="${this.value}"
            linter="${this.endpoint}/${o(this.apiVersion,"1.0.0")?"modules/editor.xql":"api/lint"}"
          ></jinn-codemirror>
        </div>
        <label class="pb-checkbox">
          ...
          />
          <span>${g("odd.editor.model.set-param")}</span>
        </label>
        <pb-icon-button
          class="icon-button"
          icon="delete"
    ...
    `}static get properties(){return{behaviour:{type:String},predicate:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},type:{type:String,reflect:!0},template:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},output:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},css:{type:String,converter:(e,t)=>"null"===e.toLowerCase()?"":e},mode:{type:String},model:{type:Object},models:{type:Array},parameters:{type:Array},renditions:{type:Array},desc:{type:String,converter:(e,t)=>"null"===e.toLowerCase()?"":e},sourcerend:{type:String},show:{type:Boolean,reflect:!0},outputs:{type:Array},behaviours:{type:Array},icon:{type:String},open:{type:String},hasCustomBehaviour:{type:Boolean},endpoint:{type:String},apiVersion:{type:String}}}constructor(){super(),this.behaviour="inline",this.predicate="",this.type="",this.template="",this.output="",this.css="",this.mode="",this.model={},this.model.models=[],this.parameters=[],this.renditions=[],this.desc="",this.sourcerend="",this.show=!1,this.outputs=["","web","print","epub","fo","latex","plain"],this.parentModel=[],this.behaviours=["alternate","anchor","block","body","break","cell","cit","document","figure","graphic","heading","inline","link","list","listItem","metadata","note","omit","paragraph","pass-through","row","section","table","text","title","webcomponent"],this.icon="expand-more",this.hasCustomBehaviour=!1}render(){let e;switch(this.output){case"web":case"epub":default:e="html";break;case"latex":e="tex";break;case"plain":e="default";break;case"fo":case"print":e="xml"}return s`
        <form>
            ...
            <details ?open="${this.show}" class="details">
                ...
                <div class="horizontal">
                    <label class="pb-field selectOutput">
                      <span class="pb-field__label">${g("odd.editor.model.output")}</span>
                      <select
                        id="output"
                        class="pb-select"
                        .value=${this.output||""}
                    ...
                    <label class="pb-field">
                      <span class="pb-field__label">${g("odd.editor.model.mode-placeholder")}</span>
                      <input
                        id="mode"
                        class="pb-input"
                        .value=${this.mode||""}
                        placeholder="${g("odd.editor.model.mode-placeholder")}"
                        @change=${this._inputMode}
                      />
                    </label>
                </div>
                <label class="pb-field">
                  <span class="pb-field__label">${g("odd.editor.model.description-placeholder")}</span>
                  <input
                    id="desc"
                    class="pb-input"
                    .value=${this.desc||""}
                    placeholder="${g("odd.editor.model.description-placeholder")}"
                ...
                <div class="editor">
                    ...
                    <jinn-codemirror id="predicate"
                        code="${this.predicate}"
                        mode="xquery"
                        linter="${this.endpoint}/${o(this.apiVersion,"1.0.0")<0?"modules/editor.xql":"api/lint"}"
                        placeholder="${g("odd.editor.model.predicate-placeholder")}"
                ...
                ${this._isModel()?s`
                        <div>
                          <div class="behaviourWrapper">
                            <label class="pb-field">
                              <span class="pb-field__label"
                                >${g("odd.editor.model.behaviour")}</span
                              >
                              <select
                                id="behaviour"
                                class="pb-select"
                            ...
                            <span style="align-self:center;justify-self: center;">
                              ${g("odd.editor.model.link-with-or")}
                            </span>
                            <label class="pb-field">
                              <span class="pb-field__label"
                                >${g("odd.editor.model.custom-behaviour-placeholder")}</span
                              >
                              <input
                                id="custombehaviour"
                                class="pb-input"
                                @input=${this._handleCustomBehaviour}
                                placeholder="${g("odd.editor.model.custom-behaviour-placeholder")}"
                              />
                            </label>
                            <span></span>
                          </div>
                          ...
                          <label class="pb-field">
                            ...
                            <input
                              ...
                              class="pb-input"
                              .value=${this.css||""}
                              placeholder="${g("odd.editor.model.css-class-placeholder")}"
                          ...
                          <div class="editor">
                            ...
                            <jinn-codemirror
                              ...
                              code="${this.template}"
                              mode="${e}"
                              placeholder="${g("odd.editor.model.template-placeholder")}"
                        ...
                        <div class="parameters">
                          ...
                          ${ee(this.parameters||[],e=>e.name,(e,t)=>s`
                        ...
                        <div class="renditions">
                          ...
                          ${ee(this.renditions||[],e=>e.name,(e,t)=>s`
            ...
            <div class="models">
                ${ee(this.model&&this.model.models||[],(e,t)=>s`
                    <pb-odd-model-editor
      ...
      <div id="layout">
        <div id="drawer">
          ...
          <h3>
            ...
            <span class="icons">
              <pb-edit-xml id="editSource"
                ><pb-icon-button
                  icon="code"
                  title="${g("odd.editor.odd-source")}"
                ></pb-icon-button
              ></pb-edit-xml>
              <pb-icon-button
                @click="${()=>this.save(!0)}"
                icon="icons:cloud-download"
                title="${g(j?"odd.editor.save-as":"odd.editor.download")}"
              ></pb-icon-button>
              <pb-icon-button
                @click="${this._reload}"
                icon="refresh"
                title="${g("odd.editor.reload")}"
              ></pb-icon-button>
              <pb-icon-button
                @click="${()=>this.save(!1)}"
                icon="save"
                title="${g("odd.editor.save")} ${this.display("save")}"
          ...
          <div id="new-element" class="input-group">
            <label class="pb-field">
              <span class="pb-field__label">${g("odd.editor.add-element")}</span>
              <div class="pb-input-with-button">
                <input
                  id="identNew"
                  class="pb-input"
                  name="ident-new"
                  placeholder="${g("odd.editor.add-element")}"
                />
                <pb-icon-button
          ...
          <div id="jump-to">
            <pb-autocomplete
              id="jumpTo"
              placeholder="${g("odd.editor.jump-to")}"
            ></pb-autocomplete>
          </div>

          <h3>${g("odd.editor.specs")}</h3>
        </div>
        <div id="navlist">
          ${ee(this.elementSpecs||[],e=>e.ident,(e,t)=>s`
                <button
                  id="es_${e.ident}"
                  type="button"
          ...
          <div class="metadata-card">
            <pb-collapse id="meta">
              ...
              <div slot="collapse-content">
                <label class="pb-field">
                  <span class="pb-field__label">${g("odd.editor.title")}</span>
                  <input
                    id="title"
                    class="pb-input"
                    name="title"
                    .value=${this.title||""}
                    placeholder="[${g("odd.editor.title-placeholder")}]"
                    @change=${this._inputTitle}
                  />
                </label>
                <label class="pb-field">
                  <span class="pb-field__label">${g("odd.editor.title-short")}</span>
                  <input
                    id="titleShort"
                    class="pb-input"
                    name="short-title"
                    .value=${this.titleShort||""}
                    placeholder="[${g("odd.editor.title-short-placeholder")}]"
                    @change=${e=>this.titleShort=e.target.value}
                  />
                </label>
                <label class="pb-field">
                  <span class="pb-field__label">${g("odd.editor.description-label")}</span>
                  <input
                    id="description"
                    class="pb-input"
                    name="description"
                    .value=${this.description||""}
                    placeholder="[${g("odd.editor.description-placeholder")}]"
                    @change=${e=>this.description=e.target.value}
                  />
                </label>
                <label class="pb-field">
                  <span class="pb-field__label">${g("odd.editor.source-label")}</span>
                  <input
                    id="source"
                    class="pb-input"
                    name="source"
                    .value=${this.source||""}
                    placeholder="[${g("odd.editor.source-placeholder")}]"
                ...
                <label class="pb-checkbox">
                  ...
                  />
                  <span>${g("odd.editor.use-namespace")}</span>
                </label>
                <label class="pb-field">
                  ...
                  <input
                    ...
                    placeholder="[${g("odd.editor.namespace-placeholder")}]"
    ...
    `}firstUpdated(e){this.shadowRoot.getElementById("useNamespace").checked=this.useNamespace,this.jumpCtrl=this.shadowRoot.getElementById("jumpTo"),this.jumpCtrl.addEventListener("pb-autocomplete-selected",this.jumpTo.bind(this));const t=this.querySelector("odd-selector");this.odd&&t&&(t.selected=this.odd,t.addEventListener("odd-selected",e=>{confirm("Any unsaved changes will be lost. Continue?")&&(this.odd=e.detail.odd,window.history.pushState({},"",`?odd=${this.odd}`)),t.selected=this.odd})),this.addEventListener("current-changed",this._changeSelection),this.addEventListener("odd-copy",e=>this._copy(e)),this.addEventListener("odd-paste",e=>this._paste(e)),this.addEventListener("element-spec-removed",this.removeElementSpec.bind(this)),window.addEventListener("beforeunload",()=>"Any unsaved changes will be lost. Continue?"),this.subscribeTo("pb-login",e=>{this.loggedIn=null!=e.detail.user}),this.focus(),this.loadContent=this.shadowRoot.getElementById("loadContent"),this.rootPath=this.getAttribute("root-path"),r("pb-page-ready",()=>{this.load(),this.inited=!0}),this.registerHotkey("save",()=>this.save(!1))}setUseNamespace(){this.useNamespace=this.shadowRoot.getElementById("useNamespace").checked}async load(){if(this.loading)return;if(this.loading=!0,""===this.rootPath||""===this.odd)return;this.elementSpecs=[],this._tabs=[],this.tabIndex=0,document.dispatchEvent(new CustomEvent("pb-start-update"));this.shadowRoot.getElementById("editSource").setPath(`${this.rootPath}/${this.odd}`);const e={odd:this.odd,root:this.rootPath};this.loadContent.params=e,this.loadContent.url=`${this.getEndpoint()}/${this.lessThanApiVersion("1.0.0")?"modules/editor.xql":`api/odd/${this.odd}`}`,this.loadContent.headers={Accept:"application/json"};const t=this.loadContent.generateRequest();if(this._hasChanges=!1,!t)return O.warn("pb-odd-editor: Failed to generate request - invalid URL"),this.loading=!1,void document.dispatchEvent(new CustomEvent("pb-end-update"));(async()=>{try{const e=await t;this.handleOdd({response:e})}catch(e){O.warn("pb-odd-editor: Failed to load ODD data:",e),this.loading=!1,document.dispatchEvent(new CustomEvent("pb-end-update"))}})()}handleOdd(e){const t=e.response;if(t){if(this.loggedIn=t.canWrite,this.source=t.source,this.title=t.title,this.titleShort=t.titleShort,this.description=t.description,this.cssFile=null==t.cssFile?"":t.cssFile,this.namespace=null!=t.namespace?t.namespace:"",this.useNamespace=null!=t.namespace,this.cssFile){this.shadowRoot.getElementById("editCSS").setPath(`${this.rootPath}/${this.cssFile}`)}t.elementSpecs&&Array.isArray(t.elementSpecs)?this.elementSpecs=t.elementSpecs.map(e=>this.mapElementSpec(e)):(O.warn("pb-odd-editor: elementSpecs data is missing or invalid"),this.elementSpecs=[]),this._updateAutoComplete(),this.requestUpdate(),this.loading=!1,document.dispatchEvent(new CustomEvent("pb-end-update")),document.title=this.titleShort||this.title}else O.warn("pb-odd-editor: Failed to load ODD data")}_updateAutoComplete(){this.shadowRoot.getElementById("jumpTo").suggestions=this.elementSpecs.map(this._specMapper)}_cssFileChanged(e){if(this.cssFile=e.target.value,this.cssFile){this.shadowRoot.getElementById("editCSS").setPath(`${this.rootPath}/${this.cssFile}`)}}_navlistActiveChanged(e,t){this.selectedNavIndex=t,this.requestUpdate()}_returnTabs(){return this.tabs}_selectTab(e,t){const i=this.elementSpecs.find(e=>e.ident===t);this._updateElementspec(i)}_openElementSpec(e,t){O.log("_openElementSpec ",e,t);const i=this.elementSpecs[t];this._updateElementspec(i),this.selectedNavIndex=t,this.requestUpdate();const{ident:s}=i;if(this.tabs.indexOf(s)>=0)return this.tabIndex=this.tabs.indexOf(s),void this.requestUpdate();this.tabs.push(s),this.tabIndex=this.tabs.length-1,this.requestUpdate()}_updateElementspec(e){const t=this.shadowRoot.getElementById("currentElement");t.innerHTML="";const i=new ge;i.addEventListener("element-spec-changed",this.handleElementSpecChanged.bind(this)),i.ident=e.ident,i.models=e.models,i.mode=e.mode,i.endpoint=this._endpoint,i.apiVersion=this._apiVersion,i.hotkeys=this.hotkeys,t.appendChild(i)}_closeTabHandler(e,t){return O.log("_closeTabHandler ",t),e.preventDefault(),e.stopPropagation(),this._closeTab(t),!1}_closeTab(e){const t=[...this.tabs];if(t.splice(e,1),0===t.length)this.shadowRoot.getElementById("currentElement").innerHTML="",this.tabIndex=0,this.tabs=[];else if(this.tabIndex>0&&this.tabIndex>=e){this.tabIndex-=1,this.tabs=t;const e=this.tabs[this.tabIndex];this._selectTab(null,e)}else this.tabs=t}attributeChangedCallback(e,t,i){super.attributeChangedCallback(e,t,i),"odd"==e&&t!==i&&this.inited&&this.load()}static get replaceCharMap(){return{'"':"&quot;","&":"&amp;","<":"&lt;",">":"&gt;"}}static get replaceCharRegexp(){return/"|&|<|>/g}static replaceChars(e){return ve.replaceCharMap[e]}jumpTo(e){var t,i,s;const o=((null==e||null===(t=e.detail)||void 0===t?void 0:t.value)||(null==e||null===(i=e.detail)||void 0===i?void 0:i.text)||(null===(s=this.jumpCtrl)||void 0===s?void 0:s.value)||"").trim();if(!o)return;const a=this.shadowRoot.querySelector(`#es_${o}`);a&&(this.jumpCtrl&&(this.jumpCtrl.value=""),a.click())}_computedTitle(){return this.odd?this.title||this.titleShort||this.odd||"Loading ...":""}_copy(e){this.clipboard=e.detail.model;const t=JSON.parse(JSON.stringify(e.detail.model));this.clipboard=t}_paste(e){if(O.log("_paste ",e),O.log("_paste clipboard",this.clipboard),this.clipboard=={}||null==this.clipboard)return;const t=e.detail.target;t.addModel(this.clipboard),t.render()}_specMapper(e){return{text:e.ident,value:e.ident}}_specObserver(e){const t=this.elementSpecs.map(this._specMapper);this.jumpCtrl.suggestions=t}mapElementSpec(e){return Object.assign(Object.assign({},e),{},{models:e.models.map(e=>this.addShowToModel(e))})}addShowToModel(e){if(e.models){const t=e.models.map(e=>this.addShowToModel(e));return Object.assign(Object.assign({},e),{},{models:t,show:!1})}return Object.assign(Object.assign({},e),{},{show:!1})}addElementSpec(e){const t=this.shadowRoot.getElementById("identNew").value;if(!t||0===t.length)return;if(this.elementSpecs.find(e=>e.ident===t)){O.log("<pb-odd-editor> element spec to be added already exists: %s",t);const e=`#es_${t}`,i=this.shadowRoot.querySelector(e);if(!i)return;return void i.click()}const i={action:"find",odd:this.odd,root:this.rootPath,ident:t},s={root:this.rootPath,ident:t},o=this.lessThanApiVersion("1.0.0")?i:s;this.loadContent.params=o,this.loadContent.url=`${this.getEndpoint()}/${this.lessThanApiVersion("1.0.0")?"modules/editor.xql":`api/odd/${this.odd}`}`;const a=this.loadContent.generateRequest();(async()=>{try{const e=await a;this._handleElementSpecResponse({response:e})}catch(e){O.error("<pb-odd-editor> Failed to load element spec:",e)}})()}_handleElementSpecResponse(e){const t=this.shadowRoot.getElementById("identNew"),i=e.response,s=t.value,o={ident:s,mode:"not-found"===i.status?"add":"change",models:i.models||[]};this.elementSpecs.unshift(o),t.value="",this.tabs.push(s),this.tabIndex=this.tabs.length-1,this.elementSpecs.sort((e,t)=>e.ident.localeCompare(t.ident)),(async()=>{await this.requestUpdate();const e=this.shadowRoot.querySelectorAll(".nav-item"),t=this.elementSpecs.indexOf(o);this._updateAutoComplete(),e[t].click(),e[t].focus()})()}removeElementSpec(e){const{ident:t}=e.detail.target;(async()=>{try{await this.shadowRoot.getElementById("dialog").confirm(v("browse.delete"),v("odd.editor.delete-spec",{ident:t}));const e=this.elementSpecs.findIndex(e=>e.ident===t);this.elementSpecs.splice(e,1),this.requestUpdate();const i=this.shadowRoot.querySelector("vaadin-tab[selected]").getAttribute("name"),s=this.tabs.indexOf(i);this._closeTab(s)}catch{}})()}serializeOdd(){const e=this.useNamespace?` ns="${this.namespace}"`:"",t=this.source?` source="${this.source}"`:"",i=this.description?` <desc>${this.description}</desc>`:"",s=`${this.indentString}<title>${this.title}${i}</title>\n`,o=this.titleShort?`${this.indentString}<title type="short">${this.titleShort}</title>\n`:"",a=this.cssFile?`${this.indentString}<rendition source="${this.cssFile}"/>\n`:"",n=this.elementSpecs.map(e=>this.serializeElementSpec(this.indentString,e)).join("");return`<schemaSpec xmlns="http://www.tei-c.org/ns/1.0" xmlns:pb="http://teipublisher.com/1.0"${e}${t}>\n${s}${o}${a}\n${n}</schemaSpec>\n`}serializeElementSpec(e,t){const i=t.mode?` mode="${t.mode}"`:"",s=e+this.indentString,o=t.models.map(e=>this.serializeModel(s,e)).join("");return`${e}<elementSpec ident="${t.ident}"${i}>\n${o}${e}</elementSpec>\n`}serializeModel(e,t){if("model"===t.type&&!t.behaviour)return"";const i=e+this.indentString,s=[this.serializeAttribute("output",t.output),this.serializeAttribute("predicate",t.predicate),"model"===t.type?this.serializeAttribute("behaviour",t.behaviour):"",this.serializeAttribute("cssClass",t.css),this.serializeAttribute("useSourceRendition",t.sourcerend),this.serializeAttribute("pb:mode",t.mode)].join(""),o=t.desc?`${i}<desc>${t.desc}</desc>\n`:"",a=t.models.map(e=>this.serializeModel(i,e)).join(""),n=t.parameters.map(e=>this.serializeParameter(i,e)).join(""),r=t.renditions.map(e=>this.serializeRendition(i,e)).join(""),d=`${o}${a}${n}${ve.serializeTemplate(i,t.template)}${r}`,l=d.length>0?`>\n${d}${e}</${t.type}`:"/";return`${e}<${t.type}${s}${l}>\n`}serializeParameter(e,t){if(!t.name)return"";const i=this.serializeAttribute("name",t.name),s=this.serializeAttribute("value",t.value);return t.set?`${e}<pb:set-param xmlns=""${i}${s}/>\n`:`${e}<param${i}${s}/>\n`}serializeRendition(e,t){return`${e}<outputRendition xml:space="preserve" ${t.scope&&"null"!==t.scope?this.serializeAttribute("scope",t.scope):""}>\n${e}${ve.escape(t.css)}\n${e}</outputRendition>\n`}static serializeTemplate(e,t){return t?`${e}<pb:template xml:space="preserve" xmlns="">${t}</pb:template>\n`:""}serializeAttribute(e,t){return t?` ${e}="${ve.escape(t)}"`:""}static escape(e){return e?"string"==typeof e?e.replace(ve.replaceCharRegexp,ve.replaceChars):e:""}save(e=!1){document.dispatchEvent(new CustomEvent("pb-start-update"));const t=this.serializeOdd();this.shadowRoot.getElementById("dialog").show(v("odd.editor.save"),v("odd.editor.saving"));const i=this.shadowRoot.getElementById("saveOdd");i.url=`${this.getEndpoint()}/${this.lessThanApiVersion("1.0.0")?"modules/editor.xql":`api/odd/${this.odd}`}`,this.lessThanApiVersion("1.0.0")?(i.contentType="application/x-www-form-urlencoded",i.method="POST",i.params=null,i.body={action:"save",root:this.rootPath,"output-prefix":this.outputPrefix,"output-root":this.outputRoot,odd:this.odd,data:t}):(i.contentType="application/xml",i.method="PUT",i.params={root:this.rootPath,"output-prefix":this.outputPrefix,"output-root":this.outputRoot},i.body=t);const s=i.generateRequest();(async()=>{try{const t=await s;this.handleSaveComplete({response:t},e)}catch(e){this.handleSaveError(e)}})()}static _renderReport(e){return e.error?`\n                        <div class="list-group-item-danger">\n                          <h4 class="list-group-item-heading">${e.file}</h4>\n                          <h5 class="list-group-item-heading">Compilation error on line ${e.line}:</h5>\n                          <pre class="list-group-item-text">${e.error}</pre>\n                          <pre class="list-group-item-text">${e.message}</pre>\n                        </div>\n                    `:`\n                    <div class="list-group-item-success">\n                      <p class="list-group-item-text">Generated ${e.file}</p>\n                    </div>\n                `}handleSaveComplete(e,t=!1){const i=e.response;if("denied"===i.status)return this.shadowRoot.getElementById("dialog").set(v("odd.editor.denied"),v("odd.editor.denied-message",{odd:this.odd})),void document.dispatchEvent(new CustomEvent("pb-end-update"));let s;if(this.lessThanApiVersion("1.0.0")){s=`<div class="list-group">${i.report.map(ve._renderReport).join("")}</div>`}else{const{report:e}=i;s=`<div class="list-group">${e}</div>`}if(this.shadowRoot.getElementById("dialog").set(v("odd.editor.saved"),s),this._hasChanges=!1,document.dispatchEvent(new CustomEvent("pb-end-update")),t){const e=new Blob([i.source],{type:"application/xml"});(async()=>{try{await z(e,{fileName:this.odd,extensions:[".odd"]}),O.log(`<pb-odd-editor> ${this.odd} exported`)}catch{O.log("<pb-odd-editor> export aborted")}})()}}handleSaveError(e){this.shadowRoot.getElementById("dialog").set("Error",e.error),document.dispatchEvent(new CustomEvent("pb-end-update"))}_reload(){(async()=>{try{await this.shadowRoot.getElementById("dialog").confirm(v("odd.editor.reload"),v("odd.editor.reload-confirm")),this.load(),this.tabs=[],this.tabIndex=0,this.shadowRoot.getElementById("currentElement").innerHTML=""}catch{}})()}_setCurrentSelection(e){null!=this.currentSelection&&this.currentSelection.removeAttribute("currentselection"),this.currentSelection=e.target,this.currentSelection.setAttribute("currentselection","true")}_changeSelection(e){if(e.preventDefault(),e.stopPropagation(),e.detail.target===this)return;let t;this.currentSelection&&void 0!==this.currentSelection.tagName&&this.currentSelection.removeAttribute("currentselection"),t=e.detail.target?e.detail.target:e.target,t.setAttribute("currentselection","true"),this.currentSelection=t}_selectElementspec(e){this.currentElementSpec&&"PB-ODD-ELEMENTSPEC-EDITOR"===this.currentElementSpec.tagName&&this.currentElementSpec.removeAttribute("currentselection");const t=e.target;t.setAttribute("currentselection","true"),this.currentElementSpec=t}nsDisabled(){return!this.useNamespace}_handleLoadError(e){O.log("loading error occurred: ",e);const t=this.shadowRoot.getElementById("errorMsg");t.style.background="red";const{url:i}=this.shadowRoot.getElementById("loadContent");O.log("url ",i),t.show("Error: ",`ODD file could not be loaded from ${i}`)}handleElementSpecChanged(e){this._hasChanges=!0;const t=this.elementSpecs.find(t=>t.ident===e.detail.ident),i=this.elementSpecs.indexOf(t),s=Object.assign(Object.assign({},t),{},{models:e.detail.models}),o=Array.from(this.elementSpecs);o.splice(i,1,s),this.elementSpecs=o}_inputTitle(e){this.title=e.target.value}}customElements.define("pb-odd-editor",ve);export{ve as PbOddEditor};
