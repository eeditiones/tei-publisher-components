import{E as t,p as e,a as s,x as n,i as o,T as i,w as r}from"./pb-mixin-DHoWQheB.js";import{t as a}from"./pb-dialog-tklYGWfc.js";import{e as l,i as c,t as h,o as d}from"./unsafe-html-D5VGo9Oq.js";import{t as u}from"./pb-i18n-C0NDma4h.js";const p=e=>e??t;class m extends(a(e(s))){static get properties(){return Object.assign(Object.assign({},super.properties),{},{noAnimation:{type:Boolean,attribute:"no-animation"},opened:{type:Boolean},toggles:{type:Boolean},expandIcon:{type:String,attribute:"expand-icon"},collapseIcon:{type:String,attribute:"collapse-icon"},iconSprite:{type:String,attribute:"icon-sprite"},noIcons:{type:Boolean,attribute:"no-icons"}})}constructor(){super(),this.horizontal=!1,this.noAnimation=!1,this.opened=!1,this.expandIcon="icons:expand-more",this.collapseIcon="icons:expand-less",this.noIcons=!1,this.toggles=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("pb-collapse-open",()=>{this.open()}),this.toggles&&this.subscribeTo("pb-collapse-open",t=>{if(t.detail&&t.detail._source!==this){for(const e of this.querySelectorAll("pb-collapse"))if(e===t.detail._source)return;this.close()}})}updated(t){if(super.updated(t),t.has("opened")){const t=this.shadowRoot.querySelector("details");t&&(t.open=this.opened)}}open(){this.opened||(this.opened=!0,this.emitTo("pb-collapse-open",this))}close(){this.opened&&(this.opened=!1)}toggle(){this.opened=!this.opened,this.opened&&this.emitTo("pb-collapse-open",this.data)}_handleToggle(t){t.preventDefault(),this.toggle()}render(){return n`
    ...
    `}}customElements.get("pb-autocomplete")||customElements.define("pb-autocomplete",A);const P="undefined"!=typeof navigator&&navigator.userAgent.toLowerCase().indexOf("firefox")>0;function C(t,e,s,n){t.addEventListener?t.addEventListener(e,s,n):t.attachEvent&&t.attachEvent("on".concat(e),s)}function x(t,e,s,n){t.removeEventListener?t.removeEventListener(e,s,n):t.detachEvent&&t.detachEvent("on".concat(e),s)}function S(t,e){const s=e.slice(0,e.length-1);for(let e=0;e<s.length;e++)s[e]=t[s[e].toLowerCase()];return s}function E(t){"string"!=typeof t&&(t="");const e=(t=t.replace(/\s/g,"")).split(",");let s=e.lastIndexOf("");for(;s>=0;)e[s-1]+=",",e.splice(s,1),s=e.lastIndexOf("");return e}function T(t,e){const s=t.length>=e.length?t:e,n=t.length>=e.length?e:t;let o=!0;for(let t=0;t<s.length;t++)-1===n.indexOf(s[t])&&(o=!1);return o}const O={backspace:8,"⌫":8,tab:9,clear:12,enter:13,"↩":13,return:13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,arrowup:38,arrowdown:40,arrowleft:37,arrowright:39,del:46,delete:46,ins:45,insert:45,home:36,end:35,pageup:33,pagedown:34,capslock:20,num_0:96,num_1:97,num_2:98,num_3:99,num_4:100,num_5:101,num_6:102,num_7:103,num_8:104,num_9:105,num_multiply:106,num_add:107,num_enter:108,num_subtract:109,num_decimal:110,num_divide:111,"⇪":20,",":188,".":190,"/":191,"`":192,"-":P?173:189,"=":P?61:187,";":P?59:186,"'":222,"{":219,"}":221,"[":219,"]":221,"\\":220},k={"⇧":16,shift:16,"⌥":18,alt:18,option:18,"⌃":17,ctrl:17,control:17,"⌘":91,cmd:91,meta:91,command:91},N={16:"shiftKey",18:"altKey",17:"ctrlKey",91:"metaKey",shiftKey:16,ctrlKey:17,altKey:18,metaKey:91},$={16:!1,18:!1,17:!1,91:!1},I={};for(let t=1;t<20;t++)O["f".concat(t)]=111+t;let L=[],R=null,M="all";const z=new Map,U=t=>O[t.toLowerCase()]||k[t.toLowerCase()]||t.toUpperCase().charCodeAt(0),D=t=>Object.keys(O).find(e=>O[e]===t),j=t=>Object.keys(k).find(e=>k[e]===t);function B(t){M=t||"all"}function H(){return M||"all"}function F(){return L.slice(0)}function q(){return L.map(t=>D(t)||j(t)||String.fromCharCode(t))}function V(){const t=[];return Object.keys(I).forEach(e=>{I[e].forEach(e=>{let{key:s,scope:n,mods:o,shortcut:i}=e;t.push({scope:n,shortcut:i,mods:o,keys:s.split("+").map(t=>U(t))})})}),t}function Y(t){const e=t.target||t.srcElement,{tagName:s}=e;let n=!0;const o="INPUT"===s&&!["checkbox","radio","range","button","file","reset","submit","color"].includes(e.type);return(e.isContentEditable||(o||"TEXTAREA"===s||"SELECT"===s)&&!e.readOnly)&&(n=!1),n}function W(t){return"string"==typeof t&&(t=U(t)),-1!==L.indexOf(t)}function K(t,e){let s,n;t||(t=H());for(const e in I)if(Object.prototype.hasOwnProperty.call(I,e))for(s=I[e],n=0;n<s.length;)if(s[n].scope===t){s.splice(n,1).forEach(t=>{let{element:e}=t;return st(e)})}else n++;H()===t&&B(e||"all")}function G(t){let e=t.keyCode||t.which||t.charCode;t.key&&"capslock"===t.key.toLowerCase()&&(e=U(t.key));const s=L.indexOf(e);if(s>=0&&L.splice(s,1),t.key&&"meta"===t.key.toLowerCase()&&L.splice(0,L.length),93!==e&&224!==e||(e=91),e in $){$[e]=!1;for(const t in k)k[t]===e&&(tt[t]=!1)}}function J(t){if(void 0===t)Object.keys(I).forEach(t=>{Array.isArray(I[t])&&I[t].forEach(t=>X(t)),delete I[t]}),st(null);else if(Array.isArray(t))t.forEach(t=>{t.key&&X(t)});else if("object"==typeof t)t.key&&X(t);else if("string"==typeof t){for(var e=arguments.length,s=new Array(e>1?e-1:0),n=1;n<e;n++)s[n-1]=arguments[n];let[o,i]=s;"function"==typeof o&&(i=o,o=""),X({key:t,scope:o,method:i,splitKey:"+"})}}const X=t=>{let{key:e,scope:s,method:n,splitKey:o="+"}=t;E(e).forEach(t=>{const e=t.split(o),i=e.length,r=e[i-1],a="*"===r?"*":U(r);if(!I[a])return;s||(s=H());const l=i>1?S(k,e):[],c=[];I[a]=I[a].filter(t=>{const e=(!n||t.method===n)&&t.scope===s&&T(t.mods,l);return e&&c.push(t.element),!e}),c.forEach(t=>st(t))})};function Z(t,e,s,n){if(e.element!==n)return;let o;if(e.scope===s||"all"===e.scope){o=e.mods.length>0;for(const t in $)Object.prototype.hasOwnProperty.call($,t)&&(!$[t]&&e.mods.indexOf(+t)>-1||$[t]&&-1===e.mods.indexOf(+t))&&(o=!1);(0!==e.mods.length||$[16]||$[18]||$[17]||$[91])&&!o&&"*"!==e.shortcut||(e.keys=[],e.keys=e.keys.concat(L),!1===e.method(t,e)&&(t.preventDefault?t.preventDefault():t.returnValue=!1,t.stopPropagation&&t.stopPropagation(),t.cancelBubble&&(t.cancelBubble=!0)))}}function Q(t,e){const s=I["*"];let n=t.keyCode||t.which||t.charCode;if(t.key&&"capslock"===t.key.toLowerCase())return;if(!tt.filter.call(this,t))return;if(93!==n&&224!==n||(n=91),-1===L.indexOf(n)&&229!==n&&L.push(n),["metaKey","ctrlKey","altKey","shiftKey"].forEach(e=>{const s=N[e];t[e]&&-1===L.indexOf(s)?L.push(s):!t[e]&&L.indexOf(s)>-1?L.splice(L.indexOf(s),1):"metaKey"===e&&t[e]&&(L=L.filter(t=>t in N||t===n))}),n in $){$[n]=!0;for(const e in k)if(Object.prototype.hasOwnProperty.call(k,e)){const s=N[k[e]];tt[e]=t[s]}if(!s)return}for(const e in $)Object.prototype.hasOwnProperty.call($,e)&&($[e]=t[N[e]]);t.getModifierState&&(!t.altKey||t.ctrlKey)&&t.getModifierState("AltGraph")&&(-1===L.indexOf(17)&&L.push(17),-1===L.indexOf(18)&&L.push(18),$[17]=!0,$[18]=!0);const o=H();if(s)for(let n=0;n<s.length;n++)s[n].scope===o&&("keydown"===t.type&&s[n].keydown||"keyup"===t.type&&s[n].keyup)&&Z(t,s[n],o,e);if(!(n in I))return;const i=I[n],r=i.length;for(let s=0;s<r;s++)if(("keydown"===t.type&&i[s].keydown||"keyup"===t.type&&i[s].keyup)&&i[s].key){const n=i[s],{splitKey:r}=n,a=n.key.split(r),l=[];for(let t=0;t<a.length;t++)l.push(U(a[t]));l.sort().join("")===L.sort().join("")&&Z(t,n,o,e)}}function tt(t,e,s){L=[];const n=E(t);let o=[],i="all",r=document,a=0,l=!1,c=!0,h="+",d=!1,u=!1;for(void 0===s&&"function"==typeof e&&(s=e),"[object Object]"===Object.prototype.toString.call(e)&&(e.scope&&(i=e.scope),e.element&&(r=e.element),e.keyup&&(l=e.keyup),void 0!==e.keydown&&(c=e.keydown),void 0!==e.capture&&(d=e.capture),"string"==typeof e.splitKey&&(h=e.splitKey),!0===e.single&&(u=!0)),"string"==typeof e&&(i=e),u&&J(t,i);a<n.length;a++)o=[],(t=n[a].split(h)).length>1&&(o=S(k,t)),(t="*"===(t=t[t.length-1])?"*":U(t))in I||(I[t]=[]),I[t].push({keyup:l,keydown:c,scope:i,mods:o,shortcut:n[a],method:s,key:n[a],splitKey:h,element:r});if(void 0!==r&&window){if(!z.has(r)){const t=function(){return Q(arguments.length>0&&void 0!==arguments[0]?arguments[0]:window.event,r)},e=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:window.event;Q(t,r),G(t)};z.set(r,{keydownListener:t,keyupListenr:e,capture:d}),C(r,"keydown",t,d),C(r,"keyup",e,d)}if(!R){const t=()=>{L=[]};R={listener:t,capture:d},C(window,"focus",t,d)}}}function et(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"all";Object.keys(I).forEach(s=>{I[s].filter(s=>s.scope===e&&s.shortcut===t).forEach(t=>{t&&t.method&&t.method()})})}function st(t){const e=Object.values(I).flat();if(e.findIndex(e=>{let{element:s}=e;return s===t})<0){const{keydownListener:e,keyupListenr:s,capture:n}=z.get(t)||{};e&&s&&(x(t,"keyup",s,n),x(t,"keydown",e,n),z.delete(t))}if(e.length<=0||z.size<=0){if(Object.keys(z).forEach(t=>{const{keydownListener:e,keyupListenr:s,capture:n}=z.get(t)||{};e&&s&&(x(t,"keyup",s,n),x(t,"keydown",e,n),z.delete(t))}),z.clear(),Object.keys(I).forEach(t=>delete I[t]),R){const{listener:t,capture:e}=R;x(window,"focus",t,e),R=null}}}const nt={getPressedKeyString:q,setScope:B,getScope:H,deleteScope:K,getPressedKeyCodes:F,getAllKeyCodes:V,isPressed:W,filter:Y,trigger:et,unbind:J,keyMap:O,modifier:k,modifierMap:N};for(const t in nt)Object.prototype.hasOwnProperty.call(nt,t)&&(tt[t]=nt[t]);if("undefined"!=typeof window){const t=window.hotkeys;tt.noConflict=e=>(e&&window.hotkeys===tt&&(window.hotkeys=t),tt),window.hotkeys=tt}const ot=new Set(["INPUT","SELECT","TEXTAREA","PAPER-INPUT","PAPER-TEXTAREA","PB-SEARCH"]);let it=!0;it&&(tt.filter=t=>{const{tagName:e}=t.target||t.srcElement;return!(e.isContentEditable||ot.has(e))},it=!1);const rt=t=>class extends t{static get properties(){return Object.assign(Object.assign({},super.properties),{},{hotkeys:{type:Object}})}constructor(){super(),this.hotkeys={}}registerHotkey(t,e,s){t&&this.hotkeys[t]&&(s?tt(this.hotkeys[t],{element:s},e):tt(this.hotkeys[t],e))}display(t){if(t&&this.hotkeys[t]){const e=[];return this.hotkeys[t].split(/\s*,\s*/).forEach(t=>{e.push(t.replace("+","-"))}),e.join(", ")}return""}};function at(t,e,s){s?tt(t,{element:s},e):tt(t,e)}window.pbKeyboard=at;const lt=(t="")=>t.replace(/[-_]/g," ").trim();class ct extends s{static properties={icon:{type:String},disabled:{type:Boolean,reflect:!0},label:{type:String},toggles:{type:Boolean},active:{type:Boolean,reflect:!0}};constructor(){super(),this.icon="",this.disabled=!1,this.label="",this.toggles=!1,this.active=!1}render(){const t=this.title||"",e=this.icon?lt(this.icon.includes(":")?this.icon.split(":").pop():this.icon):"",s=this.label||t||e;return n`
      <button
