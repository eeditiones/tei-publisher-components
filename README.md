...
> This is the development version containing the components for TEI Publisher 7. While the components are backwards compatible with TEI Publisher 6,
> demos and tests require version 7 to be installed, which has not been released yet.
