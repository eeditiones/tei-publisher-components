...
describe('pb-link-view e2e', () => {
  ...
  it('should update pb-view content when clicking pb-link', () => {
    cy.get('pb-document#document1').should('have.attr', 'path', 'test/graves6.xml');
    ...
    cy.get('pb-document#document1', { timeout: 10000 }).should(
      'have.attr',
      'path',
      'test/kant_rvernunft_1781.TEI-P5.xml',
    );
