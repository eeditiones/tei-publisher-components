...
describe('pb-clipboard e2e', () => {
  ...
  it('should write to clipboard on click', () => {
    ...
    cy.get('pb-clipboard').first().find('button.pb-button--icon').as('copyButton');
  ...
  it('should meet accessibility standards', () => {
    ...
    cy.get('pb-clipboard').find('button').first().focus().should('be.focused');
  });
  ...
  it('should support keyboard navigation', () => {
    ...
    cy.get('pb-clipboard').find('button').first().focus().type('{enter}');
  });
});
