...
describe('pb-facs-link', () => {
  ...
  it('should set properties correctly', () => {
    cy.mount(
      '<pb-facs-link facs="test-image.jpg" label="Test" order="5" trigger="mouseover" emit-on-load="true"></pb-facs-link>',
    );
    cy.get('pb-facs-link').then($el => {
      const element = $el[0];
  ...
  it('should emit pb-show-annotation when emit-on-load is true', () => {
    cy.mount(
      '<pb-facs-link facs="test-image.jpg" emit-on-load="true" trigger="click"></pb-facs-link>',
    );
  ...
  describe('IIIF manifest version compatibility', () => {
    it('should work with IIIF 2.0 manifest URLs', () => {
      cy.mount(
        '<pb-facs-link facs="api/iiif/document-v2" order="1" emit-on-load="true"></pb-facs-link>',
      );
    ...
    it('should work with IIIF 3.0 manifest URLs', () => {
      cy.mount(
        '<pb-facs-link facs="api/iiif/document-v3" order="2" emit-on-load="true"></pb-facs-link>',
      );
