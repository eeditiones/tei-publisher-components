...
describe('pb-highlight', () => {
  beforeEach(() => {
    const html =
      '<pb-highlight id="a" key="x"><span>A</span></pb-highlight><pb-highlight id="b" key="x"><span>B</span></pb-highlight>';
    cy.mount(html);
  });
  ...
  it('should emit and react to highlight events by key', () => {
    ...
    cy.document().then(doc => {
      const ev = new CustomEvent('pb-highlight-off', {
        detail: { key: '__default__', source: {} },
        bubbles: true,
        composed: true,
      });
