...
describe('pb-odd-model-editor', () => {
  ...
  it('should use native inputs/selects instead of paper-* elements', () => {
    cy.mount(
      '<pb-odd-model-editor type="model" behaviour="inline" output="web"></pb-odd-model-editor>',
    );
    ...
    cy.get('pb-odd-model-editor')
      .shadow()
      .find(
        'paper-input, paper-dropdown-menu, paper-menu-button, paper-item, paper-listbox, paper-button',
      )
      .should('not.exist');
