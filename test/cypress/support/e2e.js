...
beforeEach(() => {
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/exist\/apps\/tei-publisher\/api\/parts\/.*\/json$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
      body: {
  ...
  cy.intercept(
    { method: 'POST', pathname: /\/exist\/apps\/tei-publisher\/api\/login\/?$/ },
    req => {
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/exist\/apps\/tei-publisher\/api\/odd\/.*\.odd$/ },
    req => {
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/modules\/lib\/components-list-templates\.xql$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
      body: [{ name: 'view.html', title: 'Default Template' }],
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/modules\/lib\/components-list-odds\.xql$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
      body: [
  ...
  cy.intercept(
    { method: 'GET', pathname: '/exist/apps/tei-publisher/modules/lib/components.xql' },
    {
      statusCode: 200,
      headers: { 'content-type': 'text/html' },
      body: '',
  ...
  const mockContent = `<div class="demo-content"><p data-tei="1.1">${new Array(100)
    .fill('Mock content served by Cypress. This needs to be long to test long paragraphs.')
    .join(' ')} And this is the END</p></div>`;
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/demo\/api\/login\/?$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
      body: { success: true },
  ...
  cy.intercept(
    { method: 'POST', pathname: /\/demo\/api\/login\/?$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
      body: { success: true },
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/demo\/api\/odd$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
      body: [],
  ...
  cy.intercept(
    { method: 'GET', pathname: /\/demo\/modules\/editor\.xql$/ },
    {
      statusCode: 200,
      headers: { 'content-type': 'application/json' },
