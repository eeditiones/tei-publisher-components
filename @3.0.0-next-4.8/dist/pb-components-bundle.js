...
`,hc=document.createElement("div");let gc;function fc(e,t={}){const i=t.mode||"polite",n=void 0===t.timeout?150:t.timeout;"alert"===i?(hc.removeAttribute("aria-live"),hc.removeAttribute("role"),gc=R.debounce(gc,j,()=>{hc.setAttribute("role","alert")})):(gc&&gc.cancel(),hc.removeAttribute("role"),hc.setAttribute("aria-live",i)),hc.textContent="",setTimeout(()=>{hc.textContent=e},n)}hc.style.position="fixed",hc.style.clip="rect(0px, 0px, 0px, 0px)",hc.setAttribute("aria-live","polite"),document.body.appendChild(hc);const mc=e=>e.test(navigator.userAgent),bc=e=>e.test(navigator.platform),vc=e=>e.test(navigator.vendor);mc(/Android/u),mc(/Chrome/u)&&vc(/Google Inc/u),mc(/Firefox/u),bc(/^iPad/u)||bc(/^Mac/u)&&navigator.maxTouchPoints,bc(/^iPhone/u),mc(/^((?!chrome|android).)*safari/iu);const yc=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();function _c(e,...t){const i=e=>Array.isArray(e),n=e=>e&&"object"==typeof e&&!i(e),s=(e,t)=>{n(t)&&n(e)&&Object.keys(t).forEach(r=>{const o=t[r];n(o)?(e[r]||(e[r]={}),s(e[r],o)):i(o)?e[r]=[...o]:null!=o&&(e[r]=o)})};return t.forEach(t=>{s(e,t)}),e}const wc=(e,t)=>class extends t{static get properties(){return{i18n:{type:Object},__effectiveI18n:{type:Object,sync:!0}}}constructor(){super(),this.i18n=_c({},e)}get i18n(){return this.__customI18n}set i18n(t){t!==this.__customI18n&&(this.__customI18n=t,this.__effectiveI18n=_c({},e,this.__customI18n))}},xc={dropFiles:{one:"Drop file here",many:"Drop files here"},addFiles:{one:"Upload File...",many:"Upload Files..."},error:{tooManyFiles:"Too Many Files.",fileIsTooBig:"File is Too Big.",incorrectFileType:"Incorrect File Type."},uploading:{status:{connecting:"Connecting...",stalled:"Stalled",processing:"Processing File...",held:"Queued"},remainingTime:{prefix:"remaining time: ",unknown:"unknown remaining time"},error:{serverUnavailable:"Upload failed, please try again later",unexpectedServerError:"Upload failed due to server error",forbidden:"Upload forbidden"}},file:{retry:"Retry",start:"Start",remove:"Remove"},units:{size:["B","kB","MB","GB","TB","PB","EB","ZB","YB"]}};class kc extends L{constructor(e){super(e,"add-button","vaadin-button")}initNode(e){e._isDefault&&(this.defaultNode=e),e.addEventListener("touchend",e=>{this.host._onAddFilesTouchEnd(e)}),e.addEventListener("click",e=>{this.host._onAddFilesClick(e)}),this.host._addButton=e}}class Ac extends L{constructor(e){super(e,"drop-label","span")}initNode(e){e._isDefault&&(this.defaultNode=e),this.host._dropLabel=e}}const Sc=e=>class extends(wc(xc,e)){static get properties(){return{disabled:{type:Boolean,value:!1,reflectToAttribute:!0},nodrop:{type:Boolean,reflectToAttribute:!0,value:yc},target:{type:String,value:""},method:{type:String,value:"POST"},headers:{type:Object,value:{}},timeout:{type:Number,value:0},_dragover:{type:Boolean,value:!1,observer:"_dragoverChanged"},files:{type:Array,notify:!0,value:()=>[],sync:!0},maxFiles:{type:Number,value:1/0,sync:!0},maxFilesReached:{type:Boolean,value:!1,notify:!0,readOnly:!0,reflectToAttribute:!0},accept:{type:String,value:""},maxFileSize:{type:Number,value:1/0},_dragoverValid:{type:Boolean,value:!1,observer:"_dragoverValidChanged"},formDataName:{type:String,value:"file"},noAuto:{type:Boolean,value:!1},withCredentials:{type:Boolean,value:!1},uploadFormat:{type:String,value:"raw"},capture:String,_addButton:{type:Object},_dropLabel:{type:Object},_fileList:{type:Object},_files:{type:Array}}}static get observers(){return["__updateAddButton(_addButton, maxFiles, __effectiveI18n, maxFilesReached, disabled)","__updateDropLabel(_dropLabel, maxFiles, __effectiveI18n)","__updateFileList(_fileList, files, __effectiveI18n, disabled)","__updateMaxFilesReached(maxFiles, files)"]}get i18n(){return super.i18n}set i18n(e){super.i18n=e}get __acceptRegexp(){if(!this.accept)return null;const e=this.accept.split(",").map(e=>{let t=e.trim();return t=t.replace(/[+.]/gu,"\\$&"),t.startsWith("\\.")&&(t=`.*${t}$`),t.replace(/\/\*/gu,"/.*")});return new RegExp(`^(${e.join("|")})$`,"iu")}ready(){super.ready(),this.addEventListener("dragover",this._onDragover.bind(this)),this.addEventListener("dragleave",this._onDragleave.bind(this)),this.addEventListener("drop",this._onDrop.bind(this)),this.addEventListener("file-retry",this._onFileRetry.bind(this)),this.addEventListener("file-abort",this._onFileAbort.bind(this)),this.addEventListener("file-start",this._onFileStart.bind(this)),this.addEventListener("file-reject",this._onFileReject.bind(this)),this.addEventListener("upload-start",this._onUploadStart.bind(this)),this.addEventListener("upload-success",this._onUploadSuccess.bind(this)),this.addEventListener("upload-error",this._onUploadError.bind(this)),this._addButtonController=new kc(this),this.addController(this._addButtonController),this._dropLabelController=new Ac(this),this.addController(this._dropLabelController),this.addController(new L(this,"file-list","vaadin-upload-file-list",{initializer:e=>{this._fileList=e}})),this.addController(new L(this,"drop-label-icon","vaadin-upload-icon"))}_formatSize(e){if("function"==typeof this.__effectiveI18n.formatSize)return this.__effectiveI18n.formatSize(e);const t=this.__effectiveI18n.units.sizeBase||1e3,i=~~(Math.log(e)/Math.log(t)),n=Math.max(0,Math.min(3,i-1));return`${parseFloat((e/t**i).toFixed(n))} ${this.__effectiveI18n.units.size[i]}`}_splitTimeByUnits(e){const t=[60,60,24,1/0],i=[0];for(let n=0;n<t.length&&e>0;n++)i[n]=e%t[n],e=Math.floor(e/t[n]);return i}_formatTime(e,t){if("function"==typeof this.__effectiveI18n.formatTime)return this.__effectiveI18n.formatTime(e,t);for(;t.length<3;)t.push(0);return t.reverse().map(e=>(e<10?"0":"")+e).join(":")}_formatFileProgress(e){const t=e.loaded>0?this.__effectiveI18n.uploading.remainingTime.prefix+e.remainingStr:this.__effectiveI18n.uploading.remainingTime.unknown;return`${e.totalStr}: ${e.progress}% (${t})`}__updateMaxFilesReached(e,t){this._setMaxFilesReached(e>=0&&t.length>=e)}__updateAddButton(e,t,i,n,s){e&&(e.disabled=s||n,e===this._addButtonController.defaultNode&&(e.textContent=this._i18nPlural(t,i.addFiles)))}__updateDropLabel(e,t,i){e&&e===this._dropLabelController.defaultNode&&(e.textContent=this._i18nPlural(t,i.dropFiles))}__updateFileList(e,t,i,n){e&&(e.items=[...t],e.i18n=i,e.disabled=n)}_onDragover(e){e.preventDefault(),this.nodrop||this._dragover||(this._dragoverValid=!this.maxFilesReached&&!this.disabled,this._dragover=!0),e.dataTransfer.dropEffect=!this._dragoverValid||this.nodrop?"none":"copy"}_onDragleave(e){e.preventDefault(),this._dragover&&!this.nodrop&&(this._dragover=this._dragoverValid=!1)}async _onDrop(e){if(!this.nodrop&&!this.disabled){e.preventDefault(),this._dragover=this._dragoverValid=!1;const t=await this.__getFilesFromDropEvent(e);this._addFiles(t)}}__getFilesFromDropEvent(e){async function t(e){if(e.isFile)return new Promise(t=>{e.file(t,()=>t([]))});if(e.isDirectory){const i=e.createReader(),n=await new Promise(e=>{i.readEntries(e,()=>e([]))});return(await Promise.all(n.map(t))).flat()}}if(!Array.from(e.dataTransfer.items).filter(e=>!!e).filter(e=>"function"==typeof e.webkitGetAsEntry).map(e=>e.webkitGetAsEntry()).some(e=>!!e&&e.isDirectory))return Promise.resolve(e.dataTransfer.files?Array.from(e.dataTransfer.files):[]);const i=Array.from(e.dataTransfer.items).map(e=>e.webkitGetAsEntry()).filter(e=>!!e).map(t);return Promise.all(i).then(e=>e.flat())}_createXhr(){return new XMLHttpRequest}_configureXhr(e,t=null,i=!1){if("string"==typeof this.headers)try{this.headers=JSON.parse(this.headers)}catch(e){this.headers=void 0}Object.entries(this.headers).forEach(([t,i])=>{e.setRequestHeader(t,i)}),i&&t&&(e.setRequestHeader("Content-Type",t.type||"application/octet-stream"),e.setRequestHeader("X-Filename",encodeURIComponent(t.name))),this.timeout&&(e.timeout=this.timeout),e.withCredentials=this.withCredentials}_setStatus(e,t,i,n){e.elapsed=n,e.elapsedStr=this._formatTime(e.elapsed,this._splitTimeByUnits(e.elapsed)),e.remaining=Math.ceil(n*(t/i-1)),e.remainingStr=this._formatTime(e.remaining,this._splitTimeByUnits(e.remaining)),e.speed=~~(t/n/1024),e.totalStr=this._formatSize(t),e.loadedStr=this._formatSize(i),e.status=this._formatFileProgress(e)}uploadFiles(e=this.files){e&&!Array.isArray(e)&&(e=[e]),e=e.filter(e=>!e.complete),Array.prototype.forEach.call(e,this._uploadFile.bind(this))}_uploadFile(e){if(e.uploading)return;const t=Date.now(),i=e.xhr=this._createXhr();let n,s;i.upload.onprogress=r=>{clearTimeout(n),s=Date.now();const o=(s-t)/1e3,a=r.loaded,l=r.total,c=~~(a/l*100);e.loaded=a,e.progress=c,e.indeterminate=a<=0||a>=l,e.error?e.indeterminate=e.status=void 0:e.abort||(c<100?(this._setStatus(e,l,a,o),n=setTimeout(()=>{e.status=this.__effectiveI18n.uploading.status.stalled,this._renderFileList()},2e3)):(e.loadedStr=e.totalStr,e.status=this.__effectiveI18n.uploading.status.processing)),this._renderFileList(),this.dispatchEvent(new CustomEvent("upload-progress",{detail:{file:e,xhr:i}}))},i.onreadystatechange=()=>{if(4===i.readyState){if(clearTimeout(n),e.indeterminate=e.uploading=!1,e.abort)return;e.status="";if(!this.dispatchEvent(new CustomEvent("upload-response",{detail:{file:e,xhr:i},cancelable:!0})))return;0===i.status?e.error=this.__effectiveI18n.uploading.error.serverUnavailable:i.status>=500?e.error=this.__effectiveI18n.uploading.error.unexpectedServerError:i.status>=400&&(e.error=this.__effectiveI18n.uploading.error.forbidden),e.complete=!e.error,this.dispatchEvent(new CustomEvent("upload-"+(e.error?"error":"success"),{detail:{file:e,xhr:i}})),this._renderFileList()}};const r="raw"===this.uploadFormat;e.uploadTarget||(e.uploadTarget=this.target||""),r||(e.formDataName=this.formDataName);if(!this.dispatchEvent(new CustomEvent("upload-before",{detail:{file:e,xhr:i},cancelable:!0})))return;let o;if(r)o=e;else{const t=new FormData;t.append(e.formDataName,e,e.name),o=t}i.open(this.method,e.uploadTarget,!0),this._configureXhr(i,e,r),e.status=this.__effectiveI18n.uploading.status.connecting,e.uploading=e.indeterminate=!0,e.complete=e.abort=e.error=e.held=!1,i.upload.onloadstart=()=>{this.dispatchEvent(new CustomEvent("upload-start",{detail:{file:e,xhr:i}})),this._renderFileList()};const a={file:e,xhr:i,uploadFormat:this.uploadFormat,requestBody:o};r||(a.formData=o);this.dispatchEvent(new CustomEvent("upload-request",{detail:a,cancelable:!0}))&&i.send(o)}_retryFileUpload(e){this.dispatchEvent(new CustomEvent("upload-retry",{detail:{file:e,xhr:e.xhr},cancelable:!0}))&&(this._uploadFile(e),this._updateFocus(this.files.indexOf(e)))}_abortFileUpload(e){this.dispatchEvent(new CustomEvent("upload-abort",{detail:{file:e,xhr:e.xhr},cancelable:!0}))&&(e.abort=!0,e.xhr&&e.xhr.abort(),this._removeFile(e))}_renderFileList(){this._fileList&&"function"==typeof this._fileList.requestContentUpdate&&this._fileList.requestContentUpdate()}_addFiles(e){Array.prototype.forEach.call(e,this._addFile.bind(this))}_addFile(e){if(this.maxFilesReached)return void this.dispatchEvent(new CustomEvent("file-reject",{detail:{file:e,error:this.__effectiveI18n.error.tooManyFiles}}));if(this.maxFileSize>=0&&e.size>this.maxFileSize)return void this.dispatchEvent(new CustomEvent("file-reject",{detail:{file:e,error:this.__effectiveI18n.error.fileIsTooBig}}));const t=this.__acceptRegexp;!t||t.test(e.type)||t.test(e.name)?(e.loaded=0,e.held=!0,e.status=this.__effectiveI18n.uploading.status.held,this.files=[e,...this.files],this.noAuto||this._uploadFile(e)):this.dispatchEvent(new CustomEvent("file-reject",{detail:{file:e,error:this.__effectiveI18n.error.incorrectFileType}}))}_updateFocus(e){if(0===this.files.length)return void this._addButton.focus({focusVisible:N()});e===this.files.length&&(e-=1),this._fileList.children[e].firstElementChild.focus({focusVisible:N()})}_removeFile(e){const t=this.files.indexOf(e);t>=0&&(this.files=this.files.filter(t=>t!==e),this.dispatchEvent(new CustomEvent("file-remove",{detail:{file:e},bubbles:!0,composed:!0})),this._updateFocus(t))}_onAddFilesTouchEnd(e){e.preventDefault(),this._onAddFilesClick(e)}_onAddFilesClick(e){this.maxFilesReached||(e.stopPropagation(),this.$.fileInput.value="",this.$.fileInput.click())}_onFileInputChange(e){this._addFiles(e.target.files)}_onFileStart(e){this._uploadFile(e.detail.file)}_onFileRetry(e){this._retryFileUpload(e.detail.file)}_onFileAbort(e){this._abortFileUpload(e.detail.file)}_onFileReject(e){fc(`${e.detail.file.name}: ${e.detail.error}`,{mode:"alert"})}_onUploadStart(e){fc(`${e.detail.file.name}: 0%`,{mode:"alert"})}_onUploadSuccess(e){fc(`${e.detail.file.name}: 100%`,{mode:"alert"})}_onUploadError(e){fc(`${e.detail.file.name}: ${e.detail.file.error}`,{mode:"alert"})}_dragoverChanged(e){e?this.setAttribute("dragover",e):this.removeAttribute("dragover")}_dragoverValidChanged(e){e?this.setAttribute("dragover-valid",e):this.removeAttribute("dragover-valid")}_i18nPlural(e,t){return 1===e?t.one:t.many}_isMultiple(e){return 1!==e}};class $c extends(Sc($(E(O(C(s)))))){static get is(){return"vaadin-upload"}static get styles(){return uc}static get lumoInjector(){return Object.assign(Object.assign({},super.lumoInjector),{},{includeBaseStyles:!0})}render(){return t`
    ...
    `}}function Np(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,"symbol"==typeof(s=function(e){if("object"!=typeof e||null===e)return e;var t=e[Symbol.toPrimitive];if(void 0!==t){var i=t.call(e,"string");if("object"!=typeof i)return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(n.key))?s:String(s),n)}var s}function Pp(e,t,i){return t&&Np(e.prototype,t),Object.defineProperty(e,"prototype",{writable:!1}),e}function Dp(){return Dp=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&(e[n]=i[n])}return e},Dp.apply(this,arguments)}function Fp(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,Bp(e,t)}function Bp(e,t){return Bp=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(e,t){return e.__proto__=t,e},Bp(e,t)}function Mp(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function qp(e,t){(null==t||t>e.length)&&(t=e.length);for(var i=0,n=new Array(t);i<t;i++)n[i]=e[i];return n}function zp(e,t){var i="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(i)return(i=i.call(e)).next.bind(i);if(Array.isArray(e)||(i=function(e,t){if(e){if("string"==typeof e)return qp(e,t);var i=Object.prototype.toString.call(e).slice(8,-1);return"Object"===i&&e.constructor&&(i=e.constructor.name),"Map"===i||"Set"===i?Array.from(e):"Arguments"===i||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)?qp(e,t):void 0}}(e))||t){i&&(e=i);var n=0;return function(){return n>=e.length?{done:!0}:{done:!1,value:e[n++]}}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var Up;customElements.define("pb-blacklab-highlight",jp),function(e){e[e.Init=0]="Init",e[e.Loading=1]="Loading",e[e.Loaded=2]="Loaded",e[e.Rendered=3]="Rendered",e[e.Error=4]="Error"}(Up||(Up={}));var Hp,Vp,Wp,Gp,Yp,Qp,Kp,Jp={},Zp=[],Xp=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function eu(e,t){for(var i in t)e[i]=t[i];return e}function tu(e){var t=e.parentNode;t&&t.removeChild(e)}function iu(e,t,i){var n,s,r,o={};for(r in t)"key"==r?n=t[r]:"ref"==r?s=t[r]:o[r]=t[r];if(arguments.length>2&&(o.children=arguments.length>3?Hp.call(arguments,2):i),"function"==typeof e&&null!=e.defaultProps)for(r in e.defaultProps)void 0===o[r]&&(o[r]=e.defaultProps[r]);return nu(e,o,n,s,null)}function nu(e,t,i,n,s){var r={type:e,props:t,key:i,ref:n,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:s??++Wp};return null==s&&null!=Vp.vnode&&Vp.vnode(r),r}function su(e){return e.children}function ru(e,t){this.props=e,this.context=t}function ou(e,t){if(null==t)return e.__?ou(e.__,e.__.__k.indexOf(e)+1):null;for(var i;t<e.__k.length;t++)if(null!=(i=e.__k[t])&&null!=i.__e)return i.__e;return"function"==typeof e.type?ou(e):null}function au(e){var t,i;if(null!=(e=e.__)&&null!=e.__c){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if(null!=(i=e.__k[t])&&null!=i.__e){e.__e=e.__c.base=i.__e;break}return au(e)}}function lu(e){(!e.__d&&(e.__d=!0)&&Yp.push(e)&&!cu.__r++||Qp!==Vp.debounceRendering)&&((Qp=Vp.debounceRendering)||setTimeout)(cu)}function cu(){for(var e;cu.__r=Yp.length;)e=Yp.sort(function(e,t){return e.__v.__b-t.__v.__b}),Yp=[],e.some(function(e){var t,i,n,s,r,o;e.__d&&(r=(s=(t=e).__v).__e,(o=t.__P)&&(i=[],(n=eu({},s)).__v=s.__v+1,bu(o,s,n,t.__n,void 0!==o.ownerSVGElement,null!=s.__h?[r]:null,i,r??ou(s),s.__h),vu(i,s),s.__e!=r&&au(s)))})}function du(e,t,i,n,s,r,o,a,l,c){var d,p,u,h,g,f,m,b=n&&n.__k||Zp,v=b.length;for(i.__k=[],d=0;d<t.length;d++)if(null!=(h=i.__k[d]=null==(h=t[d])||"boolean"==typeof h?null:"string"==typeof h||"number"==typeof h||"bigint"==typeof h?nu(null,h,null,null,h):Array.isArray(h)?nu(su,{children:h},null,null,null):h.__b>0?nu(h.type,h.props,h.key,h.ref?h.ref:null,h.__v):h)){if(h.__=i,h.__b=i.__b+1,null===(u=b[d])||u&&h.key==u.key&&h.type===u.type)b[d]=void 0;else for(p=0;p<v;p++){if((u=b[p])&&h.key==u.key&&h.type===u.type){b[p]=void 0;break}u=null}bu(e,h,u=u||Jp,s,r,o,a,l,c),g=h.__e,(p=h.ref)&&u.ref!=p&&(m||(m=[]),u.ref&&m.push(u.ref,null,h),m.push(p,h.__c||g,h)),null!=g?(null==f&&(f=g),"function"==typeof h.type&&h.__k===u.__k?h.__d=l=pu(h,l,e):l=uu(e,h,u,b,g,l),"function"==typeof i.type&&(i.__d=l)):l&&u.__e==l&&l.parentNode!=e&&(l=ou(u))}for(i.__e=f,d=v;d--;)null!=b[d]&&wu(b[d],b[d]);if(m)for(d=0;d<m.length;d++)_u(m[d],m[++d],m[++d])}function pu(e,t,i){for(var n,s=e.__k,r=0;s&&r<s.length;r++)(n=s[r])&&(n.__=e,t="function"==typeof n.type?pu(n,t,i):uu(i,n,n,s,n.__e,t));return t}function uu(e,t,i,n,s,r){var o,a,l;if(void 0!==t.__d)o=t.__d,t.__d=void 0;else if(null==i||s!=r||null==s.parentNode)e:if(null==r||r.parentNode!==e)e.appendChild(s),o=null;else{for(a=r,l=0;(a=a.nextSibling)&&l<n.length;l+=1)if(a==s)break e;e.insertBefore(s,r),o=r}return void 0!==o?o:s.nextSibling}function hu(e,t,i){"-"===t[0]?e.setProperty(t,i):e[t]=null==i?"":"number"!=typeof i||Xp.test(t)?i:i+"px"}function gu(e,t,i,n,s){var r;e:if("style"===t)if("string"==typeof i)e.style.cssText=i;else{if("string"==typeof n&&(e.style.cssText=n=""),n)for(t in n)i&&t in i||hu(e.style,t,"");if(i)for(t in i)n&&i[t]===n[t]||hu(e.style,t,i[t])}else if("o"===t[0]&&"n"===t[1])r=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+r]=i,i?n||e.addEventListener(t,r?mu:fu,r):e.removeEventListener(t,r?mu:fu,r);else if("dangerouslySetInnerHTML"!==t){if(s)t=t.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if("href"!==t&&"list"!==t&&"form"!==t&&"tabIndex"!==t&&"download"!==t&&t in e)try{e[t]=i??"";break e}catch(e){}"function"==typeof i||(null==i||!1===i&&-1==t.indexOf("-")?e.removeAttribute(t):e.setAttribute(t,i))}}function fu(e){this.l[e.type+!1](Vp.event?Vp.event(e):e)}function mu(e){this.l[e.type+!0](Vp.event?Vp.event(e):e)}function bu(e,t,i,n,s,r,o,a,l){var c,d,p,u,h,g,f,m,b,v,y,_,w,x,k,A=t.type;if(void 0!==t.constructor)return null;null!=i.__h&&(l=i.__h,a=t.__e=i.__e,t.__h=null,r=[a]),(c=Vp.__b)&&c(t);try{e:if("function"==typeof A){if(m=t.props,b=(c=A.contextType)&&n[c.__c],v=c?b?b.props.value:c.__:n,i.__c?f=(d=t.__c=i.__c).__=d.__E:("prototype"in A&&A.prototype.render?t.__c=d=new A(m,v):(t.__c=d=new ru(m,v),d.constructor=A,d.render=xu),b&&b.sub(d),d.props=m,d.state||(d.state={}),d.context=v,d.__n=n,p=d.__d=!0,d.__h=[],d._sb=[]),null==d.__s&&(d.__s=d.state),null!=A.getDerivedStateFromProps&&(d.__s==d.state&&(d.__s=eu({},d.__s)),eu(d.__s,A.getDerivedStateFromProps(m,d.__s))),u=d.props,h=d.state,p)null==A.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&d.__h.push(d.componentDidMount);else{if(null==A.getDerivedStateFromProps&&m!==u&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(m,v),!d.__e&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(m,d.__s,v)||t.__v===i.__v){for(d.props=m,d.state=d.__s,t.__v!==i.__v&&(d.__d=!1),d.__v=t,t.__e=i.__e,t.__k=i.__k,t.__k.forEach(function(e){e&&(e.__=t)}),y=0;y<d._sb.length;y++)d.__h.push(d._sb[y]);d._sb=[],d.__h.length&&o.push(d);break e}null!=d.componentWillUpdate&&d.componentWillUpdate(m,d.__s,v),null!=d.componentDidUpdate&&d.__h.push(function(){d.componentDidUpdate(u,h,g)})}if(d.context=v,d.props=m,d.__v=t,d.__P=e,_=Vp.__r,w=0,"prototype"in A&&A.prototype.render){for(d.state=d.__s,d.__d=!1,_&&_(t),c=d.render(d.props,d.state,d.context),x=0;x<d._sb.length;x++)d.__h.push(d._sb[x]);d._sb=[]}else do{d.__d=!1,_&&_(t),c=d.render(d.props,d.state,d.context),d.state=d.__s}while(d.__d&&++w<25);d.state=d.__s,null!=d.getChildContext&&(n=eu(eu({},n),d.getChildContext())),p||null==d.getSnapshotBeforeUpdate||(g=d.getSnapshotBeforeUpdate(u,h)),k=null!=c&&c.type===su&&null==c.key?c.props.children:c,du(e,Array.isArray(k)?k:[k],t,i,n,s,r,o,a,l),d.base=t.__e,t.__h=null,d.__h.length&&o.push(d),f&&(d.__E=d.__=null),d.__e=!1}else null==r&&t.__v===i.__v?(t.__k=i.__k,t.__e=i.__e):t.__e=yu(i.__e,t,i,n,s,r,o,l);(c=Vp.diffed)&&c(t)}catch(e){t.__v=null,(l||null!=r)&&(t.__e=a,t.__h=!!l,r[r.indexOf(a)]=null),Vp.__e(e,t,i)}}function vu(e,t){Vp.__c&&Vp.__c(t,e),e.some(function(t){try{e=t.__h,t.__h=[],e.some(function(e){e.call(t)})}catch(e){Vp.__e(e,t.__v)}})}function yu(e,t,i,n,s,r,o,a){var l,c,d,p=i.props,u=t.props,h=t.type,g=0;if("svg"===h&&(s=!0),null!=r)for(;g<r.length;g++)if((l=r[g])&&"setAttribute"in l==!!h&&(h?l.localName===h:3===l.nodeType)){e=l,r[g]=null;break}if(null==e){if(null===h)return document.createTextNode(u);e=s?document.createElementNS("http://www.w3.org/2000/svg",h):document.createElement(h,u.is&&u),r=null,a=!1}if(null===h)p===u||a&&e.data===u||(e.data=u);else{if(r=r&&Hp.call(e.childNodes),c=(p=i.props||Jp).dangerouslySetInnerHTML,d=u.dangerouslySetInnerHTML,!a){if(null!=r)for(p={},g=0;g<e.attributes.length;g++)p[e.attributes[g].name]=e.attributes[g].value;(d||c)&&(d&&(c&&d.__html==c.__html||d.__html===e.innerHTML)||(e.innerHTML=d&&d.__html||""))}if(function(e,t,i,n,s){var r;for(r in i)"children"===r||"key"===r||r in t||gu(e,r,null,i[r],n);for(r in t)s&&"function"!=typeof t[r]||"children"===r||"key"===r||"value"===r||"checked"===r||i[r]===t[r]||gu(e,r,t[r],i[r],n)}(e,u,p,s,a),d)t.__k=[];else if(g=t.props.children,du(e,Array.isArray(g)?g:[g],t,i,n,s&&"foreignObject"!==h,r,o,r?r[0]:i.__k&&ou(i,0),a),null!=r)for(g=r.length;g--;)null!=r[g]&&tu(r[g]);a||("value"in u&&void 0!==(g=u.value)&&(g!==e.value||"progress"===h&&!g||"option"===h&&g!==p.value)&&gu(e,"value",g,p.value,!1),"checked"in u&&void 0!==(g=u.checked)&&g!==e.checked&&gu(e,"checked",g,p.checked,!1))}return e}function _u(e,t,i){try{"function"==typeof e?e(t):e.current=t}catch(e){Vp.__e(e,i)}}function wu(e,t,i){var n,s;if(Vp.unmount&&Vp.unmount(e),(n=e.ref)&&(n.current&&n.current!==e.__e||_u(n,null,t)),null!=(n=e.__c)){if(n.componentWillUnmount)try{n.componentWillUnmount()}catch(e){Vp.__e(e,t)}n.base=n.__P=null,e.__c=void 0}if(n=e.__k)for(s=0;s<n.length;s++)n[s]&&wu(n[s],t,i||"function"!=typeof e.type);i||null==e.__e||tu(e.__e),e.__=e.__e=e.__d=void 0}function xu(e,t,i){return this.constructor(e,i)}function ku(e,t,i){var n,s,r;Vp.__&&Vp.__(e,t),s=(n=!1)?null:t.__k,r=[],bu(t,e=t.__k=iu(su,null,[e]),s||Jp,Jp,void 0!==t.ownerSVGElement,s?null:t.firstChild?Hp.call(t.childNodes):null,r,s?s.__e:t.firstChild,n),vu(r,e)}function Au(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var t=16*Math.random()|0;return("x"==e?t:3&t|8).toString(16)})}Hp=Zp.slice,Vp={__e:function(e,t,i,n){for(var s,r,o;t=t.__;)if((s=t.__c)&&!s.__)try{if((r=s.constructor)&&null!=r.getDerivedStateFromError&&(s.setState(r.getDerivedStateFromError(e)),o=s.__d),null!=s.componentDidCatch&&(s.componentDidCatch(e,n||{}),o=s.__d),o)return s.__E=s}catch(t){e=t}throw e}},Wp=0,Gp=function(e){return null!=e&&void 0===e.constructor},ru.prototype.setState=function(e,t){var i;i=null!=this.__s&&this.__s!==this.state?this.__s:this.__s=eu({},this.state),"function"==typeof e&&(e=e(eu({},i),this.props)),e&&eu(i,e),null!=e&&this.__v&&(t&&this._sb.push(t),lu(this))},ru.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),lu(this))},ru.prototype.render=su,Yp=[],cu.__r=0,Kp=0;var Su=function(){function e(e){this._id=void 0,this._id=e||Au()}return Pp(e,[{key:"id",get:function(){return this._id}}]),e}();function $u(e){return iu(e.parentElement||"span",{dangerouslySetInnerHTML:{__html:e.content}})}function Eu(e,t){return iu($u,{content:e,parentElement:t})}var Ou,Cu=function(e){function t(t){var i;return(i=e.call(this)||this).data=void 0,i.update(t),i}Fp(t,e);var i=t.prototype;return i.cast=function(e){return e instanceof HTMLElement?Eu(e.outerHTML):e},i.update=function(e){return this.data=this.cast(e),this},t}(Su),Tu=function(e){function t(t){var i;return(i=e.call(this)||this)._cells=void 0,i.cells=t||[],i}Fp(t,e);var i=t.prototype;return i.cell=function(e){return this._cells[e]},i.toArray=function(){return this.cells.map(function(e){return e.data})},t.fromCells=function(e){return new t(e.map(function(e){return new Cu(e.data)}))},Pp(t,[{key:"cells",get:function(){return this._cells},set:function(e){this._cells=e}},{key:"length",get:function(){return this.cells.length}}]),t}(Su),Iu=function(e){function t(t){var i;return(i=e.call(this)||this)._rows=void 0,i._length=void 0,i.rows=t instanceof Array?t:t instanceof Tu?[t]:[],i}return Fp(t,e),t.prototype.toArray=function(){return this.rows.map(function(e){return e.toArray()})},t.fromRows=function(e){return new t(e.map(function(e){return Tu.fromCells(e.cells)}))},t.fromArray=function(e){return new t((e=function(e){return!e[0]||e[0]instanceof Array?e:[e]}(e)).map(function(e){return new Tu(e.map(function(e){return new Cu(e)}))}))},Pp(t,[{key:"rows",get:function(){return this._rows},set:function(e){this._rows=e}},{key:"length",get:function(){return this._length||this.rows.length},set:function(e){this._length=e}}]),t}(Su),Lu=function(){function e(){this.callbacks=void 0}var t=e.prototype;return t.init=function(e){this.callbacks||(this.callbacks={}),e&&!this.callbacks[e]&&(this.callbacks[e]=[])},t.listeners=function(){return this.callbacks},t.on=function(e,t){return this.init(e),this.callbacks[e].push(t),this},t.off=function(e,t){var i=e;return this.init(),this.callbacks[i]&&0!==this.callbacks[i].length?(this.callbacks[i]=this.callbacks[i].filter(function(e){return e!=t}),this):this},t.emit=function(e){var t=arguments,i=e;return this.init(i),this.callbacks[i].length>0&&(this.callbacks[i].forEach(function(e){return e.apply(void 0,[].slice.call(t,1))}),!0)},e}();function Ru(e,t){if(typeof e!=typeof t)return!1;if(null===e&&null===t)return!0;if("object"!=typeof e)return e===t;if(Array.isArray(e)&&Array.isArray(t)){if(e.length!==t.length)return!1;for(var i=0;i<e.length;i++)if(!Ru(e[i],t[i]))return!1;return!0}if(e.hasOwnProperty("constructor")&&t.hasOwnProperty("constructor")&&e.hasOwnProperty("props")&&t.hasOwnProperty("props")&&e.hasOwnProperty("key")&&t.hasOwnProperty("key")&&e.hasOwnProperty("ref")&&t.hasOwnProperty("ref")&&e.hasOwnProperty("type")&&t.hasOwnProperty("type"))return Ru(e.props,t.props);var n=Object.keys(e),s=Object.keys(t);if(n.length!==s.length)return!1;for(var r=0,o=n;r<o.length;r++){var a=o[r];if(!t.hasOwnProperty(a)||!Ru(e[a],t[a]))return!1}return!0}!function(e){e[e.Initiator=0]="Initiator",e[e.ServerFilter=1]="ServerFilter",e[e.ServerSort=2]="ServerSort",e[e.ServerLimit=3]="ServerLimit",e[e.Extractor=4]="Extractor",e[e.Transformer=5]="Transformer",e[e.Filter=6]="Filter",e[e.Sort=7]="Sort",e[e.Limit=8]="Limit"}(Ou||(Ou={}));var ju=function(e){function t(t){var i;return(i=e.call(this)||this).id=void 0,i._props=void 0,i._props={},i.id=Au(),t&&i.setProps(t),i}Fp(t,e);var i=t.prototype;return i.process=function(){var e=[].slice.call(arguments);this.validateProps instanceof Function&&this.validateProps.apply(this,e),this.emit.apply(this,["beforeProcess"].concat(e));var t=this._process.apply(this,e);return this.emit.apply(this,["afterProcess"].concat(e)),t},i.setProps=function(e){var t=Dp({},this._props,e);return Ru(t,this._props)||(this._props=t,this.emit("propsUpdated",this)),this},Pp(t,[{key:"props",get:function(){return this._props}}]),t}(Lu),Nu=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(e){return this.props.keyword?(t=String(this.props.keyword).trim(),i=this.props.columns,n=this.props.ignoreHiddenColumns,s=e,r=this.props.selector,t=t.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&"),new Iu(s.rows.filter(function(e,s){return e.cells.some(function(e,o){if(!e)return!1;if(n&&i&&i[o]&&"object"==typeof i[o]&&i[o].hidden)return!1;var a="";if("function"==typeof r)a=r(e.data,s,o);else if("object"==typeof e.data){var l=e.data;l&&l.props&&l.props.content&&(a=l.props.content)}else a=String(e.data);return new RegExp(t,"gi").test(a)})}))):e;var t,i,n,s,r},Pp(t,[{key:"type",get:function(){return Ou.Filter}}]),t}(ju);function Pu(){return""+"gridjs"+[].slice.call(arguments).reduce(function(e,t){return e+"-"+t},"")}function Du(){return[].slice.call(arguments).map(function(e){return e?e.toString():""}).filter(function(e){return e}).reduce(function(e,t){return(e||"")+" "+t},"").trim()}var Fu,Bu,Mu,qu,zu=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(e){if(!this.props.keyword)return e;var t={};return this.props.url&&(t.url=this.props.url(e.url,this.props.keyword)),this.props.body&&(t.body=this.props.body(e.body,this.props.keyword)),Dp({},e,t)},Pp(t,[{key:"type",get:function(){return Ou.ServerFilter}}]),t}(ju),Uu=0,Hu=[],Vu=[],Wu=Vp.__b,Gu=Vp.__r,Yu=Vp.diffed,Qu=Vp.__c,Ku=Vp.unmount;function Ju(e,t){Vp.__h&&Vp.__h(Bu,e,Uu||t),Uu=0;var i=Bu.__H||(Bu.__H={__:[],__h:[]});return e>=i.__.length&&i.__.push({__V:Vu}),i.__[e]}function Zu(e){return Uu=1,function(e,t){var i=Ju(Fu++,2);if(i.t=e,!i.__c&&(i.__=[lh(void 0,t),function(e){var t=i.__N?i.__N[0]:i.__[0],n=i.t(t,e);t!==n&&(i.__N=[n,i.__[1]],i.__c.setState({}))}],i.__c=Bu,!Bu.u)){Bu.u=!0;var n=Bu.shouldComponentUpdate;Bu.shouldComponentUpdate=function(e,t,s){if(!i.__c.__H)return!0;var r=i.__c.__H.__.filter(function(e){return e.__c});if(r.every(function(e){return!e.__N}))return!n||n.call(this,e,t,s);var o=!1;return r.forEach(function(e){if(e.__N){var t=e.__[0];e.__=e.__N,e.__N=void 0,t!==e.__[0]&&(o=!0)}}),!(!o&&i.__c.props===e)&&(!n||n.call(this,e,t,s))}}return i.__N||i.__}(lh,e)}function Xu(e,t){var i=Ju(Fu++,3);!Vp.__s&&ah(i.__H,t)&&(i.__=e,i.i=t,Bu.__H.__h.push(i))}function eh(e){return Uu=5,th(function(){return{current:e}},[])}function th(e,t){var i=Ju(Fu++,7);return ah(i.__H,t)?(i.__V=e(),i.i=t,i.__h=e,i.__V):i.__}function ih(){for(var e;e=Hu.shift();)if(e.__P&&e.__H)try{e.__H.__h.forEach(rh),e.__H.__h.forEach(oh),e.__H.__h=[]}catch(t){e.__H.__h=[],Vp.__e(t,e.__v)}}Vp.__b=function(e){Bu=null,Wu&&Wu(e)},Vp.__r=function(e){Gu&&Gu(e),Fu=0;var t=(Bu=e.__c).__H;t&&(Mu===Bu?(t.__h=[],Bu.__h=[],t.__.forEach(function(e){e.__N&&(e.__=e.__N),e.__V=Vu,e.__N=e.i=void 0})):(t.__h.forEach(rh),t.__h.forEach(oh),t.__h=[])),Mu=Bu},Vp.diffed=function(e){Yu&&Yu(e);var t=e.__c;t&&t.__H&&(t.__H.__h.length&&(1!==Hu.push(t)&&qu===Vp.requestAnimationFrame||((qu=Vp.requestAnimationFrame)||sh)(ih)),t.__H.__.forEach(function(e){e.i&&(e.__H=e.i),e.__V!==Vu&&(e.__=e.__V),e.i=void 0,e.__V=Vu})),Mu=Bu=null},Vp.__c=function(e,t){t.some(function(e){try{e.__h.forEach(rh),e.__h=e.__h.filter(function(e){return!e.__||oh(e)})}catch(i){t.some(function(e){e.__h&&(e.__h=[])}),t=[],Vp.__e(i,e.__v)}}),Qu&&Qu(e,t)},Vp.unmount=function(e){Ku&&Ku(e);var t,i=e.__c;i&&i.__H&&(i.__H.__.forEach(function(e){try{rh(e)}catch(e){t=e}}),i.__H=void 0,t&&Vp.__e(t,i.__v))};var nh="function"==typeof requestAnimationFrame;function sh(e){var t,i=function(){clearTimeout(n),nh&&cancelAnimationFrame(t),setTimeout(e)},n=setTimeout(i,100);nh&&(t=requestAnimationFrame(i))}function rh(e){var t=Bu,i=e.__c;"function"==typeof i&&(e.__c=void 0,i()),Bu=t}function oh(e){var t=Bu;e.__c=e.__(),Bu=t}function ah(e,t){return!e||e.length!==t.length||t.some(function(t,i){return t!==e[i]})}function lh(e,t){return"function"==typeof t?t(e):t}function ch(){return function(e){var t=Bu.context[e.__c],i=Ju(Fu++,9);return i.c=e,t?(null==i.__&&(i.__=!0,t.sub(Bu)),t.props.value):e.__}(Hh)}var dh={search:{placeholder:"Type a keyword..."},sort:{sortAsc:"Sort column ascending",sortDesc:"Sort column descending"},pagination:{previous:"Previous",next:"Next",navigate:function(e,t){return"Page "+e+" of "+t},page:function(e){return"Page "+e},showing:"Showing",of:"of",to:"to",results:"results"},loading:"Loading...",noRecordsFound:"No matching records found",error:"An error happened while fetching the data"},ph=function(){function e(e){this._language=void 0,this._defaultLanguage=void 0,this._language=e,this._defaultLanguage=dh}var t=e.prototype;return t.getString=function(e,t){if(!t||!e)return null;var i=e.split("."),n=i[0];if(t[n]){var s=t[n];return"string"==typeof s?function(){return s}:"function"==typeof s?s:this.getString(i.slice(1).join("."),s)}return null},t.translate=function(e){var t;return(t=this.getString(e,this._language)||this.getString(e,this._defaultLanguage))?t.apply(void 0,[].slice.call(arguments,1)):e},e}();function uh(){var e=ch();return function(t){var i;return(i=e.translator).translate.apply(i,[t].concat([].slice.call(arguments,1)))}}var hh=function(e){return function(t){return Dp({},t,{search:{keyword:e}})}};function gh(){return ch().store}function fh(e){var t=gh(),i=Zu(e(t.getState())),n=i[0],s=i[1];return Xu(function(){return t.subscribe(function(){var i=e(t.getState());n!==i&&s(i)})},[]),n}function mh(){var e,t=Zu(void 0),i=t[0],n=t[1],s=ch(),r=s.search,o=uh(),a=gh().dispatch,l=fh(function(e){return e.search});Xu(function(){i&&i.setProps({keyword:null==l?void 0:l.keyword})},[l,i]),Xu(function(){n(r.server?new zu({keyword:r.keyword,url:r.server.url,body:r.server.body}):new Nu({keyword:r.keyword,columns:s.header&&s.header.columns,ignoreHiddenColumns:r.ignoreHiddenColumns||void 0===r.ignoreHiddenColumns,selector:r.selector})),r.keyword&&a(hh(r.keyword))},[r]),Xu(function(){if(i)return s.pipeline.register(i),function(){return s.pipeline.unregister(i)}},[s,i]);var c,d,p,u=function(e,t){return Uu=8,th(function(){return e},t)}((c=function(e){e.target instanceof HTMLInputElement&&a(hh(e.target.value))},d=i instanceof zu?r.debounceTimeout||250:0,function(){var e=arguments;return new Promise(function(t){p&&clearTimeout(p),p=setTimeout(function(){return t(c.apply(void 0,[].slice.call(e)))},d)})}),[r,i]);return iu("div",{className:Pu(Du("search",null==(e=s.className)?void 0:e.search))},iu("input",{type:"search",placeholder:o("search.placeholder"),"aria-label":o("search.placeholder"),onInput:u,className:Du(Pu("input"),Pu("search","input")),defaultValue:(null==l?void 0:l.keyword)||""}))}var bh=function(e){function t(){return e.apply(this,arguments)||this}Fp(t,e);var i=t.prototype;return i.validateProps=function(){if(isNaN(Number(this.props.limit))||isNaN(Number(this.props.page)))throw Error("Invalid parameters passed")},i._process=function(e){var t=this.props.page;return new Iu(e.rows.slice(t*this.props.limit,(t+1)*this.props.limit))},Pp(t,[{key:"type",get:function(){return Ou.Limit}}]),t}(ju),vh=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(e){var t={};return this.props.url&&(t.url=this.props.url(e.url,this.props.page,this.props.limit)),this.props.body&&(t.body=this.props.body(e.body,this.props.page,this.props.limit)),Dp({},e,t)},Pp(t,[{key:"type",get:function(){return Ou.ServerLimit}}]),t}(ju);function yh(){var e=ch(),t=e.pagination,i=t.server,n=t.summary,s=void 0===n||n,r=t.nextButton,o=void 0===r||r,a=t.prevButton,l=void 0===a||a,c=t.buttonsCount,d=void 0===c?3:c,p=t.limit,u=void 0===p?10:p,h=t.page,g=void 0===h?0:h,f=t.resetPageOnUpdate,m=void 0===f||f,b=eh(null),v=Zu(g),y=v[0],_=v[1],w=Zu(0),x=w[0],k=w[1],A=uh();Xu(function(){return i?(b.current=new vh({limit:u,page:y,url:i.url,body:i.body}),e.pipeline.register(b.current)):(b.current=new bh({limit:u,page:y}),e.pipeline.register(b.current)),b.current instanceof vh?e.pipeline.on("afterProcess",function(e){return k(e.length)}):b.current instanceof bh&&b.current.on("beforeProcess",function(e){return k(e.length)}),e.pipeline.on("updated",S),e.pipeline.on("error",function(){k(0),_(0)}),function(){e.pipeline.unregister(b.current),e.pipeline.off("updated",S)}},[]);var S=function(e){m&&e!==b.current&&(_(0),0!==b.current.props.page&&b.current.setProps({page:0}))},$=function(){return Math.ceil(x/u)},E=function(e){if(e>=$()||e<0||e===y)return null;_(e),b.current.setProps({page:e})};return iu("div",{className:Du(Pu("pagination"),e.className.pagination)},iu(su,null,s&&x>0&&iu("div",{role:"status","aria-live":"polite",className:Du(Pu("summary"),e.className.paginationSummary),title:A("pagination.navigate",y+1,$())},A("pagination.showing")," ",iu("b",null,A(""+(y*u+1)))," ",A("pagination.to")," ",iu("b",null,A(""+Math.min((y+1)*u,x)))," ",A("pagination.of")," ",iu("b",null,A(""+x))," ",A("pagination.results"))),iu("div",{className:Pu("pages")},l&&iu("button",{tabIndex:0,role:"button",disabled:0===y,onClick:function(){return E(y-1)},title:A("pagination.previous"),"aria-label":A("pagination.previous"),className:Du(e.className.paginationButton,e.className.paginationButtonPrev)},A("pagination.previous")),function(){if(d<=0)return null;var t=Math.min($(),d),i=Math.min(y,Math.floor(t/2));return y+Math.floor(t/2)>=$()&&(i=t-($()-y)),iu(su,null,$()>t&&y-i>0&&iu(su,null,iu("button",{tabIndex:0,role:"button",onClick:function(){return E(0)},title:A("pagination.firstPage"),"aria-label":A("pagination.firstPage"),className:e.className.paginationButton},A("1")),iu("button",{tabIndex:-1,className:Du(Pu("spread"),e.className.paginationButton)},"...")),Array.from(Array(t).keys()).map(function(e){return y+(e-i)}).map(function(t){return iu("button",{tabIndex:0,role:"button",onClick:function(){return E(t)},className:Du(y===t?Du(Pu("currentPage"),e.className.paginationButtonCurrent):null,e.className.paginationButton),title:A("pagination.page",t+1),"aria-label":A("pagination.page",t+1)},A(""+(t+1)))}),$()>t&&$()>y+i+1&&iu(su,null,iu("button",{tabIndex:-1,className:Du(Pu("spread"),e.className.paginationButton)},"..."),iu("button",{tabIndex:0,role:"button",onClick:function(){return E($()-1)},title:A("pagination.page",$()),"aria-label":A("pagination.page",$()),className:e.className.paginationButton},A(""+$()))))}(),o&&iu("button",{tabIndex:0,role:"button",disabled:$()===y+1||0===$(),onClick:function(){return E(y+1)},title:A("pagination.next"),"aria-label":A("pagination.next"),className:Du(e.className.paginationButton,e.className.paginationButtonNext)},A("pagination.next"))))}function _h(e,t){return"string"==typeof e?e.indexOf("%")>-1?t/100*parseInt(e,10):parseInt(e,10):e}function wh(e){return e?Math.floor(e)+"px":""}function xh(e){var t=e.tableRef.cloneNode(!0);return t.style.position="absolute",t.style.width="100%",t.style.zIndex="-2147483640",t.style.visibility="hidden",iu("div",{ref:function(e){e&&e.appendChild(t)}})}function kh(e){if(!e)return"";var t=e.split(" ");return 1===t.length&&/([a-z][A-Z])+/g.test(e)?e:t.map(function(e,t){return 0==t?e.toLowerCase():e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()}).join("")}var Ah,Sh=new(function(){function e(){}var t=e.prototype;return t.format=function(e,t){return"[Grid.js] ["+t.toUpperCase()+"]: "+e},t.error=function(e,t){void 0===t&&(t=!1);var i=this.format(e,"error");if(t)throw Error(i);console.error(i)},t.warn=function(e){console.warn(this.format(e,"warn"))},t.info=function(e){console.info(this.format(e,"info"))},e}());!function(e){e[e.Header=0]="Header",e[e.Footer=1]="Footer",e[e.Cell=2]="Cell"}(Ah||(Ah={}));var $h=function(){function e(){this.plugins=void 0,this.plugins=[]}var t=e.prototype;return t.get=function(e){return this.plugins.find(function(t){return t.id===e})},t.add=function(e){return e.id?this.get(e.id)?(Sh.error("Duplicate plugin ID: "+e.id),this):(this.plugins.push(e),this):(Sh.error("Plugin ID cannot be empty"),this)},t.remove=function(e){var t=this.get(e);return t&&this.plugins.splice(this.plugins.indexOf(t),1),this},t.list=function(e){return(null!=e||null!=e?this.plugins.filter(function(t){return t.position===e}):this.plugins).sort(function(e,t){return e.order&&t.order?e.order-t.order:1})},e}();function Eh(e){var t=this,i=ch();if(e.pluginId){var n=i.plugin.get(e.pluginId);return n?iu(su,{},iu(n.component,Dp({plugin:n},e.props))):null}return void 0!==e.position?iu(su,{},i.plugin.list(e.position).map(function(e){return iu(e.component,Dp({plugin:e},t.props.props))})):null}var Oh=function(e){function t(){var t;return(t=e.call(this)||this)._columns=void 0,t._columns=[],t}Fp(t,e);var i=t.prototype;return i.adjustWidth=function(e,i,n){var s=e.container,r=e.autoWidth;if(!s)return this;var o=s.clientWidth,a={};i.current&&r&&(ku(iu(xh,{tableRef:i.current}),n.current),a=function(e){var t=e.querySelector("table");if(!t)return{};var i=t.className,n=t.style.cssText;t.className=i+" "+Pu("shadowTable"),t.style.tableLayout="auto",t.style.width="auto",t.style.padding="0",t.style.margin="0",t.style.border="none",t.style.outline="none";var s=Array.from(t.parentNode.querySelectorAll("thead th")).reduce(function(e,t){var i;return t.style.width=t.clientWidth+"px",Dp(((i={})[t.getAttribute("data-column-id")]={minWidth:t.clientWidth},i),e)},{});return t.className=i,t.style.cssText=n,t.style.tableLayout="auto",Array.from(t.parentNode.querySelectorAll("thead th")).reduce(function(e,t){return e[t.getAttribute("data-column-id")].width=t.clientWidth,e},s)}(n.current));for(var l,c=zp(t.tabularFormat(this.columns).reduce(function(e,t){return e.concat(t)},[]));!(l=c()).done;){var d=l.value;d.columns&&d.columns.length>0||(!d.width&&r?d.id in a&&(d.width=wh(a[d.id].width),d.minWidth=wh(a[d.id].minWidth)):d.width=wh(_h(d.width,o)))}return i.current&&r&&ku(null,n.current),this},i.setSort=function(e,t){for(var i,n=zp(t||this.columns||[]);!(i=n()).done;){var s=i.value;s.columns&&s.columns.length>0?s.sort=void 0:void 0===s.sort&&e?s.sort={}:s.sort?"object"==typeof s.sort&&(s.sort=Dp({},s.sort)):s.sort=void 0,s.columns&&this.setSort(e,s.columns)}},i.setResizable=function(e,t){for(var i,n=zp(t||this.columns||[]);!(i=n()).done;){var s=i.value;void 0===s.resizable&&(s.resizable=e),s.columns&&this.setResizable(e,s.columns)}},i.setID=function(e){for(var t,i=zp(e||this.columns||[]);!(t=i()).done;){var n=t.value;n.id||"string"!=typeof n.name||(n.id=kh(n.name)),n.id||Sh.error('Could not find a valid ID for one of the columns. Make sure a valid "id" is set for all columns.'),n.columns&&this.setID(n.columns)}},i.populatePlugins=function(e,t){for(var i,n=zp(t);!(i=n()).done;){var s=i.value;void 0!==s.plugin&&e.add(Dp({id:s.id},s.plugin,{position:Ah.Cell}))}},t.fromColumns=function(e){for(var i,n=new t,s=zp(e);!(i=s()).done;){var r=i.value;if("string"==typeof r||Gp(r))n.columns.push({name:r});else if("object"==typeof r){var o=r;o.columns&&(o.columns=t.fromColumns(o.columns).columns),"object"==typeof o.plugin&&void 0===o.data&&(o.data=null),n.columns.push(r)}}return n},t.createFromConfig=function(e){var i=new t;return e.from?i.columns=t.fromHTMLTable(e.from).columns:e.columns?i.columns=t.fromColumns(e.columns).columns:!e.data||"object"!=typeof e.data[0]||e.data[0]instanceof Array||(i.columns=Object.keys(e.data[0]).map(function(e){return{name:e}})),i.columns.length?(i.setID(),i.setSort(e.sort),i.setResizable(e.resizable),i.populatePlugins(e.plugin,i.columns),i):null},t.fromHTMLTable=function(e){for(var i,n=new t,s=zp(e.querySelector("thead").querySelectorAll("th"));!(i=s()).done;){var r=i.value;n.columns.push({name:r.innerHTML,width:r.width})}return n},t.tabularFormat=function(e){var t=[],i=e||[],n=[];if(i&&i.length){t.push(i);for(var s,r=zp(i);!(s=r()).done;){var o=s.value;o.columns&&o.columns.length&&(n=n.concat(o.columns))}n.length&&(t=t.concat(this.tabularFormat(n)))}return t},t.leafColumns=function(e){var t=[],i=e||[];if(i&&i.length)for(var n,s=zp(i);!(n=s()).done;){var r=n.value;r.columns&&0!==r.columns.length||t.push(r),r.columns&&(t=t.concat(this.leafColumns(r.columns)))}return t},t.maximumDepth=function(e){return this.tabularFormat([e]).length-1},Pp(t,[{key:"columns",get:function(){return this._columns},set:function(e){this._columns=e}},{key:"visibleColumns",get:function(){return this._columns.filter(function(e){return!e.hidden})}}]),t}(Su),Ch=function(){},Th=function(e){function t(t){var i;return(i=e.call(this)||this).data=void 0,i.set(t),i}Fp(t,e);var i=t.prototype;return i.get=function(){try{return Promise.resolve(this.data()).then(function(e){return{data:e,total:e.length}})}catch(e){return Promise.reject(e)}},i.set=function(e){return e instanceof Array?this.data=function(){return e}:e instanceof Function&&(this.data=e),this},t}(Ch),Ih=function(e){function t(t){var i;return(i=e.call(this)||this).options=void 0,i.options=t,i}Fp(t,e);var i=t.prototype;return i.handler=function(e){return"function"==typeof this.options.handle?this.options.handle(e):e.ok?e.json():(Sh.error("Could not fetch data: "+e.status+" - "+e.statusText,!0),null)},i.get=function(e){var t=Dp({},this.options,e);return"function"==typeof t.data?t.data(t):fetch(t.url,t).then(this.handler.bind(this)).then(function(e){return{data:t.then(e),total:"function"==typeof t.total?t.total(e):void 0}})},t}(Ch),Lh=function(){function e(){}return e.createFromConfig=function(e){var t=null;return e.data&&(t=new Th(e.data)),e.from&&(t=new Th(this.tableElementToArray(e.from)),e.from.style.display="none"),e.server&&(t=new Ih(e.server)),t||Sh.error("Could not determine the storage type",!0),t},e.tableElementToArray=function(e){for(var t,i,n=[],s=zp(e.querySelector("tbody").querySelectorAll("tr"));!(t=s()).done;){for(var r,o=[],a=zp(t.value.querySelectorAll("td"));!(r=a()).done;){var l=r.value;1===l.childNodes.length&&l.childNodes[0].nodeType===Node.TEXT_NODE?o.push((i=l.innerHTML,(new DOMParser).parseFromString(i,"text/html").documentElement.textContent)):o.push(Eu(l.innerHTML))}n.push(o)}return n},e}(),Rh="undefined"!=typeof Symbol?Symbol.iterator||(Symbol.iterator=Symbol("Symbol.iterator")):"@@iterator";function jh(e,t,i){if(!e.s){if(i instanceof Nh){if(!i.s)return void(i.o=jh.bind(null,e,t));1&t&&(t=i.s),i=i.v}if(i&&i.then)return void i.then(jh.bind(null,e,t),jh.bind(null,e,2));e.s=t,e.v=i;var n=e.o;n&&n(e)}}var Nh=function(){function e(){}return e.prototype.then=function(t,i){var n=new e,s=this.s;if(s){var r=1&s?t:i;if(r){try{jh(n,1,r(this.v))}catch(e){jh(n,2,e)}return n}return this}return this.o=function(e){try{var s=e.v;1&e.s?jh(n,1,t?t(s):s):i?jh(n,1,i(s)):jh(n,2,s)}catch(e){jh(n,2,e)}},n},e}();function Ph(e){return e instanceof Nh&&1&e.s}var Dh=function(e){function t(t){var i;return(i=e.call(this)||this)._steps=new Map,i.cache=new Map,i.lastProcessorIndexUpdated=-1,t&&t.forEach(function(e){return i.register(e)}),i}Fp(t,e);var i=t.prototype;return i.clearCache=function(){this.cache=new Map,this.lastProcessorIndexUpdated=-1},i.register=function(e,t){if(void 0===t&&(t=null),!e)throw Error("Processor is not defined");if(null===e.type)throw Error("Processor type is not defined");if(this.findProcessorIndexByID(e.id)>-1)throw Error("Processor ID "+e.id+" is already defined");return e.on("propsUpdated",this.processorPropsUpdated.bind(this)),this.addProcessorByPriority(e,t),this.afterRegistered(e),e},i.tryRegister=function(e,t){void 0===t&&(t=null);try{return this.register(e,t)}catch(e){}},i.unregister=function(e){if(e&&-1!==this.findProcessorIndexByID(e.id)){var t=this._steps.get(e.type);t&&t.length&&(this._steps.set(e.type,t.filter(function(t){return t!=e})),this.emit("updated",e))}},i.addProcessorByPriority=function(e,t){var i=this._steps.get(e.type);if(!i){var n=[];this._steps.set(e.type,n),i=n}if(null===t||t<0)i.push(e);else if(i[t]){var s=i.slice(0,t-1),r=i.slice(t+1);this._steps.set(e.type,s.concat(e).concat(r))}else i[t]=e},i.getStepsByType=function(e){return this.steps.filter(function(t){return t.type===e})},i.getSortedProcessorTypes=function(){return Object.keys(Ou).filter(function(e){return!isNaN(Number(e))}).map(function(e){return Number(e)})},i.process=function(e){try{var t=function(e){return i.lastProcessorIndexUpdated=s.length,i.emit("afterProcess",r),r},i=this,n=i.lastProcessorIndexUpdated,s=i.steps,r=e,o=function(e,t){try{var o=function(e,t){if("function"==typeof e[Rh]){var i,n,s,r=e[Rh]();if(function e(o){try{for(;!(i=r.next()).done;)if((o=t(i.value))&&o.then){if(!Ph(o))return void o.then(e,s||(s=jh.bind(null,n=new Nh,2)));o=o.v}n?jh(n,1,o):n=o}catch(e){jh(n||(n=new Nh),2,e)}}(),r.return){var o=function(e){try{i.done||r.return()}catch(e){}return e};if(n&&n.then)return n.then(o,function(e){throw o(e)});o()}return n}if(!("length"in e))throw new TypeError("Object is not iterable");for(var a=[],l=0;l<e.length;l++)a.push(e[l]);return function(e,t){var i,n,s=-1;return function r(o){try{for(;++s<e.length;)if((o=t(s))&&o.then){if(!Ph(o))return void o.then(r,n||(n=jh.bind(null,i=new Nh,2)));o=o.v}i?jh(i,1,o):i=o}catch(e){jh(i||(i=new Nh),2,e)}}(),i}(a,function(e){return t(a[e])})}(s,function(e){var t=i.findProcessorIndexByID(e.id),s=function(){if(t>=n)return Promise.resolve(e.process(r)).then(function(t){i.cache.set(e.id,r=t)});r=i.cache.get(e.id)}();if(s&&s.then)return s.then(function(){})})}catch(e){return t(e)}return o&&o.then?o.then(void 0,t):o}(0,function(e){throw Sh.error(e),i.emit("error",r),e});return Promise.resolve(o&&o.then?o.then(t):t())}catch(e){return Promise.reject(e)}},i.findProcessorIndexByID=function(e){return this.steps.findIndex(function(t){return t.id==e})},i.setLastProcessorIndex=function(e){var t=this.findProcessorIndexByID(e.id);this.lastProcessorIndexUpdated>t&&(this.lastProcessorIndexUpdated=t)},i.processorPropsUpdated=function(e){this.setLastProcessorIndex(e),this.emit("propsUpdated"),this.emit("updated",e)},i.afterRegistered=function(e){this.setLastProcessorIndex(e),this.emit("afterRegister"),this.emit("updated",e)},Pp(t,[{key:"steps",get:function(){for(var e,t=[],i=zp(this.getSortedProcessorTypes());!(e=i()).done;){var n=this._steps.get(e.value);n&&n.length&&(t=t.concat(n))}return t.filter(function(e){return e})}}]),t}(Lu),Fh=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(e){try{return Promise.resolve(this.props.storage.get(e))}catch(e){return Promise.reject(e)}},Pp(t,[{key:"type",get:function(){return Ou.Extractor}}]),t}(ju),Bh=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(e){var t=Iu.fromArray(e.data);return t.length=e.total,t},Pp(t,[{key:"type",get:function(){return Ou.Transformer}}]),t}(ju),Mh=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(){return Object.entries(this.props.serverStorageOptions).filter(function(e){return"function"!=typeof e[1]}).reduce(function(e,t){var i;return Dp({},e,((i={})[t[0]]=t[1],i))},{})},Pp(t,[{key:"type",get:function(){return Ou.Initiator}}]),t}(ju),qh=function(e){function t(){return e.apply(this,arguments)||this}Fp(t,e);var i=t.prototype;return i.castData=function(e){if(!e||!e.length)return[];if(!this.props.header||!this.props.header.columns)return e;var t=Oh.leafColumns(this.props.header.columns);return e[0]instanceof Array?e.map(function(e){var i=0;return t.map(function(t,n){return void 0!==t.data?(i++,"function"==typeof t.data?t.data(e):t.data):e[n-i]})}):"object"!=typeof e[0]||e[0]instanceof Array?[]:e.map(function(e){return t.map(function(t,i){return void 0!==t.data?"function"==typeof t.data?t.data(e):t.data:t.id?e[t.id]:(Sh.error("Could not find the correct cell for column at position "+i+".\n                          Make sure either 'id' or 'selector' is defined for all columns."),null)})})},i._process=function(e){return{data:this.castData(e.data),total:e.total}},Pp(t,[{key:"type",get:function(){return Ou.Transformer}}]),t}(ju),zh=function(){function e(){}return e.createFromConfig=function(e){var t=new Dh;return e.storage instanceof Ih&&t.register(new Mh({serverStorageOptions:e.server})),t.register(new Fh({storage:e.storage})),t.register(new qh({header:e.header})),t.register(new Bh),t},e}(),Uh=function(e){var t=this;this.state=void 0,this.listeners=[],this.isDispatching=!1,this.getState=function(){return t.state},this.getListeners=function(){return t.listeners},this.dispatch=function(e){if("function"!=typeof e)throw new Error("Reducer is not a function");if(t.isDispatching)throw new Error("Reducers may not dispatch actions");t.isDispatching=!0;var i=t.state;try{t.state=e(t.state)}finally{t.isDispatching=!1}for(var n,s=zp(t.listeners);!(n=s()).done;)(0,n.value)(t.state,i);return t.state},this.subscribe=function(e){if("function"!=typeof e)throw new Error("Listener is not a function");return t.listeners=[].concat(t.listeners,[e]),function(){return t.listeners=t.listeners.filter(function(t){return t!==e})}},this.state=e},Hh=function(e,t){var i={__c:t="__cC"+Kp++,__:null,Consumer:function(e,t){return e.children(t)},Provider:function(e){var i,n;return this.getChildContext||(i=[],(n={})[t]=this,this.getChildContext=function(){return n},this.shouldComponentUpdate=function(e){this.props.value!==e.value&&i.some(lu)},this.sub=function(e){i.push(e);var t=e.componentWillUnmount;e.componentWillUnmount=function(){i.splice(i.indexOf(e),1),t&&t.call(e)}}),e.children}};return i.Provider.__=i.Consumer.contextType=i}(),Vh=function(){function e(){Object.assign(this,e.defaultConfig())}var t=e.prototype;return t.assign=function(e){return Object.assign(this,e)},t.update=function(t){return t?(this.assign(e.fromPartialConfig(Dp({},this,t))),this):this},e.defaultConfig=function(){return{store:new Uh({status:Up.Init,header:void 0,data:null}),plugin:new $h,tableRef:{current:null},width:"100%",height:"auto",processingThrottleMs:100,autoWidth:!0,style:{},className:{}}},e.fromPartialConfig=function(t){var i=(new e).assign(t);return"boolean"==typeof t.sort&&t.sort&&i.assign({sort:{multiColumn:!0}}),i.assign({header:Oh.createFromConfig(i)}),i.assign({storage:Lh.createFromConfig(i)}),i.assign({pipeline:zh.createFromConfig(i)}),i.assign({translator:new ph(i.language)}),i.plugin=new $h,i.search&&i.plugin.add({id:"search",position:Ah.Header,component:mh}),i.pagination&&i.plugin.add({id:"pagination",position:Ah.Footer,component:yh}),i.plugins&&i.plugins.forEach(function(e){return i.plugin.add(e)}),i},e}();function Wh(e){var t,i=ch();return iu("td",Dp({role:e.role,colSpan:e.colSpan,"data-column-id":e.column&&e.column.id,className:Du(Pu("td"),e.className,i.className.td),style:Dp({},e.style,i.style.td),onClick:function(t){e.messageCell||i.eventEmitter.emit("cellClick",t,e.cell,e.column,e.row)}},(t=e.column)?"function"==typeof t.attributes?t.attributes(e.cell.data,e.row,e.column):t.attributes:{}),e.column&&"function"==typeof e.column.formatter?e.column.formatter(e.cell.data,e.row,e.column):e.column&&e.column.plugin?iu(Eh,{pluginId:e.column.id,props:{column:e.column,cell:e.cell,row:e.row}}):e.cell.data)}function Gh(e){var t=ch(),i=fh(function(e){return e.header});return iu("tr",{className:Du(Pu("tr"),t.className.tr),onClick:function(i){e.messageRow||t.eventEmitter.emit("rowClick",i,e.row)}},e.children?e.children:e.row.cells.map(function(t,n){var s=function(e){if(i){var t=Oh.leafColumns(i.columns);if(t)return t[e]}return null}(n);return s&&s.hidden?null:iu(Wh,{key:t.id,cell:t,row:e.row,column:s})}))}function Yh(e){return iu(Gh,{messageRow:!0},iu(Wh,{role:"alert",colSpan:e.colSpan,messageCell:!0,cell:new Cu(e.message),className:Du(Pu("message"),e.className?e.className:null)}))}function Qh(){var e=ch(),t=fh(function(e){return e.data}),i=fh(function(e){return e.status}),n=fh(function(e){return e.header}),s=uh(),r=function(){return n?n.visibleColumns.length:0};return iu("tbody",{className:Du(Pu("tbody"),e.className.tbody)},t&&t.rows.map(function(e){return iu(Gh,{key:e.id,row:e})}),i===Up.Loading&&(!t||0===t.length)&&iu(Yh,{message:s("loading"),colSpan:r(),className:Du(Pu("loading"),e.className.loading)}),i===Up.Rendered&&t&&0===t.length&&iu(Yh,{message:s("noRecordsFound"),colSpan:r(),className:Du(Pu("notfound"),e.className.notfound)}),i===Up.Error&&iu(Yh,{message:s("error"),colSpan:r(),className:Du(Pu("error"),e.className.error)}))}var Kh=function(e){function t(){return e.apply(this,arguments)||this}Fp(t,e);var i=t.prototype;return i.validateProps=function(){for(var e,t=zp(this.props.columns);!(e=t()).done;){var i=e.value;void 0===i.direction&&(i.direction=1),1!==i.direction&&-1!==i.direction&&Sh.error("Invalid sort direction "+i.direction)}},i.compare=function(e,t){return e>t?1:e<t?-1:0},i.compareWrapper=function(e,t){for(var i,n=0,s=zp(this.props.columns);!(i=s()).done;){var r=i.value;if(0!==n)break;var o=e.cells[r.index].data,a=t.cells[r.index].data;n|="function"==typeof r.compare?r.compare(o,a)*r.direction:this.compare(o,a)*r.direction}return n},i._process=function(e){var t=[].concat(e.rows);t.sort(this.compareWrapper.bind(this));var i=new Iu(t);return i.length=e.length,i},Pp(t,[{key:"type",get:function(){return Ou.Sort}}]),t}(ju),Jh=function(e,t,i,n){return function(s){var r,o=null!=(r=s.sort)&&r.columns?s.sort.columns.map(function(e){return Dp({},e)}):[],a=o.length,l=o.find(function(t){return t.index===e}),c=!1,d=!1,p=!1,u=!1;if(void 0!==l?i?-1===l.direction?p=!0:u=!0:1===a?u=!0:a>1&&(d=!0,c=!0):0===a?c=!0:a>0&&!i?(c=!0,d=!0):a>0&&i&&(c=!0),d&&(o=[]),c)o.push({index:e,direction:t,compare:n});else if(u){var h=o.indexOf(l);o[h].direction=t}else if(p){var g=o.indexOf(l);o.splice(g,1)}return Dp({},s,{sort:{columns:o}})}},Zh=function(e,t,i){return function(n){var s=(n.sort?[].concat(n.sort.columns):[]).find(function(t){return t.index===e});return Dp({},n,s?Jh(e,1===s.direction?-1:1,t,i)(n):Jh(e,1,t,i)(n))}},Xh=function(e){function t(){return e.apply(this,arguments)||this}return Fp(t,e),t.prototype._process=function(e){var t={};return this.props.url&&(t.url=this.props.url(e.url,this.props.columns)),this.props.body&&(t.body=this.props.body(e.body,this.props.columns)),Dp({},e,t)},Pp(t,[{key:"type",get:function(){return Ou.ServerSort}}]),t}(ju);function eg(e){var t=ch(),i=gh().dispatch,n=uh(),s=Zu(0),r=s[0],o=s[1],a=t.sort,l=fh(function(e){return e.sort}),c="object"==typeof(null==a?void 0:a.server)?Ou.ServerSort:Ou.Sort,d=function(){var e=t.pipeline.getStepsByType(c);if(e.length)return e[0]};return Xu(function(){var e=d()||(c===Ou.ServerSort?new Xh(Dp({columns:l?l.columns:[]},a.server)):new Kh({columns:l?l.columns:[]}));return t.pipeline.tryRegister(e),function(){return t.pipeline.unregister(e)}},[t]),Xu(function(){if(l){var t,i=l.columns.find(function(t){return t.index===e.index});i?(0===r&&(i.direction=null!=(t=e.direction)?t:1),o(i.direction)):o(0)}},[l]),Xu(function(){var e=d();e&&l&&e.setProps({columns:l.columns})},[l]),iu("button",{tabIndex:-1,"aria-label":n("sort.sort"+(1===r?"Desc":"Asc")),title:n("sort.sort"+(1===r?"Desc":"Asc")),className:Du(Pu("sort"),Pu("sort",function(e){return 1===e?"asc":-1===e?"desc":"neutral"}(r)),t.className.sort),onClick:function(t){t.preventDefault(),t.stopPropagation(),i(Zh(e.index,!0===t.shiftKey&&a.multiColumn,e.compare))}})}var tg=function(e,t){var i;void 0===t&&(t=100);var n=Date.now(),s=function(){n=Date.now(),e.apply(void 0,[].slice.call(arguments))};return function(){var e=[].slice.call(arguments),r=Date.now()-n;r>=t?s.apply(void 0,e):(i&&clearTimeout(i),i=setTimeout(function(){s.apply(void 0,e),i=null},t-r))}};function ig(e){var t,i=function(e){return e instanceof MouseEvent?Math.floor(e.pageX):Math.floor(e.changedTouches[0].pageX)},n=function(n){n.stopPropagation();var o=parseInt(e.thRef.current.style.width,10)-i(n);t=tg(function(e){return s(e,o)},10),document.addEventListener("mouseup",r),document.addEventListener("touchend",r),document.addEventListener("mousemove",t),document.addEventListener("touchmove",t)},s=function(t,n){t.stopPropagation();var s=e.thRef.current;n+i(t)>=parseInt(s.style.minWidth,10)&&(s.style.width=n+i(t)+"px")},r=function e(i){i.stopPropagation(),document.removeEventListener("mouseup",e),document.removeEventListener("mousemove",t),document.removeEventListener("touchmove",t),document.removeEventListener("touchend",e)};return iu("div",{className:Du(Pu("th"),Pu("resizable")),onMouseDown:n,onTouchStart:n,onClick:function(e){return e.stopPropagation()}})}function ng(e){var t=ch(),i=eh(null),n=Zu({}),s=n[0],r=n[1],o=gh().dispatch;Xu(function(){if(t.fixedHeader&&i.current){var e=i.current.offsetTop;"number"==typeof e&&r({top:e})}},[i]);var a,l=function(){return null!=e.column.sort},c=function(i){i.stopPropagation(),l()&&o(Zh(e.index,!0===i.shiftKey&&t.sort.multiColumn,e.column.sort.compare))};return iu("th",Dp({ref:i,"data-column-id":e.column&&e.column.id,className:Du(Pu("th"),l()?Pu("th","sort"):null,t.fixedHeader?Pu("th","fixed"):null,t.className.th),onClick:c,style:Dp({},t.style.th,{minWidth:e.column.minWidth,width:e.column.width},s,e.style),onKeyDown:function(e){l()&&13===e.which&&c(e)},rowSpan:e.rowSpan>1?e.rowSpan:void 0,colSpan:e.colSpan>1?e.colSpan:void 0},(a=e.column)?"function"==typeof a.attributes?a.attributes(null,null,e.column):a.attributes:{},l()?{tabIndex:0}:{}),iu("div",{className:Pu("th","content")},void 0!==e.column.name?e.column.name:void 0!==e.column.plugin?iu(Eh,{pluginId:e.column.plugin.id,props:{column:e.column}}):null),l()&&iu(eg,Dp({index:e.index},e.column.sort)),e.column.resizable&&e.index<t.header.visibleColumns.length-1&&iu(ig,{column:e.column,thRef:i}))}function sg(){var e,t=ch(),i=fh(function(e){return e.header});return i?iu("thead",{key:i.id,className:Du(Pu("thead"),t.className.thead)},(e=Oh.tabularFormat(i.columns)).map(function(t,n){return function(e,t,n){var s=Oh.leafColumns(i.columns);return iu(Gh,null,e.map(function(e){return e.hidden?null:function(e,t,i,n){var s=function(e,t,i){var n=Oh.maximumDepth(e),s=i-t;return{rowSpan:Math.floor(s-n-n/s),colSpan:e.columns&&e.columns.length||1}}(e,t,n);return iu(ng,{column:e,index:i,colSpan:s.colSpan,rowSpan:s.rowSpan})}(e,t,s.indexOf(e),n)}))}(t,n,e.length)})):null}var rg=function(e){return function(t){return Dp({},t,{header:e})}};function og(){var e=ch(),t=eh(null),i=gh().dispatch;return Xu(function(){t&&i(function(e){return function(t){return Dp({},t,{tableRef:e})}}(t))},[t]),iu("table",{ref:t,role:"grid",className:Du(Pu("table"),e.className.table),style:Dp({},e.style.table,{height:e.height})},iu(sg,null),iu(Qh,null))}function ag(){var e=Zu(!0),t=e[0],i=e[1],n=eh(null),s=ch();return Xu(function(){0===n.current.children.length&&i(!1)},[n]),t?iu("div",{ref:n,className:Du(Pu("head"),s.className.header),style:Dp({},s.style.header)},iu(Eh,{position:Ah.Header})):null}function lg(){var e=eh(null),t=Zu(!0),i=t[0],n=t[1],s=ch();return Xu(function(){0===e.current.children.length&&n(!1)},[e]),i?iu("div",{ref:e,className:Du(Pu("footer"),s.className.footer),style:Dp({},s.style.footer)},iu(Eh,{position:Ah.Footer})):null}function cg(){var e=ch(),t=gh().dispatch,i=fh(function(e){return e.status}),n=fh(function(e){return e.data}),s=fh(function(e){return e.tableRef}),r={current:null},o=tg(function(){try{t(function(e){return Dp({},e,{status:Up.Loading})});var i=function(i,n){try{var s=Promise.resolve(e.pipeline.process()).then(function(e){t(function(e){return function(t){return e?Dp({},t,{data:e,status:Up.Loaded}):t}}(e)),setTimeout(function(){t(function(e){return e.status===Up.Loaded?Dp({},e,{status:Up.Rendered}):e})},0)})}catch(e){return n(e)}return s&&s.then?s.then(void 0,n):s}(0,function(e){Sh.error(e),t(function(e){return Dp({},e,{data:null,status:Up.Error})})});return Promise.resolve(i&&i.then?i.then(function(){}):void 0)}catch(e){return Promise.reject(e)}},e.processingThrottleMs);return Xu(function(){return t(rg(e.header)),o(),e.pipeline.on("updated",o),function(){return e.pipeline.off("updated",o)}},[]),Xu(function(){e.header&&i===Up.Loaded&&null!=n&&n.length&&t(rg(e.header.adjustWidth(e,s,r)))},[n,e,r]),iu("div",{role:"complementary",className:Du("gridjs",Pu("container"),i===Up.Loading?Pu("loading"):null,e.className.container),style:Dp({},e.style.container,{width:e.width})},i===Up.Loading&&iu("div",{className:Pu("loading-bar")}),iu(ag,null),iu("div",{className:Pu("wrapper"),style:{height:e.height}},iu(og,null)),iu(lg,null),iu("div",{ref:r,id:"gridjs-temp",className:Pu("temp")}))}var dg=function(e){function t(t){var i;return(i=e.call(this)||this).config=void 0,i.plugin=void 0,i.config=(new Vh).assign({instance:Mp(i),eventEmitter:Mp(i)}).update(t),i.plugin=i.config.plugin,i}Fp(t,e);var i=t.prototype;return i.updateConfig=function(e){return this.config.update(e),this},i.createElement=function(){return iu(Hh.Provider,{value:this.config,children:iu(cg,{})})},i.forceRender=function(){return this.config&&this.config.container||Sh.error("Container is empty. Make sure you call render() before forceRender()",!0),this.destroy(),ku(this.createElement(),this.config.container),this},i.destroy=function(){this.config.pipeline.clearCache(),ku(null,this.config.container)},i.render=function(e){return e||Sh.error("Container element cannot be null",!0),e.childNodes.length>0?(Sh.error("The container element "+e+" is not empty. Make sure the container is empty and call render() again"),this):(this.config.container=e,ku(this.createElement(),e),this)},t}(Lu);class pg extends s{static get properties(){return Object.assign({label:{type:String},property:{type:String},sort:{type:Boolean},width:{type:String}},super.properties)}constructor(){super(),this.label="no-label",this.property=null,this.sort=!1,this.width=null}connectedCallback(){super.connectedCallback()}data(){const e={name:Eu(`<pb-i18n key="${this.label}">${this.label}</pb-i18n>`),sort:{enabled:this.sort},formatter:e=>Eu(e)};return this.property&&(e.id=this.property),this.width&&(e.width=this.width),e}}customElements.define("pb-table-column",pg);class ug extends(o(s)){static get properties(){return Object.assign({source:{type:String},cssPath:{type:String,attribute:"css-path"},resizable:{type:Boolean},subforms:{type:String},perPage:{type:Number,attribute:"per-page"},height:{type:String},search:{type:Boolean},_params:{type:Object},_initialized:{type:Boolean}},super.properties)}constructor(){super(),this.cssPath="../css/gridjs",this._params={},this.resizable=!1,this.search=!1,this.perPage=10,this.height=null,this.fixedHeader=!1,this._initialized=!1}async connectedCallback(){if(super.connectedCallback(),this.subscribeTo("pb-search-resubmit",e=>{this._submit()}),y.subscribe(this,e=>{this._params=e,this._submit()}),this.subscribeTo("pb-i18n-update",e=>{const t=this.language&&this.language!==e.detail.language;this.language=e.detail.language,t&&this._submit()},[]),!this.height){const e=getComputedStyle(this).getPropertyValue("--pb-table-grid-height");this.height=e||"auto"}const e=await b([`${r(this.cssPath)}/mermaid.min.css`]),t=v(this),i=[...this.shadowRoot.adoptedStyleSheets];e&&i.push(e),t&&i.push(t),this.shadowRoot.adoptedStyleSheets=i}firstUpdated(){a("pb-page-ready",e=>{e&&e.language&&(this.language=e.language),this._params=y.state,this._initGrid()}),requestAnimationFrame(()=>this._initGrid())}_initGrid(){if(this._initialized||this.grid)return;const e=this.shadowRoot.getElementById("table");if(!e)return;const t=this.querySelectorAll("pb-table-column"),i=[];t.forEach(e=>i.push(e.data()));const n=this.getEndpoint&&this.getEndpoint()||".",s=this.toAbsoluteURL(this.source,n),r={height:this.height,fixedHeader:!0,columns:i,resizable:this.resizable,server:{url:s,then:e=>e.results,total:e=>e.count},sort:{multiColumn:!1,enabled:!0,server:{url:(e,t)=>{if(!t.length)return e;const n=t[0];return`${e}${e.indexOf("?")>-1?"&":"?"}order=${i[n.index].id}&dir=${1===n.direction?"asc":"desc"}`}}},pagination:{enabled:!0,limit:this.perPage,server:{url:(e,t,i)=>{const n=this.shadowRoot.getElementById("form");n&&Object.assign(this._params,this._serializeSearchForm(n)),this._params=this._paramsFromSubforms(this._params),this._params.limit=i,this._params.start=t*i+1,this.language&&(this._params.language=this.language),y.commit(this,this._params);const s=Object.assign({},this._params);return Object.keys(s).forEach(e=>{null===s[e]&&delete s[e]}),`${e}${e.indexOf("?")>-1?"&":"?"}${new URLSearchParams(s).toString()}`}}}};this.grid=new dg(r),this.grid.on("load",()=>{this.emitTo("pb-results-received",{params:this._params})}),this.grid.render(e),this._initialized=!0}_submit(){this.grid&&this.grid.forceRender()}_handleFormSubmit(e){e.preventDefault(),this._submit()}_handleSearchKey(e){"Enter"===e.key&&(e.preventDefault(),this._submit())}_serializeSearchForm(e){const t={};Array.from(e.elements||[]).filter(e=>e.name&&!e.disabled&&!e.closest("[disabled]")).forEach(e=>{e.name in t||(t[e.name]=null)});return new FormData(e).forEach((e,i)=>{null==t[i]?t[i]=e:Array.isArray(t[i])?t[i].push(e):t[i]=[t[i],e]}),t}_paramsFromSubforms(e){return this.subforms&&document.querySelectorAll(this.subforms).forEach(t=>{t.serializeForm&&Object.assign(e,t.serializeForm())}),e}render(){return t`
      ${this.search?t`
