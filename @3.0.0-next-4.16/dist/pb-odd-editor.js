import{Z as e,T as t,i,a as s,x as o,c as n,E as a,p as r,w as d}from"./pb-mixin-B7EAqf7q.js";import{e as l,i as c,t as p}from"./unsafe-html-C7vzzZJI.js";import{A as h,F as u,T as m,E as b,P as g,L as v,a as f,d as y,K as _,e as w,f as x,g as $,b as E,t as S,h as C,p as k}from"./focus-mixin-Bq-O03uC.js";import{l as A}from"./logger-BDsEU7Z8.js";import"./jinn-codemirror-DETLdm08.js";import{t as R,g as I}from"./pb-i18n-Dne_FgGK.js";import"./pb-dialog-E9XIBi_S.js";const P=(()=>{if("undefined"==typeof self)return!1;if("top"in self&&self!==top)try{top.window.document._=0}catch(e){return!1}return"showOpenFilePicker"in self})();P?Promise.resolve().then(function(){return j}):Promise.resolve().then(function(){return V}),P?Promise.resolve().then(function(){return L}):Promise.resolve().then(function(){return W});const M=P?Promise.resolve().then(function(){return U}):Promise.resolve().then(function(){return G});async function T(...e){return(await M).default(...e)}const O=async e=>{const t=await e.getFile();return t.handle=e,t};var B=async(e=[{}])=>{Array.isArray(e)||(e=[e]);const t=[];e.forEach((e,i)=>{t[i]={description:e.description||"Files",accept:{}},e.mimeTypes?e.mimeTypes.map(s=>{t[i].accept[s]=e.extensions||[]}):t[i].accept["*/*"]=e.extensions||[]});const i=await window.showOpenFilePicker({id:e[0].id,startIn:e[0].startIn,types:t,multiple:e[0].multiple||!1,excludeAcceptAllOption:e[0].excludeAcceptAllOption||!1}),s=await Promise.all(i.map(O));return e[0].multiple?s:s[0]},j={__proto__:null,default:B};function z(e){function t(e){if(Object(e)!==e)return Promise.reject(new TypeError(e+" is not an object."));var t=e.done;return Promise.resolve(e.value).then(function(e){return{value:e,done:t}})}return z=function(e){this.s=e,this.n=e.next},z.prototype={s:null,n:null,next:function(){return t(this.n.apply(this.s,arguments))},return:function(e){var i=this.s.return;return void 0===i?Promise.resolve({value:e,done:!0}):t(i.apply(this.s,arguments))},throw:function(e){var i=this.s.return;return void 0===i?Promise.reject(e):t(i.apply(this.s,arguments))}},new z(e)}const q=async(e,t,i=e.name,s)=>{const o=[],n=[];var a,r=!1,d=!1;try{for(var l,c=function(e){var t,i,s,o=2;for("undefined"!=typeof Symbol&&(i=Symbol.asyncIterator,s=Symbol.iterator);o--;){if(i&&null!=(t=e[i]))return t.call(e);if(s&&null!=(t=e[s]))return new z(t.call(e));i="@@asyncIterator",s="@@iterator"}throw new TypeError("Object is not async iterable")}(e.values());r=!(l=await c.next()).done;r=!1){const a=l.value,r=`${i}/${a.name}`;"file"===a.kind?n.push(a.getFile().then(t=>(t.directoryHandle=e,t.handle=a,Object.defineProperty(t,"webkitRelativePath",{configurable:!0,enumerable:!0,get:()=>r})))):"directory"!==a.kind||!t||s&&s(a)||o.push(q(a,t,r,s))}}catch(e){d=!0,a=e}finally{try{r&&null!=c.return&&await c.return()}finally{if(d)throw a}}return[...(await Promise.all(o)).flat(),...await Promise.all(n)]};var N=async(e={})=>{e.recursive=e.recursive||!1,e.mode=e.mode||"read";const t=await window.showDirectoryPicker({id:e.id,startIn:e.startIn,mode:e.mode});return(await(await t.values()).next()).done?[t]:q(t,e.recursive,void 0,e.skipDirectory)},L={__proto__:null,default:N},D=async(e,t=[{}],i=null,s=!1,o=null)=>{Array.isArray(t)||(t=[t]),t[0].fileName=t[0].fileName||"Untitled";const n=[];let a=null;if(e instanceof Blob&&e.type?a=e.type:e.headers&&e.headers.get("content-type")&&(a=e.headers.get("content-type")),t.forEach((e,t)=>{n[t]={description:e.description||"Files",accept:{}},e.mimeTypes?(0===t&&a&&e.mimeTypes.push(a),e.mimeTypes.map(i=>{n[t].accept[i]=e.extensions||[]})):a?n[t].accept[a]=e.extensions||[]:n[t].accept["*/*"]=e.extensions||[]}),i)try{await i.getFile()}catch(e){if(i=null,s)throw e}const r=i||await window.showSaveFilePicker({suggestedName:t[0].fileName,id:t[0].id,startIn:t[0].startIn,types:n,excludeAcceptAllOption:t[0].excludeAcceptAllOption||!1});!i&&o&&o(r);const d=await r.createWritable();if("stream"in e){const t=e.stream();return await t.pipeTo(d),r}return"body"in e?(await e.body.pipeTo(d),r):(await d.write(await e),await d.close(),r)},U={__proto__:null,default:D},F=async(e=[{}])=>(Array.isArray(e)||(e=[e]),new Promise((t,i)=>{const s=document.createElement("input");s.type="file";const o=[...e.map(e=>e.mimeTypes||[]),...e.map(e=>e.extensions||[])].join();s.multiple=e[0].multiple||!1,s.accept=o||"",s.style.display="none",document.body.append(s),s.addEventListener("cancel",()=>{s.remove(),i(new DOMException("The user aborted a request.","AbortError"))}),s.addEventListener("change",()=>{s.remove(),t(s.multiple?Array.from(s.files):s.files[0])}),"showPicker"in HTMLInputElement.prototype?s.showPicker():s.click()})),V={__proto__:null,default:F},K=async(e=[{}])=>(Array.isArray(e)||(e=[e]),e[0].recursive=e[0].recursive||!1,new Promise((t,i)=>{const s=document.createElement("input");s.type="file",s.webkitdirectory=!0,s.style.display="none",document.body.append(s),s.addEventListener("cancel",()=>{s.remove(),i(new DOMException("The user aborted a request.","AbortError"))}),s.addEventListener("change",()=>{s.remove();let i=Array.from(s.files);e[0].recursive?e[0].recursive&&e[0].skipDirectory&&(i=i.filter(t=>t.webkitRelativePath.split("/").every(t=>!e[0].skipDirectory({name:t,kind:"directory"})))):i=i.filter(e=>2===e.webkitRelativePath.split("/").length),t(i)}),"showPicker"in HTMLInputElement.prototype?s.showPicker():s.click()})),W={__proto__:null,default:K},H=async(e,t={})=>{Array.isArray(t)&&(t=t[0]);const i=document.createElement("a");let s=e;"body"in e&&(s=await async function(e,t){const i=e.getReader(),s=new ReadableStream({start:e=>async function t(){return i.read().then(({done:i,value:s})=>{if(!i)return e.enqueue(s),t();e.close()})}()}),o=new Response(s),n=await o.blob();return i.releaseLock(),new Blob([n],{type:t})}(e.body,e.headers.get("content-type"))),i.download=t.fileName||"Untitled",i.href=URL.createObjectURL(await s);const o=()=>{"function"==typeof n&&n()},n=t.legacySetup&&t.legacySetup(o,()=>n(),i);return i.addEventListener("click",()=>{setTimeout(()=>URL.revokeObjectURL(i.href),3e4),o()}),i.click(),null},G={__proto__:null,default:H};const{I:J}=e,X=()=>document.createComment(""),Q=(e,t,i)=>{const s=e._$AA.parentNode,o=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(X(),o),n=s.insertBefore(X(),o);i=new J(t,n,e,e.options)}else{const t=i._$AB.nextSibling,r=i._$AM,d=r!==e;if(d){var n,a;let t;null!==(n=(a=i)._$AQ)&&void 0!==n&&n.call(a,e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==o||d){let e=i._$AA;for(;e!==t;){const t=e.nextSibling;s.insertBefore(e,o),e=t}}}return i},Y=(e,t,i=e)=>(e._$AI(t,i),e),Z={},ee=(e,t=Z)=>e._$AH=t,te=e=>e._$AH,ie=e=>{e._$AR(),e._$AA.remove()},se=(e,t,i)=>{const s=new Map;for(let o=t;o<=i;o++)s.set(e[o],o);return s},oe=l(class extends c{constructor(e){if(super(e),e.type!==p.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const o=[],n=[];let a=0;for(const t of e)o[a]=s?s(t,a):a,n[a]=i(t,a),a++;return{values:n,keys:o}}render(e,t,i){return this.dt(e,t,i).values}update(e,[i,s,o]){const n=te(e),{values:a,keys:r}=this.dt(i,s,o);if(!Array.isArray(n))return this.ut=r,a;const d=this.ut??=[],l=[];let c,p,h=0,u=n.length-1,m=0,b=a.length-1;for(;h<=u&&m<=b;)if(null===n[h])h++;else if(null===n[u])u--;else if(d[h]===r[m])l[m]=Y(n[h],a[m]),h++,m++;else if(d[u]===r[b])l[b]=Y(n[u],a[b]),u--,b--;else if(d[h]===r[b])l[b]=Y(n[h],a[b]),Q(e,l[b+1],n[h]),h++,b--;else if(d[u]===r[m])l[m]=Y(n[u],a[m]),Q(e,n[h],n[u]),u--,m++;else if(void 0===c&&(c=se(r,m,b),p=se(d,h,u)),c.has(d[h]))if(c.has(d[u])){const t=p.get(r[m]),i=void 0!==t?n[t]:null;if(null===i){const t=Q(e,n[h]);Y(t,a[m]),l[m]=t}else l[m]=Y(i,a[m]),Q(e,n[h],i),n[t]=null;m++}else ie(n[u]),u--;else ie(n[h]),h++;for(;m<=b;){const t=Q(e,l[b+1]);Y(t,a[m]),l[m++]=t}for(;h<=u;){const e=n[h++];null!==e&&ie(e)}return this.ut=r,ee(e,l),t}}),ne=e=>class extends(h(u(e))){static get properties(){return{_hasVaadinItemMixin:{value:!0},selected:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_selectedChanged",sync:!0},_value:String}}get _activeKeys(){return["Enter"," "]}get value(){return void 0!==this._value?this._value:this.textContent.trim()}set value(e){this._value=e}ready(){super.ready();const e=this.getAttribute("value");null!==e&&(this.value=e)}focus(e){this.disabled||super.focus(e)}_shouldSetActive(e){return!(this.disabled||"keydown"===e.type&&e.defaultPrevented)}_selectedChanged(e){this.setAttribute("aria-selected",e)}_disabledChanged(e){super._disabledChanged(e),e&&(this.selected=!1,this.blur())}_onKeyDown(e){super._onKeyDown(e),this._activeKeys.includes(e.key)&&!e.defaultPrevented&&(e.preventDefault(),this.click())}},ae=i`
  :host {
    flex-shrink: 0;
    display: flex;
    align-items: center;
...
`;class re extends(ne(m(b(g(v(s)))))){static get is(){return"vaadin-tab"}static get styles(){return ae}render(){return o`
      <slot></slot>
      <slot name="tooltip"></slot>
    `}ready(){super.ready(),this.setAttribute("role","tab"),this._tooltipController=new f(this),this.addController(this._tooltipController)}_onKeyUp(e){const t=this.hasAttribute("active");if(super._onKeyUp(e),t){const e=this.querySelector("a");e&&e.click()}}}y(re);const de=i`
  :host {
    display: flex;
    max-width: 100%;
    max-height: 100%;
...
`;function le(e,t){const{scrollLeft:i}=e;return"rtl"!==t?i:e.scrollWidth-e.clientWidth+i}function ce(e,t,i){e.scrollLeft="rtl"!==t?i:e.clientWidth-e.scrollWidth+i}const pe=e=>class extends(_(e)){get focused(){return(this._getItems()||[]).find(w)}get _vertical(){return!0}get _tabNavigation(){return!1}focus(e){const t=this._getFocusableIndex();t>=0&&this._focus(t,e)}_getFocusableIndex(){const e=this._getItems();return Array.isArray(e)?this._getAvailableIndex(e,0,null,e=>!x(e)):-1}_getItems(){return Array.from(this.children)}_onKeyDown(e){if(super._onKeyDown(e),e.metaKey||e.ctrlKey)return;const{key:t,shiftKey:i}=e,s=this._getItems()||[],o=s.indexOf(this.focused);let n,a;const r=!this._vertical&&"rtl"===this.getAttribute("dir")?-1:1;this.__isPrevKeyPressed(t,i)?(a=-r,n=o-r):this.__isNextKeyPressed(t,i)?(a=r,n=o+r):"Home"===t?(a=1,n=0):"End"===t&&(a=-1,n=s.length-1),n=this._getAvailableIndex(s,n,a,e=>!x(e)),this._tabNavigation&&"Tab"===t&&(n>o&&e.shiftKey||n<o&&!e.shiftKey||n===o)||n>=0&&(e.preventDefault(),this._focus(n,{focusVisible:!0},!0))}__isPrevKeyPressed(e,t){return this._vertical?"ArrowUp"===e:"ArrowLeft"===e||this._tabNavigation&&"Tab"===e&&t}__isNextKeyPressed(e,t){return this._vertical?"ArrowDown"===e:"ArrowRight"===e||this._tabNavigation&&"Tab"===e&&!t}_focus(e,t,i=!1){const s=this._getItems();this._focusItem(s[e],t,i)}_focusItem(e,t){e&&e.focus(t)}_getAvailableIndex(e,t,i,s){const o=e.length;let n=t;for(let t=0;"number"==typeof n&&t<o;t+=1,n+=i||1){n<0?n=o-1:n>=o&&(n=0);const t=e[n];if(this._isItemFocusable(t)&&this.__isMatchingItem(t,s))return n}return-1}__isMatchingItem(e,t){return"function"!=typeof t||t(e)}_isItemFocusable(e){return!e.hasAttribute("disabled")}},he=e=>class extends(pe(e)){static get properties(){return{disabled:{type:Boolean,value:!1,reflectToAttribute:!0},selected:{type:Number,reflectToAttribute:!0,notify:!0,sync:!0},orientation:{type:String,reflectToAttribute:!0,value:""},items:{type:Array,readOnly:!0,notify:!0},_searchBuf:{type:String,value:""}}}static get observers(){return["_enhanceItems(items, orientation, selected, disabled)"]}get _isRTL(){return!this._vertical&&"rtl"===this.getAttribute("dir")}get _scrollerElement(){return console.warn(`Please implement the '_scrollerElement' property in <${this.localName}>`),this}get _vertical(){return"horizontal"!==this.orientation}focus(e){this._observer&&this._observer.flush();const t=Array.isArray(this.items)?this.items:[],i=this._getAvailableIndex(t,0,null,e=>0===e.tabIndex&&!x(e));i>=0?this._focus(i,e):super.focus(e)}ready(){super.ready(),this.addEventListener("click",e=>this._onClick(e));const e=this.shadowRoot.querySelector("slot:not([name])");this._observer=new $(e,()=>{this._setItems(this._filterItems([...this.children]))})}_getItems(){return this.items}_enhanceItems(e,t,i,s){if(!s&&e){this.setAttribute("aria-orientation",t||"vertical"),e.forEach(e=>{t?e.setAttribute("orientation",t):e.removeAttribute("orientation")}),this._setFocusable(i<0||!i?0:i);const s=e[i];e.forEach(e=>{e.selected=e===s}),s&&!s.disabled&&this._scrollToItem(i)}}_filterItems(e){return e.filter(e=>e._hasVaadinItemMixin)}_onClick(e){if(e.metaKey||e.shiftKey||e.ctrlKey||e.defaultPrevented)return;const t=this._filterItems(e.composedPath())[0];let i;t&&!t.disabled&&(i=this.items.indexOf(t))>=0&&(this.selected=i)}_searchKey(e,t){this._searchReset=E.debounce(this._searchReset,S.after(500),()=>{this._searchBuf=""}),this._searchBuf+=t.toLowerCase(),this.items.some(e=>this.__isMatchingKey(e))||(this._searchBuf=t.toLowerCase());const i=1===this._searchBuf.length?e+1:e;return this._getAvailableIndex(this.items,i,1,e=>this.__isMatchingKey(e)&&"none"!==getComputedStyle(e).display)}__isMatchingKey(e){return e.textContent.replace(/[^\p{L}\p{Nd}]/gu,"").toLowerCase().startsWith(this._searchBuf)}_onKeyDown(e){if(e.metaKey||e.ctrlKey)return;const t=e.key,i=this.items.indexOf(this.focused);if(/[\p{L}\p{Nd}]/u.test(t)&&1===t.length){const e=this._searchKey(i,t);return void(e>=0&&this._focus(e))}super._onKeyDown(e)}_setFocusable(e){e=this._getAvailableIndex(this.items,e,1);const t=this.items[e];this.items.forEach(e=>{e.tabIndex=e===t?0:-1})}_focus(e,t){this.items.forEach((t,i)=>{t.focused=i===e}),this._setFocusable(e),this._scrollToItem(e),super._focus(e,t)}_scrollToItem(e){const t=this.items[e];if(!t)return;const i=this._vertical?["top","bottom"]:this._isRTL?["right","left"]:["left","right"],s=this._scrollerElement.getBoundingClientRect(),o=(this.items[e+1]||t).getBoundingClientRect(),n=(this.items[e-1]||t).getBoundingClientRect();let a=0;!this._isRTL&&o[i[1]]>=s[i[1]]||this._isRTL&&o[i[1]]<=s[i[1]]?a=o[i[1]]-s[i[1]]:(!this._isRTL&&n[i[0]]<=s[i[0]]||this._isRTL&&n[i[0]]>=s[i[0]])&&(a=n[i[0]]-s[i[0]]),this._scroll(a)}_scroll(e){if(this._vertical)this._scrollerElement.scrollTop+=e;else{const t=this.getAttribute("dir")||"ltr",i=le(this._scrollerElement,t)+e;ce(this._scrollerElement,t,i)}}},ue=new ResizeObserver(e=>{setTimeout(()=>{e.forEach(e=>{e.target.isConnected&&(e.target.resizables?e.target.resizables.forEach(t=>{t._onResize(e.contentRect)}):e.target._onResize(e.contentRect))})})}),me=C(e=>class extends e{get _observeParent(){return!1}connectedCallback(){if(super.connectedCallback(),ue.observe(this),this._observeParent){const e=this.parentNode instanceof ShadowRoot?this.parentNode.host:this.parentNode;e.resizables||(e.resizables=new Set,ue.observe(e)),e.resizables.add(this),this.__parent=e}}disconnectedCallback(){super.disconnectedCallback(),ue.unobserve(this);const e=this.__parent;if(this._observeParent&&e){const t=e.resizables;t&&(t.delete(this),0===t.size&&ue.unobserve(e)),this.__parent=null}}_onResize(e){}}),be=e=>class extends(me(he(e))){static get properties(){return{orientation:{value:"horizontal",type:String,reflectToAttribute:!0,sync:!0},selected:{value:0,type:Number,reflectToAttribute:!0}}}static get observers(){return["__tabsItemsChanged(items)"]}constructor(){super(),this.__itemsResizeObserver=new ResizeObserver(()=>{setTimeout(()=>this._updateOverflow())})}get _scrollOffset(){return this._vertical?this._scrollerElement.offsetHeight:this._scrollerElement.offsetWidth}get _scrollerElement(){return this.$.scroll}get __direction(){return!this._vertical&&this.__isRTL?1:-1}ready(){super.ready(),this._scrollerElement.addEventListener("scroll",()=>this._updateOverflow()),this.setAttribute("role","tablist")}_onResize(){this._updateOverflow()}__tabsItemsChanged(e){this.__itemsResizeObserver.disconnect(),(e||[]).forEach(e=>{this.__itemsResizeObserver.observe(e)}),this._updateOverflow()}_scrollForward(){const e=this._getNavigationButtonVisibleWidth("forward-button"),t=this._getNavigationButtonVisibleWidth("back-button"),i=this._scrollerElement.getBoundingClientRect(),s=[...this.items].reverse().find(s=>this._isItemVisible(s,e,t,i)).getBoundingClientRect(),o=20+this.shadowRoot.querySelector('[part="back-button"]').clientWidth;let n;if(this.__isRTL){const e=i.right-o;n=s.right-e}else{const e=i.left+o;n=s.left-e}-this.__direction*n<1&&(n=-this.__direction*(this._scrollOffset-o)),this._scroll(n)}_scrollBack(){const e=this._getNavigationButtonVisibleWidth("forward-button"),t=this._getNavigationButtonVisibleWidth("back-button"),i=this._scrollerElement.getBoundingClientRect(),s=this.items.find(s=>this._isItemVisible(s,e,t,i)).getBoundingClientRect(),o=20+this.shadowRoot.querySelector('[part="forward-button"]').clientWidth;let n;if(this.__isRTL){const e=i.left+o;n=s.left-e}else{const e=i.right-o;n=s.right-e}this.__direction*n<1&&(n=this.__direction*(this._scrollOffset-o)),this._scroll(n)}_isItemVisible(e,t,i,s){if(this._vertical)throw new Error("Visibility check is only supported for horizontal tabs.");const o=this.__isRTL?i:t,n=this.__isRTL?t:i,a=s.right-o,r=s.left+n,d=e.getBoundingClientRect();return a>Math.floor(d.left)&&r<Math.ceil(d.right)}_getNavigationButtonVisibleWidth(e){const t=this.shadowRoot.querySelector(`[part="${e}"]`);return"0"===window.getComputedStyle(t).opacity?0:t.clientWidth}_updateOverflow(){const e=this._vertical?this._scrollerElement.scrollTop:le(this._scrollerElement,this.getAttribute("dir")),t=this._vertical?this._scrollerElement.scrollHeight:this._scrollerElement.scrollWidth;let i=Math.floor(e)>1?"start":"";Math.ceil(e)<Math.ceil(t-this._scrollOffset)&&(i+=" end"),1===this.__direction&&(i=i.replace(/start|end/giu,e=>"start"===e?"end":"start")),i?this.setAttribute("overflow",i.trim()):this.removeAttribute("overflow")}};class ge extends(be(b(m(g(v(s)))))){static get is(){return"vaadin-tabs"}static get styles(){return de}render(){return o`
    ...
    `}}y(ge);class ve extends s{static get styles(){return i`
      :host {
        display: block;
      }
      .wrapper {
    ...
    `}render(){return o`
      ...
      <slot></slot>
    `}static get properties(){return{scopes:{type:Array},css:{type:String,reflect:!0},scope:{type:String,reflect:!0},selected:{type:String}}}constructor(){super(),this.scopes=["","before","after"],this.css="";const e=this.getAttribute("scope");this.scope=null!=e?e:"",this.selected="",this._initialized=!1}connectedCallback(){super.connectedCallback(),this.css=this.css.trim(),this.dispatchEvent(new CustomEvent("rendition-connected",{composed:!0,bubbles:!0,detail:{target:this}}))}firstUpdated(e){this.refreshEditor(),this._initialized=!0}refreshEditor(){A.log("refreshEditor"),this.shadowRoot.getElementById("editor")}_remove(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("remove-rendition",{}))}_handleCodeChange(){this.css=this.shadowRoot.getElementById("editor").value,this._emitChange()}_handleScopeChange(e){this.scope=e.target.value,this._emitChange()}_emitChange(){this.dispatchEvent(new CustomEvent("rendition-changed",{composed:!0,bubbles:!0,detail:{name:this.name,css:this.css,scope:this.scope}}))}_displayScope(e){return e||"(default)"}}customElements.define("pb-odd-rendition-editor",ve);class fe extends s{static get styles(){return i`
      :host {
        display: block;
      }
      .wrapper {
      ...
      <div class="wrapper">
        <div class="pb-field">
          <span class="pb-field__label"
            >${R("odd.editor.model.param-name-placeholder")}</span
          >
          <pb-autocomplete
            id="combo"
            .suggestions=${this._currentParameters}
            .value=${this.name||""}
            placeholder="${R("odd.editor.model.param-name-placeholder")}"
        ...
        <label class="pb-checkbox">
          ...
          />
          <span>${R("odd.editor.model.set-param")}</span>
        </label>
        <pb-icon-button
          class="icon-button"
          icon="delete"
    ...
    `}static get properties(){return{behaviour:{type:String},predicate:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},type:{type:String,reflect:!0},template:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},output:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},css:{type:String,converter:(e,t)=>"null"===e.toLowerCase()?"":e},mode:{type:String},model:{type:Object},models:{type:Array},parameters:{type:Array},renditions:{type:Array},desc:{type:String,converter:(e,t)=>"null"===e.toLowerCase()?"":e},sourcerend:{type:String},show:{type:Boolean,reflect:!0},outputs:{type:Array},behaviours:{type:Array},icon:{type:String},open:{type:String},hasCustomBehaviour:{type:Boolean},endpoint:{type:String},apiVersion:{type:String}}}constructor(){super(),this.behaviour="inline",this.predicate="",this.type="",this.template="",this.output="",this.css="",this.mode="",this.model={},this.model.models=[],this.parameters=[],this.renditions=[],this.desc="",this.sourcerend="",this.show=!1,this.outputs=["","web","print","epub","fo","latex","plain"],this.parentModel=[],this.behaviours=["alternate","anchor","block","body","break","cell","cit","document","figure","graphic","heading","inline","link","list","listItem","metadata","note","omit","paragraph","pass-through","row","section","table","text","title","webcomponent"],this.icon="expand-more",this.hasCustomBehaviour=!1}render(){let e;switch(this.output){case"web":case"epub":default:e="html";break;case"latex":e="tex";break;case"plain":e="default";break;case"fo":case"print":e="xml"}return o`
        <form>
            ...
            <details ?open="${this.show}" class="details">
                ...
                <div class="horizontal">
                    <label class="pb-field selectOutput">
                      <span class="pb-field__label">${R("odd.editor.model.output")}</span>
                      <select
                        id="output"
                        class="pb-select"
                        .value=${this.output||""}
                    ...
                    <label class="pb-field">
                      <span class="pb-field__label">${R("odd.editor.model.mode-placeholder")}</span>
                      <input
                        id="mode"
                        class="pb-input"
                        .value=${this.mode||""}
                        placeholder="${R("odd.editor.model.mode-placeholder")}"
                        @change=${this._inputMode}
                      />
                    </label>
                </div>
                <label class="pb-field">
                  <span class="pb-field__label">${R("odd.editor.model.description-placeholder")}</span>
                  <input
                    id="desc"
                    class="pb-input"
                    .value=${this.desc||""}
                    placeholder="${R("odd.editor.model.description-placeholder")}"
                ...
                <div class="editor">
                    ...
                    <jinn-codemirror id="predicate"
                        ...
                        placeholder="${R("odd.editor.model.predicate-placeholder")}"
                ...
                ${this._isModel()?o`
                        <div>
                          <div class="behaviourWrapper">
                            <label class="pb-field">
                              <span class="pb-field__label"
                                >${R("odd.editor.model.behaviour")}</span
                              >
                              <select
                                id="behaviour"
                                class="pb-select"
                            ...
                            <span style="align-self:center;justify-self: center;">
                              ${R("odd.editor.model.link-with-or")}
                            </span>
                            <label class="pb-field">
                              <span class="pb-field__label"
                                >${R("odd.editor.model.custom-behaviour-placeholder")}</span
                              >
                              <input
                                id="custombehaviour"
                                class="pb-input"
                                @input=${this._handleCustomBehaviour}
                                placeholder="${R("odd.editor.model.custom-behaviour-placeholder")}"
                              />
                            </label>
                            <span></span>
                          </div>
                          ...
                          <label class="pb-field">
                            ...
                            <input
                              ...
                              class="pb-input"
                              .value=${this.css||""}
                              placeholder="${R("odd.editor.model.css-class-placeholder")}"
                          ...
                          <div class="editor">
                            ...
                            <jinn-codemirror
                              ...
                              code="${this.template}"
                              mode="${e}"
                              placeholder="${R("odd.editor.model.template-placeholder")}"
                        ...
                        <div class="parameters">
                          ...
                          ${oe(this.parameters||[],e=>e.name,(e,t)=>o`
                        ...
                        <div class="renditions">
                          ...
                          ${oe(this.renditions||[],e=>e.name,(e,t)=>o`
            ...
            <div class="models">
                ${oe(this.model&&this.model.models||[],(e,t)=>o`
                    <pb-odd-model-editor
      ...
      <div id="layout">
        <div id="drawer">
          ...
          <h3>
            ...
            <span class="icons">
              <pb-edit-xml id="editSource"
                ><pb-icon-button
                  icon="code"
                  title="${R("odd.editor.odd-source")}"
                ></pb-icon-button
              ></pb-edit-xml>
              <pb-icon-button
                @click="${()=>this.save(!0)}"
                icon="icons:cloud-download"
                title="${R(P?"odd.editor.save-as":"odd.editor.download")}"
              ></pb-icon-button>
              <pb-icon-button
                @click="${this._reload}"
                icon="refresh"
                title="${R("odd.editor.reload")}"
              ></pb-icon-button>
              <pb-icon-button
                @click="${()=>this.save(!1)}"
                icon="save"
                title="${R("odd.editor.save")} ${this.display("save")}"
          ...
          <div id="new-element" class="input-group">
            <label class="pb-field">
              <span class="pb-field__label">${R("odd.editor.add-element")}</span>
              <div class="pb-input-with-button">
                <input
                  id="identNew"
                  class="pb-input"
                  name="ident-new"
                  placeholder="${R("odd.editor.add-element")}"
                />
                <pb-icon-button
          ...
          <div id="jump-to">
            <pb-autocomplete
              id="jumpTo"
              placeholder="${R("odd.editor.jump-to")}"
            ></pb-autocomplete>
          </div>

          <h3>${R("odd.editor.specs")}</h3>
        </div>
        <div id="navlist">
          ${oe(this.elementSpecs||[],e=>e.ident,(e,t)=>o`
                <button
                  id="es_${e.ident}"
                  type="button"
          ...
          <div class="metadata-card">
            <pb-collapse id="meta">
              ...
              <div slot="collapse-content">
                <label class="pb-field">
                  <span class="pb-field__label">${R("odd.editor.title")}</span>
                  <input
                    id="title"
                    class="pb-input"
                    name="title"
                    .value=${this.title||""}
                    placeholder="[${R("odd.editor.title-placeholder")}]"
                    @change=${this._inputTitle}
                  />
                </label>
                <label class="pb-field">
                  <span class="pb-field__label">${R("odd.editor.title-short")}</span>
                  <input
                    id="titleShort"
                    class="pb-input"
                    name="short-title"
                    .value=${this.titleShort||""}
                    placeholder="[${R("odd.editor.title-short-placeholder")}]"
                    @change=${e=>this.titleShort=e.target.value}
                  />
                </label>
                <label class="pb-field">
                  <span class="pb-field__label">${R("odd.editor.description-label")}</span>
                  <input
                    id="description"
                    class="pb-input"
                    name="description"
                    .value=${this.description||""}
                    placeholder="[${R("odd.editor.description-placeholder")}]"
                    @change=${e=>this.description=e.target.value}
                  />
                </label>
                <label class="pb-field">
                  <span class="pb-field__label">${R("odd.editor.source-label")}</span>
                  <input
                    id="source"
                    class="pb-input"
                    name="source"
                    .value=${this.source||""}
                    placeholder="[${R("odd.editor.source-placeholder")}]"
                ...
                <label class="pb-checkbox">
                  ...
                  />
                  <span>${R("odd.editor.use-namespace")}</span>
                </label>
                <label class="pb-field">
                  ...
                  <input
                    ...
                    placeholder="[${R("odd.editor.namespace-placeholder")}]"
